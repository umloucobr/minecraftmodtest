...
public class RealmsTermsScreen extends RealmsScreen {
   ...
   private static final ITextComponent field_243186_p = (new StringTextComponent(" ")).appendSibling((new TranslationTextComponent("mco.terms.sentence.2")).mergeStyle(Style.EMPTY.func_244282_c(true)));
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.font.drawText(matrixStack, field_243185_c, (float)(this.width / 2 - 120), (float)func_239562_k_(5), 16777215);
      ...
      this.font.drawText(matrixStack, field_243186_p, (float)(this.width / 2 - 120 + i), (float)func_239562_k_(5), this.field_224727_f ? 7107012 : 3368635);
