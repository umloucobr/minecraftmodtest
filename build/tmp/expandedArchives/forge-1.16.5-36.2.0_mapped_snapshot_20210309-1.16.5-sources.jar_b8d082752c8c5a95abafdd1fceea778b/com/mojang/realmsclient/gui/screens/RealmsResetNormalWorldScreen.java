...
public class RealmsResetNormalWorldScreen extends RealmsScreen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.font.drawText(matrixStack, field_243144_a, (float)(this.width / 2 - 100), (float)func_239562_k_(1), 10526880);
      this.field_224356_d.render(matrixStack, mouseX, mouseY, partialTicks);
      super.render(matrixStack, mouseX, mouseY, partialTicks);
   }

   private ITextComponent func_237937_g_() {
      return (new TranslationTextComponent("selectWorld.mapType")).appendString(" ").appendSibling(field_243145_b[this.field_224358_f]);
   }
