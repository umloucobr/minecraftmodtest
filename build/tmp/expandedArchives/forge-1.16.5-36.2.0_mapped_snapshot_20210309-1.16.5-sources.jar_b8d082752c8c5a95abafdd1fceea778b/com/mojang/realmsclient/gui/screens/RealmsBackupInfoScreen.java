...
public class RealmsBackupInfoScreen extends RealmsScreen {
   ...
   class BackupInfoEntry extends ExtendedList.AbstractListEntry<RealmsBackupInfoScreen.BackupInfoEntry> {
      ...
      public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
         ...
         AbstractGui.drawString(matrixStack, fontrenderer, this.field_237738_b_, left, top, 10526880);
         AbstractGui.drawString(matrixStack, fontrenderer, RealmsBackupInfoScreen.this.func_237733_a_(this.field_237738_b_, this.field_237739_c_), left, top + 12, 16777215);
      }
   }
