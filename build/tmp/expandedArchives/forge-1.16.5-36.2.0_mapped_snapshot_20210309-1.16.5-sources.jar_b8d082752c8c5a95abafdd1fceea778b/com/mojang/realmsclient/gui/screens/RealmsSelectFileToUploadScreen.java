...
public class RealmsSelectFileToUploadScreen extends RealmsScreen {
   ...
   class WorldSelectionEntry extends ExtendedList.AbstractListEntry<RealmsSelectFileToUploadScreen.WorldSelectionEntry> {
      ...
      public WorldSelectionEntry(WorldSummary p_i232220_2_) {
         ...
         if (p_i232220_2_.requiresConversion()) {
            ...
            if (p_i232220_2_.getCheatsEnabled()) {
               itextcomponent = itextcomponent.deepCopy().appendString(", ").appendSibling(RealmsSelectFileToUploadScreen.field_243150_q);
            }
      ...
      public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
         this.func_237985_a_(matrixStack, this.field_223759_a, index, left, top);
      }
      ...
      protected void func_237985_a_(MatrixStack p_237985_1_, WorldSummary p_237985_2_, int p_237985_3_, int p_237985_4_, int p_237985_5_) {
         ...
         RealmsSelectFileToUploadScreen.this.font.drawText(p_237985_1_, this.field_243162_e, (float)(p_237985_4_ + 2), (float)(p_237985_5_ + 12 + 10), 8421504);
      }
   }
