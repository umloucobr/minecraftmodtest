...
public class RealmsSubscriptionInfoScreen extends RealmsScreen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.font.drawText(matrixStack, field_243174_c, (float)i, (float)func_239562_k_(0), 10526880);
      ...
      if (this.field_224592_n == Subscription.Type.NORMAL) {
         this.font.drawText(matrixStack, field_243175_p, (float)i, (float)func_239562_k_(3), 10526880);
      } else if (this.field_224592_n == Subscription.Type.RECURRING) {
         this.font.drawText(matrixStack, field_243176_q, (float)i, (float)func_239562_k_(3), 10526880);
      }

      this.font.drawText(matrixStack, this.field_224590_l, (float)i, (float)func_239562_k_(4), 16777215);
   ...
   private ITextComponent func_224576_a(int p_224576_1_) {
      if (p_224576_1_ < 0 && this.field_224581_c.field_230591_j_) {
         ...
         if (i > 0) {
            ...
            if (i == 1) {
               iformattabletextcomponent.appendSibling(field_243179_t);
            } else {
               iformattabletextcomponent.appendSibling(field_243180_u);
            }
         }
         ...
         if (j > 0) {
            ...
            if (j == 1) {
               iformattabletextcomponent.appendSibling(field_243181_v);
            } else {
               iformattabletextcomponent.appendSibling(field_243182_w);
            }
         }
