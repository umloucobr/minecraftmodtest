...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.field_224303_d != null && this.field_224303_d.field_230589_h_ != null) {
         this.font.drawText(matrixStack, (new StringTextComponent("")).appendSibling(field_243141_u).appendString(" (").appendString(Integer.toString(this.field_224303_d.field_230589_h_.size())).appendString(")"), (float)this.field_224305_f, (float)func_239562_k_(0), 10526880);
      } else {
         this.font.drawText(matrixStack, field_243141_u, (float)this.field_224305_f, (float)func_239562_k_(0), 10526880);
      }
   ...
   protected void func_237903_a_(MatrixStack p_237903_1_, @Nullable ITextComponent p_237903_2_, int p_237903_3_, int p_237903_4_) {
      if (p_237903_2_ != null) {
         ...
         this.font.drawTextWithShadow(p_237903_1_, p_237903_2_, (float)i, (float)j, 16777215);
      }
   }
   ...
   class InvitedEntry extends ExtendedList.AbstractListEntry<RealmsPlayerScreen.InvitedEntry> {
      ...
      public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
         this.func_237932_a_(matrixStack, this.field_237930_b_, left, top, mouseX, mouseY);
      }
