...
public class RealmsSelectWorldTemplateScreen extends RealmsScreen {
   ...
   protected void func_237993_a_(MatrixStack p_237993_1_, @Nullable ITextComponent p_237993_2_, int p_237993_3_, int p_237993_4_) {
      if (p_237993_2_ != null) {
         ...
         this.font.drawTextWithShadow(p_237993_1_, p_237993_2_, (float)i, (float)j, 16777215);
      }
   }
   ...
   class WorldTemplateSelectionEntry extends ExtendedList.AbstractListEntry<RealmsSelectWorldTemplateScreen.WorldTemplateSelectionEntry> {
      ...
      public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
         this.func_238029_a_(matrixStack, this.field_223756_a, left, top, mouseX, mouseY);
      }
