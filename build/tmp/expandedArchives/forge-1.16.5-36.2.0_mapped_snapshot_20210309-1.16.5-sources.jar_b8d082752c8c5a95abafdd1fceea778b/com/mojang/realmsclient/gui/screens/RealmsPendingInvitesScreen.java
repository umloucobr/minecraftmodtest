...
public class RealmsPendingInvitesScreen extends RealmsScreen {
   ...
   protected void func_237866_a_(MatrixStack p_237866_1_, @Nullable ITextComponent p_237866_2_, int p_237866_3_, int p_237866_4_) {
      if (p_237866_2_ != null) {
         ...
         this.font.drawTextWithShadow(p_237866_1_, p_237866_2_, (float)i, (float)j, 16777215);
      }
   }
   ...
   class InvitationEntry extends ExtendedList.AbstractListEntry<RealmsPendingInvitesScreen.InvitationEntry> {
      ...
      public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
         this.func_237893_a_(matrixStack, this.field_223750_a, left, top, mouseX, mouseY);
      }
