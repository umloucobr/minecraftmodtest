...
public class RealmsConfigureWorldScreen extends NotifableRealmsScreen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.field_224416_d == null) {
         ...
         if (this.func_224376_g()) {
            this.font.drawText(matrixStack, field_243110_t.deepCopy().appendString(this.field_224416_d.func_230778_c_()), (float)(this.field_224418_f + 80 + 20 + 10), (float)func_239562_k_(13), 16777215);
         }
   ...
   protected void func_237796_a_(MatrixStack p_237796_1_, @Nullable ITextComponent p_237796_2_, int p_237796_3_, int p_237796_4_) {
      ...
      this.font.drawTextWithShadow(p_237796_1_, p_237796_2_, (float)i, (float)j, 16777215);
   }
