...
public class RealmsSlotOptionsScreen extends RealmsScreen {
   ...
   private ITextComponent func_224625_b() {
      return (new TranslationTextComponent("options.difficulty")).appendString(": ").appendSibling(field_238035_a_[this.field_224649_l]);
   }
   ...
   private ITextComponent func_224618_d() {
      return (new TranslationTextComponent("mco.configure.world.pvp")).appendString(": ").appendSibling(func_238050_c_(this.field_224651_n));
   }

   private ITextComponent func_224606_e() {
      return (new TranslationTextComponent("mco.configure.world.spawnAnimals")).appendString(": ").appendSibling(func_238050_c_(this.field_224653_p));
   }

   private ITextComponent func_224626_f() {
      return this.field_224649_l == 0 ? (new TranslationTextComponent("mco.configure.world.spawnMonsters")).appendString(": ").appendSibling(new TranslationTextComponent("mco.configure.world.off")) : (new TranslationTextComponent("mco.configure.world.spawnMonsters")).appendString(": ").appendSibling(func_238050_c_(this.field_224654_q));
   }

   private ITextComponent func_224621_g() {
      return (new TranslationTextComponent("mco.configure.world.spawnNPCs")).appendString(": ").appendSibling(func_238050_c_(this.field_224652_o));
   }

   private ITextComponent func_224594_h() {
      return (new TranslationTextComponent("mco.configure.world.commandBlocks")).appendString(": ").appendSibling(func_238050_c_(this.field_224656_s));
   }

   private ITextComponent func_224634_i() {
      return (new TranslationTextComponent("mco.configure.world.forceGameMode")).appendString(": ").appendSibling(func_238050_c_(this.field_224657_t));
   }
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.font.drawText(matrixStack, field_243172_s, (float)(this.field_224643_f + this.field_224644_g / 2 - this.font.getStringPropertyWidth(field_243172_s) / 2), (float)(func_239562_k_(0) - 5), 16777215);
   ...
   class SettingsSlider extends AbstractSlider {
      ...
      protected void func_230979_b_() {
         this.setMessage((new TranslationTextComponent("mco.configure.world.spawnProtection")).appendString(": ").appendSibling((ITextComponent)(RealmsSlotOptionsScreen.this.field_224655_r == 0 ? new TranslationTextComponent("mco.configure.world.off") : new StringTextComponent(String.valueOf((Object)RealmsSlotOptionsScreen.this.field_224655_r)))));
      }
