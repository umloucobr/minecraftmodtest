...
public class RealmsBackupScreen extends RealmsScreen {
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.font.drawText(matrixStack, field_243096_r, (float)((this.width - 150) / 2 - 90), 20.0F, 10526880);
      if (this.field_224125_l) {
         this.font.drawText(matrixStack, field_243097_s, 20.0F, (float)(this.height / 2 - 10), 16777215);
      }
   ...
   protected void func_237744_a_(MatrixStack p_237744_1_, @Nullable ITextComponent p_237744_2_, int p_237744_3_, int p_237744_4_) {
      if (p_237744_2_ != null) {
         ...
         this.font.drawTextWithShadow(p_237744_1_, p_237744_2_, (float)i, (float)j, 16777215);
      }
   }
   ...
   class BackupObjectSelectionListEntry extends ExtendedList.AbstractListEntry<RealmsBackupScreen.BackupObjectSelectionListEntry> {
      ...
      public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
         this.func_237767_a_(matrixStack, this.field_237765_b_, left - 40, top, mouseX, mouseY);
      }
