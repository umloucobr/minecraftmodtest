...
public class RealmsMainScreen extends RealmsScreen {
   ...
   private Button realmsInfoButton;
   private Button realmsPendingInviteButton;
   private Button realmsNewsButton;
   private Button field_224009_Q;
   private Button field_224010_R;
   private Button realmsCloseButton;
   ...
   public void func_223901_c() {
      ...
      this.realmsPendingInviteButton = this.addButton(new RealmsMainScreen.PendingInvitesButton());
      this.realmsNewsButton = this.addButton(new RealmsMainScreen.NewsButton());
      this.realmsInfoButton = this.addButton(new RealmsMainScreen.InfoButton());
      this.realmsCloseButton = this.addButton(new RealmsMainScreen.CloseButton());
   ...
   private void func_223915_a(@Nullable RealmsServer p_223915_1_) {
      ...
      this.realmsCloseButton.visible = this.func_223990_b() && this.field_224035_x;
      ...
      this.realmsNewsButton.active = true;
      this.realmsPendingInviteButton.active = true;
      this.field_224023_l.active = true;
      this.realmsInfoButton.active = !this.func_223990_b();
   }
   ...
   public void tick() {
      ...
      if (func_223968_l()) {
         ...
         if (this.realmsInfoButton != null) {
            this.realmsInfoButton.visible = this.func_223977_m();
         }
   ...
   private void func_243059_h(RealmsServer p_243059_1_) {
      ...
      this.field_224020_i.getEventListeners().removeIf((p_243041_1_) -> {
         return p_243041_1_ instanceof RealmsMainScreen.ServerEntry && ((RealmsMainScreen.ServerEntry)p_243041_1_).server.field_230582_a_ == this.field_224021_j;
      });
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.field_224037_z && !this.field_223993_A && this.func_223990_b()) {
         ...
         AbstractGui.blit(matrixStack, this.field_224009_Q.x + this.field_224009_Q.getWidth() - 8 - 4, this.field_224009_Q.y + this.field_224009_Q.getHeight() / 2 - 4, 0.0F, (float)j, 8, 8, 8, 16);
      }
   ...
   private void func_237581_a_(MatrixStack p_237581_1_, int p_237581_2_, int p_237581_3_, int p_237581_4_, int p_237581_5_, boolean p_237581_6_, boolean p_237581_7_) {
      ...
      if (flag4) {
         ...
         this.font.drawTextWithShadow(p_237581_1_, itextcomponent, (float)j1, (float)p_237581_3_, -1);
      }
   ...
   protected void func_237583_a_(MatrixStack p_237583_1_, List<ITextComponent> p_237583_2_, int p_237583_3_, int p_237583_4_) {
      if (!p_237583_2_.isEmpty()) {
         ...
         for(ITextComponent itextcomponent1 : p_237583_2_) {
            ...
            this.font.drawTextWithShadow(p_237583_1_, itextcomponent1, (float)i1, (float)(j1 + i), 16777215);
            i += 10;
         }
   ...
   class ServerEntry extends RealmsMainScreen.ListEntry {
      ...
      public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
         this.func_237678_a_(this.server, matrixStack, left, top, mouseX, mouseY);
      }

      public boolean mouseClicked(double mouseX, double mouseY, int button) {
         if (this.server.field_230586_e_ == RealmsServer.Status.UNINITIALIZED) {
            RealmsMainScreen.this.field_224021_j = -1L;
            RealmsMainScreen.this.minecraft.displayGuiScreen(new RealmsCreateRealmScreen(this.server, RealmsMainScreen.this));
         } else {
            RealmsMainScreen.this.field_224021_j = this.server.field_230582_a_;
         }

         return true;
      }

      private void func_237678_a_(RealmsServer server, MatrixStack p_237678_2_, int p_237678_3_, int p_237678_4_, int p_237678_5_, int p_237678_6_) {
         this.func_237679_b_(server, p_237678_2_, p_237678_3_ + 36, p_237678_4_, p_237678_5_, p_237678_6_);
      }
      ...
      private void func_237679_b_(RealmsServer p_237679_1_, MatrixStack p_237679_2_, int p_237679_3_, int p_237679_4_, int p_237679_5_, int p_237679_6_) {
         if (p_237679_1_.field_230586_e_ == RealmsServer.Status.UNINITIALIZED) {
            ...
            if (RealmsMainScreen.this.func_223885_h(p_237679_1_) && p_237679_1_.field_230591_j_) {
               ...
               RealmsMainScreen.this.font.drawText(p_237679_2_, itextcomponent, (float)(p_237679_3_ + 2), (float)(i2 + 1), 15553363);
               ...
               if (p_237679_1_.field_230594_m_ == RealmsServer.ServerType.MINIGAME) {
                  ...
                  RealmsMainScreen.this.font.drawText(p_237679_2_, RealmsMainScreen.field_243008_M, (float)(p_237679_3_ + 2), (float)(p_237679_4_ + 12), 13413468);
   ...
   class TrialServerEntry extends RealmsMainScreen.ListEntry {
      ...
      public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
         this.func_237681_a_(matrixStack, index, left, top, mouseX, mouseY);
      }
