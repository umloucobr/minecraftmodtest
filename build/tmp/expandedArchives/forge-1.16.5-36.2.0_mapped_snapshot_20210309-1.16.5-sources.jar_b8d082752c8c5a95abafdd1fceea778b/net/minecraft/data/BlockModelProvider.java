...
public class BlockModelProvider {
   ...
   private static BlockStateVariantBuilder func_239933_b_() {
      return BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.HORIZONTAL_FACING).func_240143_a_(Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240143_a_(Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240143_a_(Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240143_a_(Direction.NORTH, BlockModelDefinition.getNewModelDefinition());
   }

   private static BlockStateVariantBuilder func_239952_c_() {
      return BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.HORIZONTAL_FACING).func_240143_a_(Direction.SOUTH, BlockModelDefinition.getNewModelDefinition()).func_240143_a_(Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240143_a_(Direction.NORTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240143_a_(Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270));
   }

   private static BlockStateVariantBuilder func_239964_d_() {
      return BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.HORIZONTAL_FACING).func_240143_a_(Direction.EAST, BlockModelDefinition.getNewModelDefinition()).func_240143_a_(Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240143_a_(Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240143_a_(Direction.NORTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270));
   }

   private static BlockStateVariantBuilder func_239974_e_() {
      return BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.FACING).func_240143_a_(Direction.DOWN, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90)).func_240143_a_(Direction.UP, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270)).func_240143_a_(Direction.NORTH, BlockModelDefinition.getNewModelDefinition()).func_240143_a_(Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240143_a_(Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240143_a_(Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90));
   }
   ...
   private static BlockModelDefinition[] func_239915_a_(ResourceLocation p_239915_0_) {
      return new BlockModelDefinition[]{BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239915_0_), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239915_0_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239915_0_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239915_0_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)};
   }
   ...
   private static FinishedVariantBlockState func_239979_e_(Block p_239979_0_, ResourceLocation p_239979_1_, ResourceLocation p_239979_2_) {
      return FinishedVariantBlockState.func_240121_a_(p_239979_0_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239979_1_), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239979_2_), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239979_1_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239979_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180));
   }
   ...
   private static BlockStateVariantBuilder func_239894_a_(BooleanProperty p_239894_0_, ResourceLocation p_239894_1_, ResourceLocation p_239894_2_) {
      return BlockStateVariantBuilder.func_240133_a_(p_239894_0_).func_240143_a_(true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239894_1_)).func_240143_a_(false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239894_2_));
   }
   ...
   private static IFinishedBlockState func_239987_f_(Block p_239987_0_, ResourceLocation p_239987_1_, ResourceLocation p_239987_2_) {
      return FinishedVariantBlockState.fromBlock(p_239987_0_).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.POWERED).func_240143_a_(false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239987_1_)).func_240143_a_(true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239987_2_))).func_240125_a_(BlockStateVariantBuilder.func_240134_a_(BlockStateProperties.FACE, BlockStateProperties.HORIZONTAL_FACING).func_240149_a_(AttachFace.FLOOR, Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240149_a_(AttachFace.FLOOR, Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240149_a_(AttachFace.FLOOR, Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(AttachFace.FLOOR, Direction.NORTH, BlockModelDefinition.getNewModelDefinition()).func_240149_a_(AttachFace.WALL, Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240149_a_(AttachFace.WALL, Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240149_a_(AttachFace.WALL, Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240149_a_(AttachFace.WALL, Direction.NORTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240149_a_(AttachFace.CEILING, Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(AttachFace.CEILING, Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(AttachFace.CEILING, Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(AttachFace.CEILING, Direction.NORTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180)));
   }
   ...
   private static BlockStateVariantBuilder.Four<Direction, DoubleBlockHalf, DoorHingeSide, Boolean> func_239903_a_(BlockStateVariantBuilder.Four<Direction, DoubleBlockHalf, DoorHingeSide, Boolean> p_239903_0_, DoubleBlockHalf p_239903_1_, ResourceLocation p_239903_2_, ResourceLocation p_239903_3_) {
      return p_239903_0_.func_240170_a_(Direction.EAST, p_239903_1_, DoorHingeSide.LEFT, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_2_)).func_240170_a_(Direction.SOUTH, p_239903_1_, DoorHingeSide.LEFT, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240170_a_(Direction.WEST, p_239903_1_, DoorHingeSide.LEFT, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240170_a_(Direction.NORTH, p_239903_1_, DoorHingeSide.LEFT, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240170_a_(Direction.EAST, p_239903_1_, DoorHingeSide.RIGHT, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_3_)).func_240170_a_(Direction.SOUTH, p_239903_1_, DoorHingeSide.RIGHT, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240170_a_(Direction.WEST, p_239903_1_, DoorHingeSide.RIGHT, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240170_a_(Direction.NORTH, p_239903_1_, DoorHingeSide.RIGHT, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240170_a_(Direction.EAST, p_239903_1_, DoorHingeSide.LEFT, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240170_a_(Direction.SOUTH, p_239903_1_, DoorHingeSide.LEFT, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240170_a_(Direction.WEST, p_239903_1_, DoorHingeSide.LEFT, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240170_a_(Direction.NORTH, p_239903_1_, DoorHingeSide.LEFT, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_3_)).func_240170_a_(Direction.EAST, p_239903_1_, DoorHingeSide.RIGHT, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240170_a_(Direction.SOUTH, p_239903_1_, DoorHingeSide.RIGHT, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_2_)).func_240170_a_(Direction.WEST, p_239903_1_, DoorHingeSide.RIGHT, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240170_a_(Direction.NORTH, p_239903_1_, DoorHingeSide.RIGHT, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239903_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180));
   }
   ...
   private static IFinishedBlockState func_239994_g_(Block p_239994_0_, ResourceLocation p_239994_1_, ResourceLocation p_239994_2_) {
      return FinishedMultiPartBlockState.func_240106_a_(p_239994_0_).func_240111_a_(BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239994_1_)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239994_2_).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.EAST, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239994_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.SOUTH, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239994_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WEST, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239994_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true));
   }
   ...
   private static IFinishedBlockState func_239970_d_(Block p_239970_0_, ResourceLocation p_239970_1_, ResourceLocation p_239970_2_, ResourceLocation p_239970_3_) {
      return FinishedMultiPartBlockState.func_240106_a_(p_239970_0_).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.UP, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239970_1_)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WALL_HEIGHT_NORTH, WallHeight.LOW), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239970_2_).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WALL_HEIGHT_EAST, WallHeight.LOW), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239970_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WALL_HEIGHT_SOUTH, WallHeight.LOW), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239970_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WALL_HEIGHT_WEST, WallHeight.LOW), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239970_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WALL_HEIGHT_NORTH, WallHeight.TALL), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239970_3_).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WALL_HEIGHT_EAST, WallHeight.TALL), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239970_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WALL_HEIGHT_SOUTH, WallHeight.TALL), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239970_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WALL_HEIGHT_WEST, WallHeight.TALL), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239970_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true));
   }
   ...
   private static IFinishedBlockState func_239960_c_(Block p_239960_0_, ResourceLocation p_239960_1_, ResourceLocation p_239960_2_, ResourceLocation p_239960_3_, ResourceLocation p_239960_4_) {
      return FinishedVariantBlockState.func_240120_a_(p_239960_0_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240125_a_(func_239952_c_()).func_240125_a_(BlockStateVariantBuilder.func_240134_a_(BlockStateProperties.IN_WALL, BlockStateProperties.OPEN).func_240149_a_(false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239960_2_)).func_240149_a_(true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239960_4_)).func_240149_a_(false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239960_1_)).func_240149_a_(true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239960_3_)));
   }
   ...
   private static IFinishedBlockState func_239980_e_(Block p_239980_0_, ResourceLocation p_239980_1_, ResourceLocation p_239980_2_, ResourceLocation p_239980_3_) {
      return FinishedVariantBlockState.fromBlock(p_239980_0_).func_240125_a_(BlockStateVariantBuilder.func_240135_a_(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.HALF, BlockStateProperties.STAIRS_SHAPE).func_240161_a_(Direction.EAST, Half.BOTTOM, StairsShape.STRAIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_2_)).func_240161_a_(Direction.WEST, Half.BOTTOM, StairsShape.STRAIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.SOUTH, Half.BOTTOM, StairsShape.STRAIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.NORTH, Half.BOTTOM, StairsShape.STRAIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.EAST, Half.BOTTOM, StairsShape.OUTER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_)).func_240161_a_(Direction.WEST, Half.BOTTOM, StairsShape.OUTER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.SOUTH, Half.BOTTOM, StairsShape.OUTER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.NORTH, Half.BOTTOM, StairsShape.OUTER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.EAST, Half.BOTTOM, StairsShape.OUTER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.WEST, Half.BOTTOM, StairsShape.OUTER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.SOUTH, Half.BOTTOM, StairsShape.OUTER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_)).func_240161_a_(Direction.NORTH, Half.BOTTOM, StairsShape.OUTER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.EAST, Half.BOTTOM, StairsShape.INNER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_)).func_240161_a_(Direction.WEST, Half.BOTTOM, StairsShape.INNER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.SOUTH, Half.BOTTOM, StairsShape.INNER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.NORTH, Half.BOTTOM, StairsShape.INNER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.EAST, Half.BOTTOM, StairsShape.INNER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.WEST, Half.BOTTOM, StairsShape.INNER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.SOUTH, Half.BOTTOM, StairsShape.INNER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_)).func_240161_a_(Direction.NORTH, Half.BOTTOM, StairsShape.INNER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.EAST, Half.TOP, StairsShape.STRAIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_2_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.WEST, Half.TOP, StairsShape.STRAIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_2_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.SOUTH, Half.TOP, StairsShape.STRAIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_2_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.NORTH, Half.TOP, StairsShape.STRAIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_2_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.EAST, Half.TOP, StairsShape.OUTER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.WEST, Half.TOP, StairsShape.OUTER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.SOUTH, Half.TOP, StairsShape.OUTER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.NORTH, Half.TOP, StairsShape.OUTER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.EAST, Half.TOP, StairsShape.OUTER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.WEST, Half.TOP, StairsShape.OUTER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.SOUTH, Half.TOP, StairsShape.OUTER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.NORTH, Half.TOP, StairsShape.OUTER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_3_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.EAST, Half.TOP, StairsShape.INNER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.WEST, Half.TOP, StairsShape.INNER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.SOUTH, Half.TOP, StairsShape.INNER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.NORTH, Half.TOP, StairsShape.INNER_RIGHT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.EAST, Half.TOP, StairsShape.INNER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.WEST, Half.TOP, StairsShape.INNER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.SOUTH, Half.TOP, StairsShape.INNER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240161_a_(Direction.NORTH, Half.TOP, StairsShape.INNER_LEFT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239980_1_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)));
   }
   ...
   private static IFinishedBlockState func_239988_f_(Block p_239988_0_, ResourceLocation p_239988_1_, ResourceLocation p_239988_2_, ResourceLocation p_239988_3_) {
      return FinishedVariantBlockState.fromBlock(p_239988_0_).func_240125_a_(BlockStateVariantBuilder.func_240135_a_(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.HALF, BlockStateProperties.OPEN).func_240161_a_(Direction.NORTH, Half.BOTTOM, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_2_)).func_240161_a_(Direction.SOUTH, Half.BOTTOM, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240161_a_(Direction.EAST, Half.BOTTOM, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240161_a_(Direction.WEST, Half.BOTTOM, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_2_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240161_a_(Direction.NORTH, Half.TOP, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_1_)).func_240161_a_(Direction.SOUTH, Half.TOP, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_1_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240161_a_(Direction.EAST, Half.TOP, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_1_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240161_a_(Direction.WEST, Half.TOP, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_1_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240161_a_(Direction.NORTH, Half.BOTTOM, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_3_)).func_240161_a_(Direction.SOUTH, Half.BOTTOM, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240161_a_(Direction.EAST, Half.BOTTOM, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240161_a_(Direction.WEST, Half.BOTTOM, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240161_a_(Direction.NORTH, Half.TOP, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_3_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240161_a_(Direction.SOUTH, Half.TOP, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_3_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R0)).func_240161_a_(Direction.EAST, Half.TOP, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_3_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240161_a_(Direction.WEST, Half.TOP, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239988_3_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)));
   }
   ...
   private static IFinishedBlockState func_239995_g_(Block p_239995_0_, ResourceLocation p_239995_1_, ResourceLocation p_239995_2_, ResourceLocation p_239995_3_) {
      return FinishedVariantBlockState.fromBlock(p_239995_0_).func_240125_a_(BlockStateVariantBuilder.func_240135_a_(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.HALF, BlockStateProperties.OPEN).func_240161_a_(Direction.NORTH, Half.BOTTOM, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_2_)).func_240161_a_(Direction.SOUTH, Half.BOTTOM, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_2_)).func_240161_a_(Direction.EAST, Half.BOTTOM, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_2_)).func_240161_a_(Direction.WEST, Half.BOTTOM, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_2_)).func_240161_a_(Direction.NORTH, Half.TOP, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_1_)).func_240161_a_(Direction.SOUTH, Half.TOP, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_1_)).func_240161_a_(Direction.EAST, Half.TOP, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_1_)).func_240161_a_(Direction.WEST, Half.TOP, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_1_)).func_240161_a_(Direction.NORTH, Half.BOTTOM, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_3_)).func_240161_a_(Direction.SOUTH, Half.BOTTOM, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240161_a_(Direction.EAST, Half.BOTTOM, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240161_a_(Direction.WEST, Half.BOTTOM, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240161_a_(Direction.NORTH, Half.TOP, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_3_)).func_240161_a_(Direction.SOUTH, Half.TOP, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240161_a_(Direction.EAST, Half.TOP, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240161_a_(Direction.WEST, Half.TOP, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239995_3_).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)));
   }

   private static FinishedVariantBlockState func_239978_e_(Block p_239978_0_, ResourceLocation p_239978_1_) {
      return FinishedVariantBlockState.func_240120_a_(p_239978_0_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239978_1_));
   }

   private static BlockStateVariantBuilder func_239983_f_() {
      return BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.AXIS).func_240143_a_(Direction.Axis.Y, BlockModelDefinition.getNewModelDefinition()).func_240143_a_(Direction.Axis.Z, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90)).func_240143_a_(Direction.Axis.X, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90));
   }

   private static IFinishedBlockState func_239986_f_(Block p_239986_0_, ResourceLocation p_239986_1_) {
      return FinishedVariantBlockState.func_240120_a_(p_239986_0_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239986_1_)).func_240125_a_(func_239983_f_());
   }
   ...
   private void func_239939_b_(Block p_239939_1_, TexturedModel.ISupplier p_239939_2_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(p_239939_1_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation)).func_240125_a_(func_239933_b_()));
   }
   ...
   private static IFinishedBlockState func_240000_h_(Block p_240000_0_, ResourceLocation p_240000_1_, ResourceLocation p_240000_2_) {
      return FinishedVariantBlockState.fromBlock(p_240000_0_).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.AXIS).func_240143_a_(Direction.Axis.Y, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_240000_1_)).func_240143_a_(Direction.Axis.Z, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_240000_2_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90)).func_240143_a_(Direction.Axis.X, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_240000_2_).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)));
   }
   ...
   private static IFinishedBlockState func_240006_i_(Block p_240006_0_, ResourceLocation p_240006_1_, ResourceLocation p_240006_2_) {
      return FinishedVariantBlockState.fromBlock(p_240006_0_).func_240125_a_(func_239894_a_(BlockStateProperties.POWERED, p_240006_2_, p_240006_1_));
   }
   ...
   private static IFinishedBlockState func_240001_h_(Block p_240001_0_, ResourceLocation p_240001_1_, ResourceLocation p_240001_2_, ResourceLocation p_240001_3_) {
      return FinishedVariantBlockState.fromBlock(p_240001_0_).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.SLAB_TYPE).func_240143_a_(SlabType.BOTTOM, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_240001_1_)).func_240143_a_(SlabType.TOP, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_240001_2_)).func_240143_a_(SlabType.DOUBLE, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_240001_3_)));
   }
   ...
   private void func_239935_b_(Block p_239935_1_, Block p_239935_2_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(p_239935_2_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1)).func_240125_a_(func_239933_b_()));
   ...
   private void func_239954_c_(Block p_239954_1_, Block p_239954_2_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(p_239954_2_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation)).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.HORIZONTAL_FACING).func_240143_a_(Direction.WEST, BlockModelDefinition.getNewModelDefinition()).func_240143_a_(Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240143_a_(Direction.NORTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240143_a_(Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180))));
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(p_239954_1_).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.AGE_0_7).func_240145_a_((p_239881_3_) -> {
         return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, StockModelShapes.STEM_GROWTH_STAGES[p_239881_3_].func_240228_a_(p_239954_1_, modeltextures, this.field_239835_b_));
      })));
   }
   ...
   private void func_240011_j_(Block p_240011_1_, ResourceLocation p_240011_2_, ResourceLocation p_240011_3_) {
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(p_240011_1_).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.DOUBLE_BLOCK_HALF).func_240143_a_(DoubleBlockHalf.LOWER, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_240011_3_)).func_240143_a_(DoubleBlockHalf.UPPER, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_240011_2_))));
   }
   ...
   private void func_240018_l_(Block p_240018_1_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(p_240018_1_).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.RAIL_SHAPE).func_240143_a_(RailShape.NORTH_SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation)).func_240143_a_(RailShape.EAST_WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240143_a_(RailShape.ASCENDING_EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240143_a_(RailShape.ASCENDING_WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240143_a_(RailShape.ASCENDING_NORTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2)).func_240143_a_(RailShape.ASCENDING_SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3)).func_240143_a_(RailShape.SOUTH_EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1)).func_240143_a_(RailShape.SOUTH_WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240143_a_(RailShape.NORTH_WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240143_a_(RailShape.NORTH_EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270))));
   }
   ...
   private void func_240021_m_(Block p_240021_1_) {
      ...
      BlockStateVariantBuilder blockstatevariantbuilder = BlockStateVariantBuilder.func_240134_a_(BlockStateProperties.POWERED, BlockStateProperties.RAIL_SHAPE_STRAIGHT).func_240152_a_((p_239919_6_, p_239919_7_) -> {
         switch(p_239919_7_) {
         case NORTH_SOUTH:
            return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239919_6_ ? resourcelocation3 : resourcelocation);
         case EAST_WEST:
            return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239919_6_ ? resourcelocation3 : resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90);
         case ASCENDING_EAST:
            return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239919_6_ ? resourcelocation4 : resourcelocation1).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90);
         case ASCENDING_WEST:
            return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239919_6_ ? resourcelocation5 : resourcelocation2).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90);
         case ASCENDING_NORTH:
            return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239919_6_ ? resourcelocation4 : resourcelocation1);
         case ASCENDING_SOUTH:
            return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239919_6_ ? resourcelocation5 : resourcelocation2);
         default:
            throw new UnsupportedOperationException("Fix you generator!");
         }
      });
      this.func_239934_b_(p_240021_1_);
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(p_240021_1_).func_240125_a_(blockstatevariantbuilder));
   }
   ...
   private void func_239948_b_(TexturedModel.ISupplier p_239948_1_, Block... p_239948_2_) {
      for(Block block : p_239948_2_) {
         ...
         this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(block, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation)).func_240125_a_(func_239952_c_()));
      }
   ...
   private void func_239985_f_(Block p_239985_1_, Block p_239985_2_) {
      ...
      this.field_239834_a_.accept(FinishedMultiPartBlockState.func_240106_a_(p_239985_2_).func_240111_a_(BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.EAST, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.SOUTH, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WEST, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.EAST, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation4)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.SOUTH, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation4).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WEST, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)));
   }
   ...
   private void func_240023_n_(Block p_240023_1_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(p_240023_1_).func_240125_a_(func_239894_a_(BlockStateProperties.CONDITIONAL, resourcelocation1, resourcelocation)).func_240125_a_(func_239974_e_()));
   }
   ...
   private List<BlockModelDefinition> func_239864_a_(int p_239864_1_) {
      ...
      return IntStream.range(1, 5).mapToObj((p_239913_1_) -> {
         return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.BAMBOO, p_239913_1_ + s));
      }).collect(Collectors.toList());
   }

   private void func_240003_i_() {
      this.func_239869_a_(Blocks.BAMBOO);
      this.field_239834_a_.accept(FinishedMultiPartBlockState.func_240106_a_(Blocks.BAMBOO).func_240109_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.AGE_0_1, 0), this.func_239864_a_(0)).func_240109_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.AGE_0_1, 1), this.func_239864_a_(1)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.BAMBOO_LEAVES, BambooLeaves.SMALL), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.BAMBOO, "_small_leaves"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.BAMBOO_LEAVES, BambooLeaves.LARGE), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.BAMBOO, "_large_leaves"))));
   }

   private BlockStateVariantBuilder func_240008_j_() {
      return BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.FACING).func_240143_a_(Direction.DOWN, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180)).func_240143_a_(Direction.UP, BlockModelDefinition.getNewModelDefinition()).func_240143_a_(Direction.NORTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90)).func_240143_a_(Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240143_a_(Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240143_a_(Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90));
   }

   private void func_240013_k_() {
      ResourceLocation resourcelocation = ModelTextures.func_240347_a_(Blocks.BARREL, "_top_open");
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.BARREL).func_240125_a_(this.func_240008_j_()).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.OPEN).func_240143_a_(false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, TexturedModel.field_240438_e_.func_240466_a_(Blocks.BARREL, this.field_239835_b_))).func_240143_a_(true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, TexturedModel.field_240438_e_.get(Blocks.BARREL).func_240460_a_((p_239973_1_) -> {
   ...
   private static <T extends Comparable<T>> BlockStateVariantBuilder func_239895_a_(Property<T> p_239895_0_, T p_239895_1_, ResourceLocation p_239895_2_, ResourceLocation p_239895_3_) {
      BlockModelDefinition blockmodeldefinition = BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239895_2_);
      BlockModelDefinition blockmodeldefinition1 = BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239895_3_);
   ...
   private void func_239887_a_(Block p_239887_1_, Function<Block, ModelTextures> p_239887_2_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(p_239887_1_).func_240125_a_(func_239933_b_()).func_240125_a_(func_239895_a_(BlockStateProperties.HONEY_LEVEL, 5, resourcelocation1, resourcelocation)));
   }
   ...
   private void func_239876_a_(Block p_239876_1_, Property<Integer> p_239876_2_, int... p_239876_3_) {
      if (p_239876_2_.getAllowedValues().size() != p_239876_3_.length) {
         ...
         BlockStateVariantBuilder blockstatevariantbuilder = BlockStateVariantBuilder.func_240133_a_(p_239876_2_).func_240145_a_((p_239920_4_) -> {
            ...
            return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation);
         });
         this.func_239866_a_(p_239876_1_.asItem());
         this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(p_239876_1_).func_240125_a_(blockstatevariantbuilder));
      }
   }
   ...
   private void func_240017_l_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.BELL).func_240125_a_(BlockStateVariantBuilder.func_240134_a_(BlockStateProperties.HORIZONTAL_FACING, BlockStateProperties.BELL_ATTACHMENT).func_240149_a_(Direction.NORTH, BellAttachment.FLOOR, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation)).func_240149_a_(Direction.SOUTH, BellAttachment.FLOOR, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(Direction.EAST, BellAttachment.FLOOR, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240149_a_(Direction.WEST, BellAttachment.FLOOR, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240149_a_(Direction.NORTH, BellAttachment.CEILING, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1)).func_240149_a_(Direction.SOUTH, BellAttachment.CEILING, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(Direction.EAST, BellAttachment.CEILING, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240149_a_(Direction.WEST, BellAttachment.CEILING, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240149_a_(Direction.NORTH, BellAttachment.SINGLE_WALL, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240149_a_(Direction.SOUTH, BellAttachment.SINGLE_WALL, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240149_a_(Direction.EAST, BellAttachment.SINGLE_WALL, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2)).func_240149_a_(Direction.WEST, BellAttachment.SINGLE_WALL, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(Direction.SOUTH, BellAttachment.DOUBLE_WALL, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240149_a_(Direction.NORTH, BellAttachment.DOUBLE_WALL, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240149_a_(Direction.EAST, BellAttachment.DOUBLE_WALL, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3)).func_240149_a_(Direction.WEST, BellAttachment.DOUBLE_WALL, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180))));
   }

   private void func_240020_m_() {
      this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(Blocks.GRINDSTONE, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240221_a_(Blocks.GRINDSTONE))).func_240125_a_(BlockStateVariantBuilder.func_240134_a_(BlockStateProperties.FACE, BlockStateProperties.HORIZONTAL_FACING).func_240149_a_(AttachFace.FLOOR, Direction.NORTH, BlockModelDefinition.getNewModelDefinition()).func_240149_a_(AttachFace.FLOOR, Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240149_a_(AttachFace.FLOOR, Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(AttachFace.FLOOR, Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240149_a_(AttachFace.WALL, Direction.NORTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90)).func_240149_a_(AttachFace.WALL, Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240149_a_(AttachFace.WALL, Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(AttachFace.WALL, Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240149_a_(AttachFace.CEILING, Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(AttachFace.CEILING, Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240149_a_(AttachFace.CEILING, Direction.NORTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(AttachFace.CEILING, Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270))));
   }
   ...
   private void func_239977_e_(Block p_239977_1_, TexturedModel.ISupplier p_239977_2_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(p_239977_1_).func_240125_a_(func_239894_a_(BlockStateProperties.LIT, resourcelocation2, resourcelocation)).func_240125_a_(func_239933_b_()));
   }
   ...
   private void func_239921_a_(Block... p_239921_1_) {
      ...
      for(Block block : p_239921_1_) {
         ...
         this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(block).func_240125_a_(func_239894_a_(BlockStateProperties.LIT, resourcelocation1, resourcelocation)).func_240125_a_(func_239952_c_()));
      }
   ...
   private void func_240024_o_() {
      ...
      this.field_239834_a_.accept(FinishedMultiPartBlockState.func_240106_a_(Blocks.REDSTONE_WIRE).func_240108_a_(IMultiPartPredicateBuilder.func_240090_b_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.REDSTONE_NORTH, RedstoneSide.NONE).func_240098_a_(BlockStateProperties.REDSTONE_EAST, RedstoneSide.NONE).func_240098_a_(BlockStateProperties.REDSTONE_SOUTH, RedstoneSide.NONE).func_240098_a_(BlockStateProperties.REDSTONE_WEST, RedstoneSide.NONE), IMultiPartPredicateBuilder.func_240089_a_().func_240099_a_(BlockStateProperties.REDSTONE_NORTH, RedstoneSide.SIDE, RedstoneSide.UP).func_240099_a_(BlockStateProperties.REDSTONE_EAST, RedstoneSide.SIDE, RedstoneSide.UP), IMultiPartPredicateBuilder.func_240089_a_().func_240099_a_(BlockStateProperties.REDSTONE_EAST, RedstoneSide.SIDE, RedstoneSide.UP).func_240099_a_(BlockStateProperties.REDSTONE_SOUTH, RedstoneSide.SIDE, RedstoneSide.UP), IMultiPartPredicateBuilder.func_240089_a_().func_240099_a_(BlockStateProperties.REDSTONE_SOUTH, RedstoneSide.SIDE, RedstoneSide.UP).func_240099_a_(BlockStateProperties.REDSTONE_WEST, RedstoneSide.SIDE, RedstoneSide.UP), IMultiPartPredicateBuilder.func_240089_a_().func_240099_a_(BlockStateProperties.REDSTONE_WEST, RedstoneSide.SIDE, RedstoneSide.UP).func_240099_a_(BlockStateProperties.REDSTONE_NORTH, RedstoneSide.SIDE, RedstoneSide.UP)), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240223_a_("redstone_dust_dot"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240099_a_(BlockStateProperties.REDSTONE_NORTH, RedstoneSide.SIDE, RedstoneSide.UP), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240223_a_("redstone_dust_side0"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240099_a_(BlockStateProperties.REDSTONE_SOUTH, RedstoneSide.SIDE, RedstoneSide.UP), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240223_a_("redstone_dust_side_alt0"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240099_a_(BlockStateProperties.REDSTONE_EAST, RedstoneSide.SIDE, RedstoneSide.UP), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240223_a_("redstone_dust_side_alt1")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240099_a_(BlockStateProperties.REDSTONE_WEST, RedstoneSide.SIDE, RedstoneSide.UP), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240223_a_("redstone_dust_side1")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.REDSTONE_NORTH, RedstoneSide.UP), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240223_a_("redstone_dust_up"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.REDSTONE_EAST, RedstoneSide.UP), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240223_a_("redstone_dust_up")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.REDSTONE_SOUTH, RedstoneSide.UP), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240223_a_("redstone_dust_up")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.REDSTONE_WEST, RedstoneSide.UP), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240223_a_("redstone_dust_up")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)));
   }

   private void func_240026_p_() {
      this.func_239866_a_(Items.COMPARATOR);
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.COMPARATOR).func_240125_a_(func_239952_c_()).func_240125_a_(BlockStateVariantBuilder.func_240134_a_(BlockStateProperties.COMPARATOR_MODE, BlockStateProperties.POWERED).func_240149_a_(ComparatorMode.COMPARE, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240221_a_(Blocks.COMPARATOR))).func_240149_a_(ComparatorMode.COMPARE, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.COMPARATOR, "_on"))).func_240149_a_(ComparatorMode.SUBTRACT, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.COMPARATOR, "_subtract"))).func_240149_a_(ComparatorMode.SUBTRACT, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.COMPARATOR, "_on_subtract")))));
   }
   ...
   private void func_240030_r_() {
      ...
      this.field_239834_a_.accept(FinishedMultiPartBlockState.func_240106_a_(Blocks.BREWING_STAND).func_240111_a_(BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240341_C_(Blocks.BREWING_STAND))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.HAS_BOTTLE_0, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.BREWING_STAND, "_bottle0"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.HAS_BOTTLE_1, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.BREWING_STAND, "_bottle1"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.HAS_BOTTLE_2, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.BREWING_STAND, "_bottle2"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.HAS_BOTTLE_0, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.BREWING_STAND, "_empty0"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.HAS_BOTTLE_1, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.BREWING_STAND, "_empty1"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.HAS_BOTTLE_2, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.BREWING_STAND, "_empty2"))));
   }
   ...
   private void func_240027_p_(Block p_240027_1_) {
      ...
      this.field_239834_a_.accept(FinishedMultiPartBlockState.func_240106_a_(p_240027_1_).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.EAST, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.SOUTH, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WEST, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.UP, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.DOWN, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.EAST, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, false)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.SOUTH, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, false)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WEST, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, false)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.UP, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, false)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.DOWN, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, false)));
   ...
   private void func_240032_s_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.CAKE).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.BITES_0_6).func_240143_a_(0, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240221_a_(Blocks.CAKE))).func_240143_a_(1, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.CAKE, "_slice1"))).func_240143_a_(2, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.CAKE, "_slice2"))).func_240143_a_(3, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.CAKE, "_slice3"))).func_240143_a_(4, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.CAKE, "_slice4"))).func_240143_a_(5, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.CAKE, "_slice5"))).func_240143_a_(6, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.CAKE, "_slice6")))));
   }
   ...
   private void func_239879_a_(Block p_239879_1_, ModelTextures p_239879_2_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(p_239879_1_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation)).func_240125_a_(func_239933_b_()));
   }

   private void func_240040_w_() {
      this.func_239866_a_(Items.CAULDRON);
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.CAULDRON).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.LEVEL_0_3).func_240143_a_(0, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240221_a_(Blocks.CAULDRON))).func_240143_a_(1, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.CAULDRON, "_level1"))).func_240143_a_(2, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.CAULDRON, "_level2"))).func_240143_a_(3, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.CAULDRON, "_level3")))));
   }
   ...
   private void func_240042_x_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.CHORUS_FLOWER).func_240125_a_(func_239895_a_(BlockStateProperties.AGE_0_5, 5, resourcelocation1, resourcelocation)));
   }
   ...
   private void func_240029_q_(Block p_240029_1_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(p_240029_1_).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.FACING).func_240143_a_(Direction.DOWN, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180)).func_240143_a_(Direction.UP, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1)).func_240143_a_(Direction.NORTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation)).func_240143_a_(Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240143_a_(Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240143_a_(Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270))));
   }
   ...
   private void func_240045_z_() {
      ...
      this.field_239834_a_.accept(FinishedMultiPartBlockState.func_240106_a_(Blocks.CHORUS_PLANT).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.EAST, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.SOUTH, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WEST, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.UP, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.DOWN, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240110_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.WEIGHT, 2), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation4)).func_240110_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.EAST, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation4).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.WEIGHT, 2).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240110_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.SOUTH, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation4).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.WEIGHT, 2).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240110_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WEST, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation4).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.WEIGHT, 2).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240110_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.UP, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.WEIGHT, 2).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation4).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.UVLOCK, true)).func_240110_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.DOWN, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation4).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.WEIGHT, 2).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.UVLOCK, true)));
   }

   private void func_239837_A_() {
      this.field_239834_a_.accept(FinishedMultiPartBlockState.func_240106_a_(Blocks.COMPOSTER).func_240111_a_(BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240341_C_(Blocks.COMPOSTER))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.LEVEL_0_8, 1), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.COMPOSTER, "_contents1"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.LEVEL_0_8, 2), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.COMPOSTER, "_contents2"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.LEVEL_0_8, 3), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.COMPOSTER, "_contents3"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.LEVEL_0_8, 4), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.COMPOSTER, "_contents4"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.LEVEL_0_8, 5), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.COMPOSTER, "_contents5"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.LEVEL_0_8, 6), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.COMPOSTER, "_contents6"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.LEVEL_0_8, 7), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.COMPOSTER, "_contents7"))).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.LEVEL_0_8, 8), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.COMPOSTER, "_contents_ready"))));
   }
   ...
   private void func_239838_B_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.DAYLIGHT_DETECTOR).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.INVERTED).func_240143_a_(false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, StockModelShapes.TEMPLATE_DAYLIGHT_SENSOR.func_240228_a_(Blocks.DAYLIGHT_DETECTOR, modeltextures, this.field_239835_b_))).func_240143_a_(true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, StockModelShapes.TEMPLATE_DAYLIGHT_SENSOR.func_240234_a_(ModelsResourceUtil.func_240222_a_(Blocks.DAYLIGHT_DETECTOR, "_inverted"), modeltextures1, this.field_239835_b_)))));
   }

   private void func_239839_C_(Block p_239839_1_) {
      this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(p_239839_1_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240221_a_(p_239839_1_))).func_240125_a_(this.func_240008_j_()));
   }
   ...
   private void func_239840_D_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.FARMLAND).func_240125_a_(func_239895_a_(BlockStateProperties.MOISTURE_0_7, 7, resourcelocation1, resourcelocation)));
   }
   ...
   private static List<BlockModelDefinition> func_239914_a_(List<ResourceLocation> p_239914_0_, UnaryOperator<BlockModelDefinition> p_239914_1_) {
      return p_239914_0_.stream().map((p_239950_0_) -> {
         return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239950_0_);
   ...
   private void func_239841_E_() {
      ...
      this.field_239834_a_.accept(FinishedMultiPartBlockState.func_240106_a_(Blocks.FIRE).func_240109_a_(imultipartpredicatebuilder, func_239914_a_(list, (p_240016_0_) -> {
         ...
         return p_240007_0_.replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90);
         ...
         return p_240002_0_.replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180);
         ...
         return p_239996_0_.replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270);
   ...
   private void func_239842_F_() {
      ...
      this.field_239834_a_.accept(FinishedMultiPartBlockState.func_240106_a_(Blocks.SOUL_FIRE).func_240112_a_(func_239914_a_(list, (p_239981_0_) -> {
         ...
         return p_239961_0_.replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90);
      })).func_240112_a_(func_239914_a_(list1, (p_239945_0_) -> {
         return p_239945_0_.replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180);
      })).func_240112_a_(func_239914_a_(list1, (p_239904_0_) -> {
         return p_239904_0_.replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270);
      })));
   }
   ...
   private void func_240039_v_(Block p_240039_1_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(p_240039_1_).func_240125_a_(func_239894_a_(BlockStateProperties.HANGING, resourcelocation1, resourcelocation)));
   }

   private void func_239843_G_() {
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.FROSTED_ICE).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.AGE_0_3).func_240143_a_(0, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, this.func_239886_a_(Blocks.FROSTED_ICE, "_0", StockModelShapes.CUBE_ALL, ModelTextures::func_240356_b_))).func_240143_a_(1, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, this.func_239886_a_(Blocks.FROSTED_ICE, "_1", StockModelShapes.CUBE_ALL, ModelTextures::func_240356_b_))).func_240143_a_(2, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, this.func_239886_a_(Blocks.FROSTED_ICE, "_2", StockModelShapes.CUBE_ALL, ModelTextures::func_240356_b_))).func_240143_a_(3, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, this.func_239886_a_(Blocks.FROSTED_ICE, "_3", StockModelShapes.CUBE_ALL, ModelTextures::func_240356_b_)))));
   }
   ...
   private void func_239844_H_() {
      ...
      BlockModelDefinition blockmodeldefinition = BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, StockModelShapes.CUBE_BOTTOM_TOP.func_240229_a_(Blocks.GRASS_BLOCK, "_snow", modeltextures, this.field_239835_b_));
   ...
   private void func_239889_a_(Block p_239889_1_, ResourceLocation p_239889_2_, BlockModelDefinition p_239889_3_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(p_239889_1_).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.SNOWY).func_240143_a_(true, p_239889_3_).func_240144_a_(false, list)));
   }

   private void func_239845_I_() {
      this.func_239866_a_(Items.COCOA_BEANS);
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.COCOA).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.AGE_0_2).func_240143_a_(0, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.COCOA, "_stage0"))).func_240143_a_(1, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.COCOA, "_stage1"))).func_240143_a_(2, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.COCOA, "_stage2")))).func_240125_a_(func_239952_c_()));
   }
   ...
   private void func_239999_h_(Block p_239999_1_, Block p_239999_2_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(p_239999_1_).func_240125_a_(func_239895_a_(BlockStateProperties.POWER_0_15, 1, resourcelocation1, resourcelocation)));
   }
   ...
   private void func_239847_K_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.HOPPER).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.FACING_EXCEPT_UP).func_240143_a_(Direction.DOWN, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation)).func_240143_a_(Direction.NORTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1)).func_240143_a_(Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240143_a_(Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240143_a_(Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270))));
   }
   ...
   private void func_240005_i_(Block p_240005_1_, Block p_240005_2_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(p_240005_2_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation)));
   ...
   private void func_239848_L_() {
      ...
      this.field_239834_a_.accept(FinishedMultiPartBlockState.func_240106_a_(Blocks.IRON_BARS).func_240111_a_(BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, false).func_240098_a_(BlockStateProperties.EAST, false).func_240098_a_(BlockStateProperties.SOUTH, false).func_240098_a_(BlockStateProperties.WEST, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation1)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, true).func_240098_a_(BlockStateProperties.EAST, false).func_240098_a_(BlockStateProperties.SOUTH, false).func_240098_a_(BlockStateProperties.WEST, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, false).func_240098_a_(BlockStateProperties.EAST, true).func_240098_a_(BlockStateProperties.SOUTH, false).func_240098_a_(BlockStateProperties.WEST, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation2).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, false).func_240098_a_(BlockStateProperties.EAST, false).func_240098_a_(BlockStateProperties.SOUTH, true).func_240098_a_(BlockStateProperties.WEST, false), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, false).func_240098_a_(BlockStateProperties.EAST, false).func_240098_a_(BlockStateProperties.SOUTH, false).func_240098_a_(BlockStateProperties.WEST, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation3).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.NORTH, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation4)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.EAST, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation4).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.SOUTH, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation5)).func_240108_a_(IMultiPartPredicateBuilder.func_240089_a_().func_240098_a_(BlockStateProperties.WEST, true), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation5).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)));
      this.func_239934_b_(Blocks.IRON_BARS);
   }

   private void func_240041_w_(Block p_240041_1_) {
      this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(p_240041_1_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240221_a_(p_240041_1_))).func_240125_a_(func_239933_b_()));
   }
   ...
   private void func_239849_M_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.LEVER).func_240125_a_(func_239894_a_(BlockStateProperties.POWERED, resourcelocation, resourcelocation1)).func_240125_a_(BlockStateVariantBuilder.func_240134_a_(BlockStateProperties.FACE, BlockStateProperties.HORIZONTAL_FACING).func_240149_a_(AttachFace.CEILING, Direction.NORTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(AttachFace.CEILING, Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240149_a_(AttachFace.CEILING, Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(AttachFace.CEILING, Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240149_a_(AttachFace.FLOOR, Direction.NORTH, BlockModelDefinition.getNewModelDefinition()).func_240149_a_(AttachFace.FLOOR, Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240149_a_(AttachFace.FLOOR, Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(AttachFace.FLOOR, Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240149_a_(AttachFace.WALL, Direction.NORTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90)).func_240149_a_(AttachFace.WALL, Direction.EAST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240149_a_(AttachFace.WALL, Direction.SOUTH, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240149_a_(AttachFace.WALL, Direction.WEST, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270))));
   }
   ...
   private void func_239851_O_() {
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.NETHER_PORTAL).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.HORIZONTAL_AXIS).func_240143_a_(Direction.Axis.X, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.NETHER_PORTAL, "_ns"))).func_240143_a_(Direction.Axis.Z, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.NETHER_PORTAL, "_ew")))));
   }
   ...
   private void func_239852_P_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.func_240121_a_(Blocks.NETHERRACK, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R180), BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270)));
   }
   ...
   private void func_239853_Q_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.OBSERVER).func_240125_a_(func_239894_a_(BlockStateProperties.POWERED, resourcelocation1, resourcelocation)).func_240125_a_(func_239974_e_()));
   }
   ...
   private void func_239890_a_(Block p_239890_1_, ResourceLocation p_239890_2_, ModelTextures p_239890_3_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(p_239890_1_).func_240125_a_(func_239894_a_(BlockStateProperties.EXTENDED, p_239890_2_, resourcelocation)).func_240125_a_(func_239974_e_()));
   }
   ...
   private void func_239855_S_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.PISTON_HEAD).func_240125_a_(BlockStateVariantBuilder.func_240134_a_(BlockStateProperties.SHORT, BlockStateProperties.PISTON_TYPE).func_240149_a_(false, PistonType.DEFAULT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, StockModelShapes.TEMPLATE_PISTON_HEAD.func_240229_a_(Blocks.PISTON, "_head", modeltextures2, this.field_239835_b_))).func_240149_a_(false, PistonType.STICKY, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, StockModelShapes.TEMPLATE_PISTON_HEAD.func_240229_a_(Blocks.PISTON, "_head_sticky", modeltextures1, this.field_239835_b_))).func_240149_a_(true, PistonType.DEFAULT, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, StockModelShapes.TEMPLATE_PISTON_HEAD_SHORT.func_240229_a_(Blocks.PISTON, "_head_short", modeltextures2, this.field_239835_b_))).func_240149_a_(true, PistonType.STICKY, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, StockModelShapes.TEMPLATE_PISTON_HEAD_SHORT.func_240229_a_(Blocks.PISTON, "_head_short_sticky", modeltextures1, this.field_239835_b_)))).func_240125_a_(func_239974_e_()));
   }
   ...
   private void func_239856_T_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.SCAFFOLDING).func_240125_a_(func_239894_a_(BlockStateProperties.BOTTOM, resourcelocation1, resourcelocation)));
   }
   ...
   private void func_239857_U_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.REDSTONE_LAMP).func_240125_a_(func_239894_a_(BlockStateProperties.LIT, resourcelocation1, resourcelocation)));
   }
   ...
   private void func_240010_j_(Block p_240010_1_, Block p_240010_2_) {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(p_240010_2_, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, StockModelShapes.TEMPLATE_TORCH_WALL.func_240228_a_(p_240010_2_, modeltextures, this.field_239835_b_))).func_240125_a_(func_239964_d_()));
   ...
   private void func_239858_V_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.REDSTONE_TORCH).func_240125_a_(func_239894_a_(BlockStateProperties.LIT, resourcelocation, resourcelocation1)));
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.REDSTONE_WALL_TORCH).func_240125_a_(func_239894_a_(BlockStateProperties.LIT, resourcelocation2, resourcelocation3)).func_240125_a_(func_239964_d_()));
   ...
   private void func_239859_W_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.REPEATER).func_240125_a_(BlockStateVariantBuilder.func_240135_a_(BlockStateProperties.DELAY_1_4, BlockStateProperties.LOCKED, BlockStateProperties.POWERED).func_240160_a_((p_239911_0_, p_239911_1_, p_239911_2_) -> {
         ...
         return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.REPEATER, stringbuilder.toString()));
   ...
   private void func_239861_Y_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.SNOW).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.LAYERS_1_8).func_240145_a_((p_239918_1_) -> {
         return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, p_239918_1_ < 8 ? ModelsResourceUtil.func_240222_a_(Blocks.SNOW, "_height" + p_239918_1_ * 2) : resourcelocation);
      })));
   ...
   private void func_239862_Z_() {
      this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(Blocks.STONECUTTER, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240221_a_(Blocks.STONECUTTER))).func_240125_a_(func_239933_b_()));
   }
   ...
   private void func_239923_aa_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.STRUCTURE_BLOCK).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.STRUCTURE_BLOCK_MODE).func_240145_a_((p_239896_1_) -> {
         return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, this.func_239886_a_(Blocks.STRUCTURE_BLOCK, "_" + p_239896_1_.getString(), StockModelShapes.CUBE_ALL, ModelTextures::func_240356_b_));
      })));
   }

   private void func_239924_ab_() {
      this.func_239866_a_(Items.SWEET_BERRIES);
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.SWEET_BERRY_BUSH).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.AGE_0_3).func_240145_a_((p_239910_1_) -> {
         return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, this.func_239886_a_(Blocks.SWEET_BERRY_BUSH, "_stage" + p_239910_1_, StockModelShapes.CROSS, ModelTextures::func_240361_c_));
      })));
   }

   private void func_239925_ac_() {
      this.func_239866_a_(Items.STRING);
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.TRIPWIRE).func_240125_a_(BlockStateVariantBuilder.func_240137_a_(BlockStateProperties.ATTACHED, BlockStateProperties.EAST, BlockStateProperties.NORTH, BlockStateProperties.SOUTH, BlockStateProperties.WEST).func_240177_a_(false, false, false, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_ns"))).func_240177_a_(false, true, false, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_n")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(false, false, true, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_n"))).func_240177_a_(false, false, false, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_n")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240177_a_(false, false, false, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_n")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240177_a_(false, true, true, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_ne"))).func_240177_a_(false, true, false, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_ne")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(false, false, false, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_ne")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240177_a_(false, false, true, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_ne")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240177_a_(false, false, true, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_ns"))).func_240177_a_(false, true, false, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_ns")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(false, true, true, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_nse"))).func_240177_a_(false, true, false, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_nse")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(false, false, true, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_nse")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240177_a_(false, true, true, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_nse")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240177_a_(false, true, true, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_nsew"))).func_240177_a_(true, false, false, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_ns"))).func_240177_a_(true, false, true, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_n"))).func_240177_a_(true, false, false, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_n")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240177_a_(true, true, false, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_n")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(true, false, false, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_n")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240177_a_(true, true, true, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_ne"))).func_240177_a_(true, true, false, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_ne")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(true, false, false, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_ne")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240177_a_(true, false, true, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_ne")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240177_a_(true, false, true, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_ns"))).func_240177_a_(true, true, false, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_ns")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(true, true, true, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_nse"))).func_240177_a_(true, true, false, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_nse")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(true, false, true, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_nse")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240177_a_(true, true, true, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_nse")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240177_a_(true, true, true, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.TRIPWIRE, "_attached_nsew")))));
   }

   private void func_239926_ad_() {
      this.func_239934_b_(Blocks.TRIPWIRE_HOOK);
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.TRIPWIRE_HOOK).func_240125_a_(BlockStateVariantBuilder.func_240134_a_(BlockStateProperties.ATTACHED, BlockStateProperties.POWERED).func_240152_a_((p_239908_0_, p_239908_1_) -> {
         return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelTextures.func_240347_a_(Blocks.TRIPWIRE_HOOK, (p_239908_0_ ? "_attached" : "") + (p_239908_1_ ? "_on" : "")));
   ...
   private void func_239927_ae_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.TURTLE_EGG).func_240125_a_(BlockStateVariantBuilder.func_240134_a_(BlockStateProperties.EGGS_1_4, BlockStateProperties.HATCH_0_2).func_240155_b_((p_239949_1_, p_239949_2_) -> {
   ...
   private void func_239928_af_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.VINE).func_240125_a_(BlockStateVariantBuilder.func_240137_a_(BlockStateProperties.EAST, BlockStateProperties.NORTH, BlockStateProperties.SOUTH, BlockStateProperties.UP, BlockStateProperties.WEST).func_240177_a_(false, false, false, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_1"))).func_240177_a_(false, false, true, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_1"))).func_240177_a_(false, false, false, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_1")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(false, true, false, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_1")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240177_a_(true, false, false, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_1")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240177_a_(true, true, false, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_2"))).func_240177_a_(true, false, true, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_2")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(false, false, true, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_2")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240177_a_(false, true, false, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_2")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240177_a_(true, false, false, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_2_opposite"))).func_240177_a_(false, true, true, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_2_opposite")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(true, true, true, false, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_3"))).func_240177_a_(true, false, true, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_3")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(false, true, true, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_3")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240177_a_(true, true, false, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_3")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240177_a_(true, true, true, false, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_4"))).func_240177_a_(false, false, false, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_u"))).func_240177_a_(false, false, true, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_1u"))).func_240177_a_(false, false, false, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_1u")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(false, true, false, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_1u")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240177_a_(true, false, false, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_1u")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240177_a_(true, true, false, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_2u"))).func_240177_a_(true, false, true, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_2u")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(false, false, true, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_2u")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240177_a_(false, true, false, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_2u")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240177_a_(true, false, false, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_2u_opposite"))).func_240177_a_(false, true, true, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_2u_opposite")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(true, true, true, true, false, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_3u"))).func_240177_a_(true, false, true, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_3u")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90)).func_240177_a_(false, true, true, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_3u")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180)).func_240177_a_(true, true, false, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_3u")).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270)).func_240177_a_(true, true, true, true, true, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, ModelsResourceUtil.func_240222_a_(Blocks.VINE, "_4u")))));
   }
   ...
   private void func_239931_ai_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.fromBlock(Blocks.RESPAWN_ANCHOR).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.CHARGES).func_240145_a_((p_239922_1_) -> {
         return BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, aresourcelocation[p_239922_1_]);
      })));
   ...
   private BlockModelDefinition func_239898_a_(JigsawOrientation p_239898_1_, BlockModelDefinition p_239898_2_) {
      switch(p_239898_1_) {
      case DOWN_NORTH:
         return p_239898_2_.replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90);
      case DOWN_SOUTH:
         return p_239898_2_.replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180);
      case DOWN_WEST:
         return p_239898_2_.replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270);
      case DOWN_EAST:
         return p_239898_2_.replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R90).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90);
      case UP_NORTH:
         return p_239898_2_.replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180);
      case UP_SOUTH:
         return p_239898_2_.replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270);
      case UP_WEST:
         return p_239898_2_.replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90);
      case UP_EAST:
         return p_239898_2_.replaceInfoValue(BlockModelFields.X_ROTATIONS, BlockModelFields.Rotation.R270).replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270);
      case NORTH_UP:
         return p_239898_2_;
      case SOUTH_UP:
         return p_239898_2_.replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R180);
      case WEST_UP:
         return p_239898_2_.replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R270);
      case EAST_UP:
         return p_239898_2_.replaceInfoValue(BlockModelFields.Y_ROTATIONS, BlockModelFields.Rotation.R90);
      default:
   ...
   private void func_239932_aj_() {
      ...
      this.field_239834_a_.accept(FinishedVariantBlockState.func_240120_a_(Blocks.JIGSAW, BlockModelDefinition.getNewModelDefinition().replaceInfoValue(BlockModelFields.MODEL, resourcelocation4)).func_240125_a_(BlockStateVariantBuilder.func_240133_a_(BlockStateProperties.ORIENTATION).func_240145_a_((p_239897_1_) -> {
