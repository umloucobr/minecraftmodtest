...
public abstract class DynamicRegistries {
   ...
   private static final Map<RegistryKey<? extends Registry<?>>, DynamicRegistries.CodecHolder<?>> registryCodecMap = Util.make(() -> {
      ...
      put(builder, Registry.CONFIGURED_FEATURE_KEY, ConfiguredFeature.CODEC);
      put(builder, Registry.CONFIGURED_STRUCTURE_FEATURE_KEY, StructureFeature.CODEC);
      put(builder, Registry.STRUCTURE_PROCESSOR_LIST_KEY, IStructureProcessorType.PROCESSOR_LIST_OBJECT_CODEC);
      put(builder, Registry.JIGSAW_POOL_KEY, JigsawPattern.field_236852_a_);
      put(builder, Registry.NOISE_SETTINGS_KEY, DimensionSettings.CODEC);
