         ...
         if (p_deserialize_1_.isJsonPrimitive()) {
            ...
            if (p_deserialize_1_.isJsonArray()) {
               ...
               for(JsonElement jsonelement : jsonarray1) {
                  ...
                  if (iformattabletextcomponent1 == null) {
                     ...
                     iformattabletextcomponent1.appendSibling(iformattabletextcomponent2);
                  }
               }
            ...
            if (jsonobject.has("extra")) {
               ...
               for(int j = 0; j < jsonarray2.size(); ++j) {
                  iformattabletextcomponent.appendSibling(this.deserialize(jsonarray2.get(j), p_deserialize_2_, p_deserialize_3_));
               }
            }
