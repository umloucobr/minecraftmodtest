...
public enum BlockVoxelShape {
   FULL {
      public boolean func_241854_a(BlockState p_241854_1_, IBlockReader p_241854_2_, BlockPos p_241854_3_, Direction p_241854_4_) {
         return Block.doesSideFillSquare(p_241854_1_.getCollisionShape(p_241854_2_, p_241854_3_), p_241854_4_);
      }
   },
   CENTER {
      ...
      public boolean func_241854_a(BlockState p_241854_1_, IBlockReader p_241854_2_, BlockPos p_241854_3_, Direction p_241854_4_) {
         return !VoxelShapes.compare(p_241854_1_.getCollisionShape(p_241854_2_, p_241854_3_).project(p_241854_4_), this.field_242681_e, IBooleanFunction.ONLY_SECOND);
      }
   },
   RIGID {
      ...
      public boolean func_241854_a(BlockState p_241854_1_, IBlockReader p_241854_2_, BlockPos p_241854_3_, Direction p_241854_4_) {
         return !VoxelShapes.compare(p_241854_1_.getCollisionShape(p_241854_2_, p_241854_3_).project(p_241854_4_), this.field_242683_e, IBooleanFunction.ONLY_SECOND);
      }
   };
