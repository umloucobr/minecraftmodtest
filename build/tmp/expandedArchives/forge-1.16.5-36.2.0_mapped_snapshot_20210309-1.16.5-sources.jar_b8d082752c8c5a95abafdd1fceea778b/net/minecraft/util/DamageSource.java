...
public class DamageSource {
   ...
   public static DamageSource causeFireworkDamage(FireworkRocketEntity firework, @Nullable Entity indirectEntityIn) {
      return (new IndirectEntityDamageSource("fireworks", firework, indirectEntityIn)).setExplosion();
   }

   public static DamageSource causeOnFireDamage(AbstractFireballEntity fireball, @Nullable Entity indirectEntityIn) {
   ...
   public static DamageSource causeWitherSkullDamage(WitherSkullEntity witherSkull, Entity indirectEntityIn) {
      return (new IndirectEntityDamageSource("witherSkull", witherSkull, indirectEntityIn)).setProjectile();
   }
