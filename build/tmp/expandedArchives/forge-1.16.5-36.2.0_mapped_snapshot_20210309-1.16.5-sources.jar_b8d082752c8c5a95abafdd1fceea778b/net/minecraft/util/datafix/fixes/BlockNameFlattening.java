...
public class BlockNameFlattening extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<Pair<String, Either<Integer, String>>> type2 = DSL.named(TypeReferences.BLOCK_NAME.typeName(), DSL.or(DSL.intType(), NamespacedSchema.getType()));
      Type<Pair<String, String>> type3 = DSL.named(TypeReferences.BLOCK_NAME.typeName(), NamespacedSchema.getType());
