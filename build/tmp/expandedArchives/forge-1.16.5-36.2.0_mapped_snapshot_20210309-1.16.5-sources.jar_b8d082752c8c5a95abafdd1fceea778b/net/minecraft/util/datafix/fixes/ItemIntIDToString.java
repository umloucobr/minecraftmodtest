...
public class ItemIntIDToString extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> type = DSL.or(DSL.intType(), DSL.named(TypeReferences.ITEM_NAME.typeName(), NamespacedSchema.getType()));
      Type<Pair<String, String>> type1 = DSL.named(TypeReferences.ITEM_NAME.typeName(), NamespacedSchema.getType());
