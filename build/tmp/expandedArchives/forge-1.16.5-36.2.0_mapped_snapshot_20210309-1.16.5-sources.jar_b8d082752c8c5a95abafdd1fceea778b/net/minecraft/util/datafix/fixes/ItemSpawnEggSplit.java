...
public class ItemSpawnEggSplit extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      OpticFinder<Pair<String, String>> opticfinder = DSL.fieldFinder("id", DSL.named(TypeReferences.ITEM_NAME.typeName(), NamespacedSchema.getType()));
      OpticFinder<String> opticfinder1 = DSL.fieldFinder("id", NamespacedSchema.getType());
