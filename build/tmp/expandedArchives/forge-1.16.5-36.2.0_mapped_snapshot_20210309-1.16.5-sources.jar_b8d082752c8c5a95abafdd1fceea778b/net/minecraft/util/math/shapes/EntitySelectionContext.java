...
public class EntitySelectionContext implements ISelectionContext {
   ...
   protected EntitySelectionContext(Entity entityIn) {
      this(entityIn, entityIn.isDescending(), entityIn.getPosY(), entityIn instanceof LivingEntity ? ((LivingEntity)entityIn).getHeldItemMainhand().getItem() : Items.AIR, entityIn instanceof LivingEntity ? ((LivingEntity)entityIn)::func_230285_a_ : (fluid) -> {
         return false;
      });
   }
