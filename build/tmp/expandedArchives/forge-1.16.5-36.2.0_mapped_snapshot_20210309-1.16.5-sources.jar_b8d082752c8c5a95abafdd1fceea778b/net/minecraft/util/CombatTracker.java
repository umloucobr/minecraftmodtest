...
public class CombatTracker {
   ...
   public void calculateFallSuffix() {
      ...
      if (optional.isPresent()) {
         ...
         if (!blockstate.matchesBlock(Blocks.LADDER) && !blockstate.isIn(BlockTags.TRAPDOORS)) {
            if (blockstate.matchesBlock(Blocks.VINE)) {
               this.fallSuffix = "vines";
            } else if (!blockstate.matchesBlock(Blocks.WEEPING_VINES) && !blockstate.matchesBlock(Blocks.WEEPING_VINES_PLANT)) {
               if (!blockstate.matchesBlock(Blocks.TWISTING_VINES) && !blockstate.matchesBlock(Blocks.TWISTING_VINES_PLANT)) {
                  if (blockstate.matchesBlock(Blocks.SCAFFOLDING)) {
