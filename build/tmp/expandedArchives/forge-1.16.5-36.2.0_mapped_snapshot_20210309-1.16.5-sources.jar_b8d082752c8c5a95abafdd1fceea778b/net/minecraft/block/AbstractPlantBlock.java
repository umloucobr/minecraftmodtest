...
public abstract class AbstractPlantBlock extends Block {
   ...
   public BlockState getStateForPlacement(BlockItemUseContext context) {
      ...
      return !blockstate.matchesBlock(this.getTopPlantBlock()) && !blockstate.matchesBlock(this.getBodyPlantBlock()) ? this.grow(context.getWorld()) : this.getBodyPlantBlock().getDefaultState();
   }
