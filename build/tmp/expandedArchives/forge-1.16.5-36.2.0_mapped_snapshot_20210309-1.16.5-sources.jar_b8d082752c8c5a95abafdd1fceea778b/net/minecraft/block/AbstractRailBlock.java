...
public abstract class AbstractRailBlock extends Block implements net.minecraftforge.common.extensions.IAbstractRailBlock {
   ...
   public VoxelShape getShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context) {
      RailShape railshape = state.matchesBlock(this) ? state.get(this.getShapeProperty()) : null;
      RailShape railShape2 = state.matchesBlock(this) ? getRailDirection(state, worldIn, pos, null) : null;
   ...
   public void neighborChanged(BlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos, boolean isMoving) {
      if (!worldIn.isRemote && worldIn.getBlockState(pos).matchesBlock(this)) {
