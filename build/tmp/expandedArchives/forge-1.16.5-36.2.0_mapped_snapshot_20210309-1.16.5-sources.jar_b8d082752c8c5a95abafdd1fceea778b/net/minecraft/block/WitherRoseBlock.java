...
public class WitherRoseBlock extends FlowerBlock {
   ...
   protected boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
      return super.isValidGround(state, worldIn, pos) || state.matchesBlock(Blocks.NETHERRACK) || state.matchesBlock(Blocks.SOUL_SAND) || state.matchesBlock(Blocks.SOUL_SOIL);
   }
