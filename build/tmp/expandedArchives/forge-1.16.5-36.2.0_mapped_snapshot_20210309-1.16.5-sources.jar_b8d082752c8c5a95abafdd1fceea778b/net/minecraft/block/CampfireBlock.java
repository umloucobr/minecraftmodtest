...
public class CampfireBlock extends ContainerBlock implements IWaterLoggable {
   ...
   public static boolean isSmokingBlockAt(World world, BlockPos pos) {
      for(int i = 1; i <= 5; ++i) {
         ...
         boolean flag = VoxelShapes.compare(SMOKING_SHAPE, blockstate.getCollisionShape(world, blockpos, ISelectionContext.dummy()), IBooleanFunction.AND);//Forge fix: MC-201374
         if (flag) {
