...
public class SugarCaneBlock extends Block implements net.minecraftforge.common.IPlantable {
   ...
   public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) {
      ...
      if (blockstate.getBlock() == this) {
         ...
         if (blockstate.matchesBlock(Blocks.GRASS_BLOCK) || blockstate.matchesBlock(Blocks.DIRT) || blockstate.matchesBlock(Blocks.COARSE_DIRT) || blockstate.matchesBlock(Blocks.PODZOL) || blockstate.matchesBlock(Blocks.SAND) || blockstate.matchesBlock(Blocks.RED_SAND)) {
