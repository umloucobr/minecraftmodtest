...
public class AdvancementRewards {
   ...
   public void apply(ServerPlayerEntity player) {
      ...
      LootContext lootcontext = (new LootContext.Builder(player.getServerWorld())).withParameter(LootParameters.THIS_ENTITY, player).withParameter(LootParameters.ORIGIN, player.getPositionVec()).withRandom(player.getRNG()).withLuck(player.getLuck()).build(LootParameterSets.ADVANCEMENT); // FORGE: luck to LootContext
      boolean flag = false;
