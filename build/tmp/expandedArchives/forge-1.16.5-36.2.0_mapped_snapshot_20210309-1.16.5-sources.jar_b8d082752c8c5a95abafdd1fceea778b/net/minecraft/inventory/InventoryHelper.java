...
public class InventoryHelper {
   ...
   public static void dropItems(World world, BlockPos pos, NonNullList<ItemStack> stackList) {
      stackList.forEach((stack) -> {
         spawnItemStack(world, (double)pos.getX(), (double)pos.getY(), (double)pos.getZ(), stack);
      });
   }
