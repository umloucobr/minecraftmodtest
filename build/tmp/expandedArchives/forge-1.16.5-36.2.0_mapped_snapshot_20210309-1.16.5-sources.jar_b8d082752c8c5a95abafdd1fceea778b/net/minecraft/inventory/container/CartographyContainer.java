...
public class CartographyContainer extends Container {
   ...
   private void func_216993_a(ItemStack originalMap, ItemStack p_216993_2_, ItemStack p_216993_3_) {
      this.worldPosCallable.consume((p_216996_4_, p_216996_5_) -> {
         Item item = p_216993_2_.getItem();
         MapData mapdata = FilledMapItem.getData(originalMap, p_216996_4_);
         if (mapdata != null) {
            ItemStack itemstack;
            if (item == Items.PAPER && !mapdata.locked && mapdata.scale < 4) {
               itemstack = originalMap.copy();
