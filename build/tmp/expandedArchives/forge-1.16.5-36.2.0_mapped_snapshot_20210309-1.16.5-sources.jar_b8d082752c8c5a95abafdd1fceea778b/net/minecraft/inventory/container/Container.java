...
public abstract class Container {
   ...
   protected static boolean isWithinUsableDistance(IWorldPosCallable worldPos, PlayerEntity playerIn, Block targetBlock) {
      return worldPos.applyOrElse((p_216960_2_, p_216960_3_) -> {
         return !p_216960_2_.getBlockState(p_216960_3_).matchesBlock(targetBlock) ? false : playerIn.getDistanceSq((double)p_216960_3_.getX() + 0.5D, (double)p_216960_3_.getY() + 0.5D, (double)p_216960_3_.getZ() + 0.5D) <= 64.0D;
      }, true);
   }
