...
public class CommandBlockTileEntity extends TileEntity {
   ...
   public CommandBlockTileEntity.Mode getMode() {
      ...
      if (blockstate.matchesBlock(Blocks.COMMAND_BLOCK)) {
         return CommandBlockTileEntity.Mode.REDSTONE;
      } else if (blockstate.matchesBlock(Blocks.REPEATING_COMMAND_BLOCK)) {
         return CommandBlockTileEntity.Mode.AUTO;
      } else {
         return blockstate.matchesBlock(Blocks.CHAIN_COMMAND_BLOCK) ? CommandBlockTileEntity.Mode.SEQUENCE : CommandBlockTileEntity.Mode.REDSTONE;
      }
   }
