...
public class Scoreboard {
   ...
   public ScoreObjective getObjective(String p_197899_1_) {
    ...
    */
   @Nullable
   public ScoreObjective getObjectiveNullable(@Nullable String name) {
   ...
   protected void func_197905_a(ListNBT p_197905_1_) {
      for(int i = 0; i < p_197905_1_.size(); ++i) {
         ...
         ScoreObjective scoreobjective = this.getObjective(compoundnbt.getString("Objective"));
