...
public class DeathScreen extends Screen {
   ...
   protected void init() {
      ...
      this.field_243285_p = (new TranslationTextComponent("deathScreen.score")).appendString(": ").appendSibling((new StringTextComponent(Integer.toString(this.minecraft.player.getScore()))).mergeStyle(TextFormatting.YELLOW));
   }
