...
public class AdvancementToast implements IToast {
   ...
   public IToast.Visibility func_230444_a_(MatrixStack p_230444_1_, ToastGui p_230444_2_, long p_230444_3_) {
      ...
      if (displayinfo != null) {
         ...
         if (list.size() == 1) {
            p_230444_2_.getMinecraft().fontRenderer.drawText(p_230444_1_, displayinfo.getFrame().getTranslatedToast(), 30.0F, 7.0F, i | -16777216);
            ...
            if (p_230444_3_ < 1500L) {
               ...
               p_230444_2_.getMinecraft().fontRenderer.drawText(p_230444_1_, displayinfo.getFrame().getTranslatedToast(), 30.0F, 11.0F, i | k);
            } else {
