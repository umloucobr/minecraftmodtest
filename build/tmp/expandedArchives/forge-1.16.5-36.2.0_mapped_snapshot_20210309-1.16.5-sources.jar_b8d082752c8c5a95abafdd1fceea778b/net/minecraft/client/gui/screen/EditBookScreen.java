...
public class EditBookScreen extends Screen {
   ...
   private void func_238755_a_(int p_238755_1_) {
      int i = this.field_238748_u_.getSelectionEnd();
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      if (this.bookGettingSigned) {
         ...
         this.font.drawText(matrixStack, field_243340_a, (float)(i + 36 + (114 - k) / 2), 34.0F, 0);
         ...
         this.font.drawText(matrixStack, this.field_243339_L, (float)(i + 36 + (114 - i1) / 2), 60.0F, 0);
         this.font.func_238418_a_(field_243341_b, i + 36, 82, 114, 0);
      } else {
         int j1 = this.font.getStringPropertyWidth(this.field_243338_K);
         this.font.drawText(matrixStack, this.field_243338_K, (float)(i - j1 + 192 - 44), 18.0F, 0);
         EditBookScreen.BookPage editbookscreen$bookpage = this.func_238750_B_();

         for(EditBookScreen.BookLine editbookscreen$bookline : editbookscreen$bookpage.field_238784_f_) {
            this.font.drawText(matrixStack, editbookscreen$bookline.field_238797_c_, (float)editbookscreen$bookline.field_238798_d_, (float)editbookscreen$bookline.field_238799_e_, -16777216);
         }
   ...
   private EditBookScreen.BookPage func_238753_E_() {
      ...
      if (s.isEmpty()) {
         ...
         int i = this.field_238748_u_.getSelectionEnd();
         int j = this.field_238748_u_.getSelectionStart();
