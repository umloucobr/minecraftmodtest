      ...
      for(int i1 = 0; i1 < this.lines.size(); ++i1) {
         ...
         if ((float)l + f + 12.0F + 8.0F > 0.0F && (float)l + f < (float)this.height) {
            ...
            if (this.field_238664_v_.contains(i1)) {
               this.font.drawTextWithShadow(matrixStack, ireorderingprocessor, (float)(j + (274 - this.font.func_243245_a(ireorderingprocessor)) / 2), (float)l, 16777215);
            } else {
               this.font.random.setSeed((long)((float)((long)i1 * 4238972211L) + this.time / 4.0F));
               this.font.drawTextWithShadow(matrixStack, ireorderingprocessor, (float)j, (float)l, 16777215);
            }
         }
