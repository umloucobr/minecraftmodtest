   ...
   protected void init() {
      ...
      this.field_244674_u = new TextFieldWidget(this.font, this.func_244692_n() + 28, 78, 196, 16, field_244671_r) {
         protected IFormattableTextComponent getNarrationMessage() {
            return !SocialInteractionsScreen.this.field_244674_u.getText().isEmpty() && SocialInteractionsScreen.this.field_244673_t.func_244660_f() ? super.getNarrationMessage().appendString(", ").appendSibling(SocialInteractionsScreen.field_244764_u) : super.getNarrationMessage();
         }
      };
