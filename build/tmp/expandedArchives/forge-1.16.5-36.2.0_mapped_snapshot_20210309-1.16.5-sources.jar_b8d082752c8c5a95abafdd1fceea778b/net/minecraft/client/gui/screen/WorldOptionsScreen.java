...
public class WorldOptionsScreen implements IScreen, IRenderable {
   ...
   public void func_239048_a_(final CreateWorldScreen p_239048_1_, Minecraft p_239048_2_, FontRenderer p_239048_3_) {
      ...
      this.field_239034_h_ = p_239048_1_.addButton(new Button(i, 100, 150, 20, new TranslationTextComponent("selectWorld.mapFeatures"), (p_239056_1_) -> {
         ...
         protected IFormattableTextComponent getNarrationMessage() {
            return super.getNarrationMessage().appendString(". ").appendSibling(new TranslationTextComponent("selectWorld.mapFeatures.info"));
         }
      });
      ...
      this.field_239035_i_ = p_239048_1_.addButton(new Button(j, 100, 150, 20, new TranslationTextComponent("selectWorld.mapType"), (p_239050_2_) -> {
         while(true) {
            if (this.field_239040_n_.isPresent()) {
               ...
               if (this.field_239039_m_.hasDebugChunkGenerator() && !Screen.hasShiftDown()) {
                  continue;
               }
            }
         ...
         public ITextComponent getMessage() {
            return super.getMessage().deepCopy().appendString(" ").appendSibling(WorldOptionsScreen.this.field_239040_n_.map(BiomeGeneratorTypeScreens::func_239077_a_).orElse(WorldOptionsScreen.field_239029_c_));
         }

         protected IFormattableTextComponent getNarrationMessage() {
            return Objects.equals(WorldOptionsScreen.this.field_239040_n_, Optional.of(BiomeGeneratorTypeScreens.field_239067_b_)) ? super.getNarrationMessage().appendString(". ").appendSibling(WorldOptionsScreen.field_239030_d_) : super.getNarrationMessage();
         }
      });
   ...
   public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      if (this.field_239034_h_.visible) {
         this.field_239031_e_.drawTextWithShadow(matrixStack, field_243442_e, (float)(this.field_239032_f_ / 2 - 150), 122.0F, -6250336);
      }
   ...
   public boolean func_239042_a_() {
      return this.field_239039_m_.hasDebugChunkGenerator();
   }

   public void func_239059_b_(boolean p_239059_1_) {
      this.field_239035_i_.visible = p_239059_1_;
      if (this.field_239039_m_.hasDebugChunkGenerator()) {
         this.field_239034_h_.visible = false;
         this.field_239027_a_.visible = false;
         this.field_239036_j_.visible = false;
         this.field_239037_k_.visible = false;
         ...
         this.field_239036_j_.visible = p_239059_1_ && (BiomeGeneratorTypeScreens.field_239069_d_.containsKey(this.field_239040_n_) || net.minecraftforge.client.ForgeHooksClient.hasBiomeGeneratorSettingsOptionsScreen(this.field_239040_n_));
   ...
   void func_243447_a(DataPackRegistries p_243447_1_) {
      ...
      dataresult.resultOrPartial(Util.prefixString("Error parsing worldgen settings after loading data packs: ", field_239028_b_::error)).ifPresent((p_243448_2_) -> {
