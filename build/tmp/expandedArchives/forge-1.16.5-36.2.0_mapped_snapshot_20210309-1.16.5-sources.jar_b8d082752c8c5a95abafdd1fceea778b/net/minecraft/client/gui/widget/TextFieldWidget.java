...
public class TextFieldWidget extends Widget implements IRenderable, IGuiEventListener {
   ...
   public TextFieldWidget(FontRenderer fontRenderer, int x, int y, int width, int height, ITextComponent title) {
      this(fontRenderer, x, y, width, height, (TextFieldWidget)null, title);
   }

   public TextFieldWidget(FontRenderer fontRenderer, int x, int y, int width, int height, @Nullable TextFieldWidget inputWidget, ITextComponent title) {
