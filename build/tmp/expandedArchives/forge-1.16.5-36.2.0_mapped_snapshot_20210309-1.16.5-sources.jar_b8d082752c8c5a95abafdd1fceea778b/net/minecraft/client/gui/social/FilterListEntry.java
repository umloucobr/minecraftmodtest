...
public class FilterListEntry extends AbstractOptionList.Entry<FilterListEntry> {
   ...
   public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
      ...
      if (itextcomponent == StringTextComponent.EMPTY) {
         AbstractGui.fill(matrixStack, left, top, left + width, top + height, field_244617_b);
         l = top + (height - 9) / 2;
      } else {
         AbstractGui.fill(matrixStack, left, top, left + width, top + height, field_244618_c);
         l = top + (height - (9 + 9)) / 2;
         this.field_244620_e.fontRenderer.drawText(matrixStack, itextcomponent, (float)k, (float)(l + 12), field_244741_e);
      }

      this.field_244620_e.getTextureManager().bindTexture(this.field_244742_j.get());
      AbstractGui.blit(matrixStack, i, j, 24, 24, 8.0F, 8.0F, 8, 8, 64, 64);
      RenderSystem.enableBlend();
      AbstractGui.blit(matrixStack, i, j, 24, 24, 40.0F, 8.0F, 8, 8, 64, 64);
      RenderSystem.disableBlend();
      this.field_244620_e.fontRenderer.drawString(matrixStack, this.field_244623_h, (float)k, (float)l, field_244619_d);
      if (this.field_244625_j) {
         AbstractGui.fill(matrixStack, i, j, i + 24, j + 24, field_244616_a);
      }

      if (this.field_244626_k != null && this.field_244627_l != null) {
         float f = this.field_244630_o;
         this.field_244626_k.x = left + (width - this.field_244626_k.getWidth() - 4);
         this.field_244626_k.y = top + (height - this.field_244626_k.getHeight()) / 2;
         this.field_244626_k.render(matrixStack, mouseX, mouseY, partialTicks);
         this.field_244627_l.x = left + (width - this.field_244627_l.getWidth() - 4);
         this.field_244627_l.y = top + (height - this.field_244627_l.getHeight()) / 2;
         this.field_244627_l.render(matrixStack, mouseX, mouseY, partialTicks);
   ...
   private IFormattableTextComponent func_244750_a(IFormattableTextComponent p_244750_1_) {
      ITextComponent itextcomponent = this.func_244752_d();
      return itextcomponent == StringTextComponent.EMPTY ? (new StringTextComponent(this.field_244623_h)).appendString(", ").appendSibling(p_244750_1_) : (new StringTextComponent(this.field_244623_h)).appendString(", ").appendSibling(itextcomponent).appendString(", ").appendSibling(p_244750_1_);
   }
