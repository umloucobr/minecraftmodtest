...
public abstract class DisplayEffectsScreen<T extends Container> extends ContainerScreen<T> {
   ...
   private void renderEffectSprites(MatrixStack matrixStack, int renderX, int yOffset, Iterable<EffectInstance> effects) {
      ...
      for(EffectInstance effectinstance : effects) {
         ...
         blit(matrixStack, renderX + 6, i + 7, this.getBlitOffset(), 18, 18, textureatlassprite);
         i += yOffset;
      }
   ...
   private void renderEffectText(MatrixStack matrixStack, int renderX, int yOffset, Iterable<EffectInstance> effects) {
      ...
      for(EffectInstance effectinstance : effects) {
         ...
         this.font.drawStringWithShadow(matrixStack, s, (float)(renderX + 10 + 18), (float)(i + 6), 16777215);
         String s1 = EffectUtils.getPotionDurationString(effectinstance, 1.0F);
         this.font.drawStringWithShadow(matrixStack, s1, (float)(renderX + 10 + 18), (float)(i + 6 + 10), 8355711);
         i += yOffset;
      }
