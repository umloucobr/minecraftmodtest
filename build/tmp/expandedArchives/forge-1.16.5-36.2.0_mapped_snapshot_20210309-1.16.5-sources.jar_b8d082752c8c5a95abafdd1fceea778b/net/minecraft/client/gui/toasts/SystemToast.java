...
public class SystemToast implements IToast {
   ...
   public IToast.Visibility func_230444_a_(MatrixStack p_230444_1_, ToastGui p_230444_2_, long p_230444_3_) {
      ...
      if (this.field_238531_e_ == null) {
         p_230444_2_.getMinecraft().fontRenderer.drawText(p_230444_1_, this.title, 18.0F, 12.0F, -256);
      } else {
         p_230444_2_.getMinecraft().fontRenderer.drawText(p_230444_1_, this.title, 18.0F, 7.0F, -256);
