   ...
   public static AdvancementTabGui create(Minecraft minecraft, AdvancementsScreen screen, int tabIndex, Advancement advancement) {
      if (advancement.getDisplay() == null) {
         ...
         for(AdvancementTabType advancementtabtype : AdvancementTabType.values()) {
            if ((tabIndex % AdvancementTabType.MAX_TABS) < advancementtabtype.getMax()) {
               return new AdvancementTabGui(minecraft, screen, advancementtabtype, tabIndex % AdvancementTabType.MAX_TABS, tabIndex / AdvancementTabType.MAX_TABS, advancement, advancement.getDisplay());
            }
