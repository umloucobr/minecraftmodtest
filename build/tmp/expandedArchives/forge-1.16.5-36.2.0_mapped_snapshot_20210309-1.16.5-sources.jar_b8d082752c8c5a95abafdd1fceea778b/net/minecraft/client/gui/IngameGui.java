...
public class IngameGui extends AbstractGui {
   ...
   private static final ITextComponent DEMO_EXPIRED = new TranslationTextComponent("demo.demoExpired");
   ...
   protected void renderChatBackground(MatrixStack matrixStack, FontRenderer renderer, int p_238448_3_, int p_238448_4_, int p_238448_5_) {
      int i = this.mc.gameSettings.getTextBackgroundColor(0.0F);
      if (i != 0) {
         int j = -p_238448_4_ / 2;
         fill(matrixStack, j - 2, p_238448_3_ - 2, j + p_238448_4_ + 2, p_238448_3_ + 9 + 2, ColorHelper.PackedColor.blendColors(i, p_238448_5_));
      }
      ...
      if (!collection.isEmpty()) {
         ...
         for(EffectInstance effectinstance : Ordering.natural().reverse().sortedCopy(collection)) {
            ...
            if (effectinstance.isShowIcon()) {
               ...
               effectinstance.renderHUDEffect(this, matrixStack, k, l, this.getBlitOffset(), f);
            }
         }
   ...
   public void renderExpBar(MatrixStack matrixStack, int xPos) {
      ...
      if (i > 0) {
         ...
         this.blit(matrixStack, xPos, l, 0, 64, 182, 5);
         if (k > 0) {
            this.blit(matrixStack, xPos, l, 0, 69, k, 5);
         }
      }
      ...
      if (this.mc.player.experienceLevel > 0) {
         ...
         this.getFontRenderer().drawString(matrixStack, s, (float)(i1 + 1), (float)j1, 0);
         this.getFontRenderer().drawString(matrixStack, s, (float)(i1 - 1), (float)j1, 0);
         this.getFontRenderer().drawString(matrixStack, s, (float)i1, (float)(j1 + 1), 0);
         this.getFontRenderer().drawString(matrixStack, s, (float)i1, (float)(j1 - 1), 0);
         this.getFontRenderer().drawString(matrixStack, s, (float)i1, (float)j1, 8453920);
         this.mc.getProfiler().endSection();
      }
   ...
   public void renderItemName(MatrixStack matrixStack) {
      ...
      if (this.remainingHighlightTicks > 0 && !this.highlightingItemStack.isEmpty()) {
         IFormattableTextComponent iformattabletextcomponent = (new StringTextComponent("")).appendSibling(this.highlightingItemStack.getDisplayName()).mergeStyle(this.highlightingItemStack.getRarity().color);
         ...
         int i = this.getFontRenderer().getStringPropertyWidth(highlightTip);
         ...
         if (l > 0) {
            ...
            RenderSystem.enableBlend();
            RenderSystem.defaultBlendFunc();
            fill(matrixStack, j - 2, k - 2, j + i + 2, k + 9 + 2, this.mc.gameSettings.getChatBackgroundColor(0));
            FontRenderer font = highlightingItemStack.getItem().getFontRenderer(highlightingItemStack);
            if (font == null) {
               this.getFontRenderer().drawTextWithShadow(matrixStack, highlightTip, (float)j, (float)k, 16777215 + (l << 24));
            } else {
               j = (this.scaledWidth - font.getStringPropertyWidth(highlightTip)) / 2;
   ...
   public void renderDemoCountdown(MatrixStack matrixStack) {
      this.mc.getProfiler().startSection("demo");
      ITextComponent itextcomponent;
      if (this.mc.world.getGameTime() >= 120500L) {
         itextcomponent = DEMO_EXPIRED;
      } else {
      ...
      this.getFontRenderer().drawTextWithShadow(matrixStack, itextcomponent, (float)(this.scaledWidth - i - 10), 5.0F, 16777215);
      this.mc.getProfiler().endSection();
   }

   protected void renderScoreboard(MatrixStack p_238447_1_, ScoreObjective p_238447_2_) {
      ...
      for(Pair<Score, ITextComponent> pair : list1) {
         ...
         this.getFontRenderer().drawText(p_238447_1_, itextcomponent2, (float)l2, (float)k1, -1);
         ...
         if (l == collection.size()) {
            ...
            this.getFontRenderer().drawText(p_238447_1_, itextcomponent, (float)(l2 + j / 2 - i / 2), (float)(k1 - 9), -1);
         }
      }
   ...
   private void renderToolbarInfo(MatrixStack matrixStack) {
      PlayerEntity playerentity = this.getRenderViewPlayer();
      if (playerentity != null) {
         ...
         if (i != 0) {
            ...
            for(boolean flag = false; i > 0; j1 += 20) {
               ...
               for(int l1 = 0; l1 < k1; ++l1) {
                  ...
                  int j2 = 0;
                  int k2 = l - l1 * 8 - 9;
                  this.blit(matrixStack, k2, i1, 52 + j2 * 9, 9, 9, 9);
                  if (l1 * 2 + 1 + j1 < j) {
                     this.blit(matrixStack, k2, i1, 88, 9, 9, 9);
                  }

                  if (l1 * 2 + 1 + j1 == j) {
                     this.blit(matrixStack, k2, i1, 97, 9, 9, 9);
                  }
               }
   ...
   public void renderTitles(@Nullable ITextComponent p_238452_1_, @Nullable ITextComponent p_238452_2_, int p_238452_3_, int p_238452_4_, int p_238452_5_) {
   ...
   public void sendChatMessage(ChatType p_238450_1_, ITextComponent p_238450_2_, UUID p_238450_3_) {
