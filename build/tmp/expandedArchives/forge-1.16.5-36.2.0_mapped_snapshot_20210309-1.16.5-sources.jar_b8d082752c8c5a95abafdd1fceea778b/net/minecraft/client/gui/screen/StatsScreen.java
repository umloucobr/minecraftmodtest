...
public class StatsScreen extends Screen implements IProgressMeter {
   ...
   class CustomStatsList extends ExtendedList<StatsScreen.CustomStatsList.Entry> {
      ...
      class Entry extends ExtendedList.AbstractListEntry<StatsScreen.CustomStatsList.Entry> {
         ...
         public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
            AbstractGui.drawString(matrixStack, StatsScreen.this.font, this.field_243321_c, left + 2, top + 1, index % 2 == 0 ? 16777215 : 9474192);
            String s = this.field_214405_b.format(StatsScreen.this.stats.getValue(this.field_214405_b));
            AbstractGui.drawString(matrixStack, StatsScreen.this.font, s, left + 2 + 213 - StatsScreen.this.font.getStringWidth(s), top + 1, index % 2 == 0 ? 16777215 : 9474192);
         }
      }
   }
   ...
   class MobStatsList extends ExtendedList<StatsScreen.MobStatsList.Entry> {
      ...
      class Entry extends ExtendedList.AbstractListEntry<StatsScreen.MobStatsList.Entry> {
         ...
         public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
            AbstractGui.drawString(matrixStack, StatsScreen.this.font, this.field_243322_c, left + 2, top + 1, 16777215);
            AbstractGui.drawString(matrixStack, StatsScreen.this.font, this.field_243323_d, left + 2 + 10, top + 1 + 9, this.field_243324_e ? 9474192 : 6316128);
            AbstractGui.drawString(matrixStack, StatsScreen.this.font, this.field_243325_f, left + 2 + 10, top + 1 + 9 * 2, this.field_243326_g ? 9474192 : 6316128);
         }
      }
   }
   ...
   class StatsList extends ExtendedList<StatsScreen.StatsList.Entry> {
      ...
      protected void renderHeader(MatrixStack matrixStack, int x, int y, Tessellator tessellator) {
         ...
         for(int i = 0; i < this.field_195112_D.length; ++i) {
            StatsScreen.this.func_238674_c_(matrixStack, x + StatsScreen.this.func_195224_b(i) - 18, y + 1, 0, this.field_195115_x == i ? 0 : 18);
         }
         ...
         if (this.field_195110_A != null) {
            ...
            StatsScreen.this.func_238674_c_(matrixStack, x + k, y + 1, 18 * j, 0);
         }

         for(int l = 0; l < this.field_195112_D.length; ++l) {
            int i1 = this.field_195115_x == l ? 1 : 0;
            StatsScreen.this.func_238674_c_(matrixStack, x + StatsScreen.this.func_195224_b(l) - 18 + i1, y + 1 + i1, 18 * this.field_195112_D[l], 18);
         }
      ...
      protected void renderDecorations(MatrixStack matrixStack, int mouseX, int mouseY) {
         if (mouseY >= this.y0 && mouseY <= this.y1) {
            StatsScreen.StatsList.Entry statsscreen$statslist$entry = this.getEntryAtPosition((double)mouseX, (double)mouseY);
            ...
            if (statsscreen$statslist$entry != null) {
               ...
               this.func_238680_a_(matrixStack, this.func_200208_a(item), mouseX, mouseY);
            } else {
               ...
               this.func_238680_a_(matrixStack, itextcomponent, mouseX, mouseY);
            }
      ...
      protected void func_238680_a_(MatrixStack p_238680_1_, @Nullable ITextComponent p_238680_2_, int p_238680_3_, int p_238680_4_) {
         if (p_238680_2_ != null) {
            ...
            StatsScreen.this.font.drawTextWithShadow(p_238680_1_, p_238680_2_, (float)i, (float)j, -1);
      ...
      class Entry extends ExtendedList.AbstractListEntry<StatsScreen.StatsList.Entry> {
         ...
         public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
            Item item = StatsScreen.this.itemStats.field_195116_y.get(index);
            StatsScreen.this.func_238667_a_(matrixStack, left + 40, top, item);
            ...
            for(int i = 0; i < StatsScreen.this.itemStats.field_195113_v.size(); ++i) {
               ...
               this.func_238681_a_(matrixStack, stat, left + StatsScreen.this.func_195224_b(i), top, index % 2 == 0);
            }

            for(int j = 0; j < StatsScreen.this.itemStats.field_195114_w.size(); ++j) {
               this.func_238681_a_(matrixStack, StatsScreen.this.itemStats.field_195114_w.get(j).get(item), left + StatsScreen.this.func_195224_b(j + StatsScreen.this.itemStats.field_195113_v.size()), top, index % 2 == 0);
            }
