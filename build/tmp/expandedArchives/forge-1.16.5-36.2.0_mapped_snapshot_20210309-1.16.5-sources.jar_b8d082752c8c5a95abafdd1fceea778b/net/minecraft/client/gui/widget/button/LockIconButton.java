...
public class LockIconButton extends Button {
   ...
   public LockIconButton(int x, int y, Button.IPressable onPress) {
      super(x, y, 20, 20, new TranslationTextComponent("narrator.button.difficulty_lock"), onPress);
   }

   protected IFormattableTextComponent getNarrationMessage() {
      return super.getNarrationMessage().appendString(". ").appendSibling(this.isLocked() ? new TranslationTextComponent("narrator.button.difficulty_lock.locked") : new TranslationTextComponent("narrator.button.difficulty_lock.unlocked"));
   }
