   ...
   public void func_238523_a_(MatrixStack p_238523_1_, int p_238523_2_, Scoreboard p_238523_3_, @Nullable ScoreObjective p_238523_4_) {
      ...
      if (list1 != null) {
         ...
         for(IReorderingProcessor ireorderingprocessor2 : list1) {
            ...
            this.mc.fontRenderer.drawTextWithShadow(p_238523_1_, ireorderingprocessor2, (float)(p_238523_2_ / 2 - i2 / 2), (float)k1, -1);
            k1 += 9;
         }
      ...
      for(int i5 = 0; i5 < i4; ++i5) {
         ...
         if (i5 < list.size()) {
            ...
            this.mc.fontRenderer.drawTextWithShadow(p_238523_1_, this.getDisplayName(networkplayerinfo1), (float)k2, (float)l2, networkplayerinfo1.getGameType() == GameType.SPECTATOR ? -1862270977 : -1);
      ...
      if (list2 != null) {
         ...
         for(IReorderingProcessor ireorderingprocessor3 : list2) {
            ...
            this.mc.fontRenderer.drawTextWithShadow(p_238523_1_, ireorderingprocessor3, (float)(p_238523_2_ / 2 - k5 / 2), (float)k1, -1);
            k1 += 9;
         }
      }
