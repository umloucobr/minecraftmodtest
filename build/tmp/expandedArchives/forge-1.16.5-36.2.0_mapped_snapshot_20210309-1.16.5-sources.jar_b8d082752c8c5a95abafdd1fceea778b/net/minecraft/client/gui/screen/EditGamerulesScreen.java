...
public class EditGamerulesScreen extends Screen {
   ...
   public class BooleanEntry extends EditGamerulesScreen.ValueEntry {
      ...
      public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
         this.func_241649_a_(matrixStack, top, left);
         this.field_238986_c_.x = left + width - 45;
         this.field_238986_c_.y = top;
         this.field_238986_c_.render(matrixStack, mouseX, mouseY, partialTicks);
      }
   }
   ...
   public class IntegerEntry extends EditGamerulesScreen.ValueEntry {
      ...
      public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
         this.func_241649_a_(matrixStack, top, left);
         this.field_238997_d_.x = left + width - 44;
         this.field_238997_d_.y = top;
         this.field_238997_d_.render(matrixStack, mouseX, mouseY, partialTicks);
      }
   }
   ...
   public class NameEntry extends EditGamerulesScreen.Gamerule {
      ...
      public void render(MatrixStack matrixStack, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean isMouseOver, float partialTicks) {
         AbstractGui.drawCenteredString(matrixStack, EditGamerulesScreen.this.minecraft.fontRenderer, this.field_238994_c_, left + width / 2, top + 5, 16777215);
      }
