...
public class NetworkPlayerInfo {
   ...
   protected void setGameType(GameType gameMode) {
      net.minecraftforge.client.ForgeHooksClient.onClientChangeGameMode(this, this.gameType, gameMode);
   ...
   protected void loadPlayerTextures() {
      synchronized(this) {
         if (!this.playerTexturesLoaded) {
            ...
            Minecraft.getInstance().getSkinManager().loadProfileTextures(this.gameProfile, (textureType, textureLocation, profileTexture) -> {
               this.playerTextures.put(textureType, textureLocation);
               if (textureType == Type.SKIN) {
