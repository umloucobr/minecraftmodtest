...
public class KeyboardListener {
   ...
   private void printDebugMessage(String message, Object... args) {
      this.mc.ingameGUI.getChatGUI().printChatMessage((new StringTextComponent("")).appendSibling((new TranslationTextComponent("debug.prefix")).mergeStyle(new TextFormatting[]{TextFormatting.YELLOW, TextFormatting.BOLD})).appendString(" ").appendSibling(new TranslationTextComponent(message, args)));
   }

   private void printDebugWarning(String message, Object... args) {
      this.mc.ingameGUI.getChatGUI().printChatMessage((new StringTextComponent("")).appendSibling((new TranslationTextComponent("debug.prefix")).mergeStyle(new TextFormatting[]{TextFormatting.RED, TextFormatting.BOLD})).appendString(" ").appendSibling(new TranslationTextComponent(message, args)));
   }
      ...
      if (this.debugCrashKeyPressTime > 0L && this.debugCrashKeyPressTime < Util.milliTime() - 100L) {
         ...
         case 78:
            if (!this.mc.player.hasPermissionLevel(2)) {
               ...
               this.mc.player.sendChatMessage("/gamemode " + this.mc.playerController.getPreviousGameType().getName());
            }
