...
public class ClientChunkProvider extends AbstractChunkProvider {
   ...
   @Nullable
   public Chunk loadChunk(int chunkX, int chunkZ, @Nullable BiomeContainer biomeContainerIn, PacketBuffer packetIn, CompoundNBT nbtTagIn, int sizeIn, boolean fullChunk) {
      if (!this.array.inView(chunkX, chunkZ)) {
         ...
         if (!fullChunk && isValid(chunk, chunkX, chunkZ)) {
