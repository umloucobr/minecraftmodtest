...
public class ClientSuggestionProvider implements ISuggestionProvider {
   ...
   public ClientSuggestionProvider(ClientPlayNetHandler connection, Minecraft mc) {
   ...
   private static String formatInt(int intValue) {
   ...
   public Set<RegistryKey<World>> func_230390_p_() {
      return this.connection.getDimensionKeys();
   }
