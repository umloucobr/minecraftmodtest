...
public enum FaceDirection {
   ...
   private static final FaceDirection[] FACINGS = Util.make(new FaceDirection[6], (array) -> {
      array[FaceDirection.Constants.DOWN_INDEX] = DOWN;
      array[FaceDirection.Constants.UP_INDEX] = UP;
      array[FaceDirection.Constants.NORTH_INDEX] = NORTH;
      array[FaceDirection.Constants.SOUTH_INDEX] = SOUTH;
      array[FaceDirection.Constants.WEST_INDEX] = WEST;
      array[FaceDirection.Constants.EAST_INDEX] = EAST;
   });
