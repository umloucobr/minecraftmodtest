...
public class EnderCrystalRenderer extends EntityRenderer<EnderCrystalEntity> {
   ...
   private static final RenderType ENDER_CRYSTAL_RENDER_TYPE = RenderType.getEntityCutoutNoCull(ENDER_CRYSTAL_TEXTURES);
   ...
   public static float func_229051_a_(EnderCrystalEntity entity, float partialTicks) {
