   ...
   public void render(PistonTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
      ...
      if (world != null) {
         ...
         if (!blockstate.isAir()) {
            ...
            if (blockstate.matchesBlock(Blocks.PISTON_HEAD) && tileEntityIn.getProgress(partialTicks) <= 4.0F) {
               ...
               PistonType pistontype = blockstate.matchesBlock(Blocks.STICKY_PISTON) ? PistonType.STICKY : PistonType.DEFAULT;
