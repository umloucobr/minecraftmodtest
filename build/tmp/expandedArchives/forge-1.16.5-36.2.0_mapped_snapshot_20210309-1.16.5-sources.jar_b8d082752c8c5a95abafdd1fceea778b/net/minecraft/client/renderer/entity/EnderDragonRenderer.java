...
public class EnderDragonRenderer extends EntityRenderer<EnderDragonEntity> {
   ...
   private static final ResourceLocation DRAGON_EYES_TEXTURES = new ResourceLocation("textures/entity/enderdragon/dragon_eyes.png");
   private static final RenderType DRAGON_ALIVE_RENDER_TYPE = RenderType.getEntityCutoutNoCull(DRAGON_TEXTURES);
   private static final RenderType DRAGON_DYING_RENDER_TYPE = RenderType.getEntityDecal(DRAGON_TEXTURES);
   private static final RenderType DRAGON_EYES_RENDER_TYPE = RenderType.getEyes(DRAGON_EYES_TEXTURES);
   private static final RenderType ENDER_CRYSTAL_BEAM_RENDER_TYPE = RenderType.getEntitySmoothCutout(ENDERCRYSTAL_BEAM_TEXTURES);
   ...
   public static void func_229059_a_(float p_229059_0_, float p_229059_1_, float p_229059_2_, float p_229059_3_, int p_229059_4_, MatrixStack p_229059_5_, IRenderTypeBuffer p_229059_6_, int p_229059_7_) {
      ...
      IVertexBuilder ivertexbuilder = p_229059_6_.getBuffer(ENDER_CRYSTAL_BEAM_RENDER_TYPE);
