...
public class ShulkerRenderer extends MobRenderer<ShulkerEntity, ShulkerModel<ShulkerEntity>> {
   ...
   public static final ResourceLocation[] SHULKER_TEXTURE = Atlases.SHULKER_TEXTURES.stream().map((p_229125_0_) -> {
   ...
   public ResourceLocation getEntityTexture(ShulkerEntity entity) {
      return entity.getColor() == null ? field_204402_a : SHULKER_TEXTURE[entity.getColor().getId()];
   }
