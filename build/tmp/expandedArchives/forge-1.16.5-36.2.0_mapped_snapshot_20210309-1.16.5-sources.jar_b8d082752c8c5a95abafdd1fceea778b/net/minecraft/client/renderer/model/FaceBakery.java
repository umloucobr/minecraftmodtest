...
public class FaceBakery {
   ...
   private void fillVertexData(int[] vertexData, int vertexIndex, Vector3f vector, TextureAtlasSprite sprite, BlockFaceUV blockFaceUV) {
      ...
      vertexData[i + 4 + 1] = Float.floatToRawIntBits(sprite.getInterpolatedV((double)blockFaceUV.getVertexV(vertexIndex) * .999 + blockFaceUV.getVertexV((vertexIndex + 2) % 4) * .001));
   }
