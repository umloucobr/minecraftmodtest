...
public class Atlases {
   ...
   public static RenderMaterial getSignMaterial(WoodType woodType) {
      ResourceLocation location = new ResourceLocation(woodType.getName());
      return new RenderMaterial(SIGN_ATLAS, new ResourceLocation(location.getNamespace(), "entity/signs/" + location.getPath()));
   }
   ...
   public static void addWoodType(WoodType woodType) {
      SIGN_MATERIALS.put(woodType, getSignMaterial(woodType));
   }
}
