...
public class BipedRenderer<T extends MobEntity, M extends BipedModel<T>> extends MobRenderer<T, M> {
   ...
   public BipedRenderer(EntityRendererManager p_i232471_1_, M entity, float shadowSize, float p_i232471_4_, float p_i232471_5_, float p_i232471_6_) {
      super(p_i232471_1_, entity, shadowSize);
