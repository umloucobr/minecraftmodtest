...
public class WorldRenderer implements IResourceManagerReloadListener, AutoCloseable {
   ...
   @Nullable
   private Framebuffer itemEntityFrameBuffer;
   @Nullable
   private Framebuffer particleFrameBuffer;
   @Nullable
   private Framebuffer weatherFrameBuffer;
   @Nullable
   private Framebuffer cloudFrameBuffer;
   @Nullable
   ...
   private void renderRainSnow(LightTexture lightmapIn, float partialTicks, double xIn, double yIn, double zIn) {
      net.minecraftforge.client.IWeatherRenderHandler renderHandler = world.getDimensionRenderInfo().getWeatherRenderHandler();
   ...
   public void addRainParticles(ActiveRenderInfo activeRenderInfoIn) {
      net.minecraftforge.client.IWeatherParticleRenderHandler renderHandler = world.getDimensionRenderInfo().getWeatherParticleRenderHandler();
      if (renderHandler != null) {
      ...
      if (!(f <= 0.0F)) {
         ...
         for(int j = 0; j < i; ++j) {
            ...
            if (blockpos2.getY() > 0 && blockpos2.getY() <= blockpos.getY() + 10 && blockpos2.getY() >= blockpos.getY() - 10 && biome.getPrecipitation() == Biome.RainType.RAIN && biome.getTemperature(blockpos2) >= 0.15F) {
               ...
               VoxelShape voxelshape = blockstate.getCollisionShapeUncached(iworldreader, blockpos2);
   ...
   private void func_239233_v_() {
      ...
      try {
         ...
         this.translucentFrameBuffer = framebuffer1;
         this.itemEntityFrameBuffer = framebuffer2;
         this.particleFrameBuffer = framebuffer3;
         this.weatherFrameBuffer = framebuffer4;
         this.cloudFrameBuffer = framebuffer;
   ...
   private void resetFrameBuffers() {
      if (this.field_239227_K_ != null) {
         this.field_239227_K_.close();
         this.translucentFrameBuffer.deleteFramebuffer();
         this.itemEntityFrameBuffer.deleteFramebuffer();
         this.particleFrameBuffer.deleteFramebuffer();
         this.weatherFrameBuffer.deleteFramebuffer();
         this.cloudFrameBuffer.deleteFramebuffer();
   ...
   public void updateCameraAndRender(MatrixStack matrixStackIn, float partialTicks, long finishTimeNano, boolean drawBlockOutline, ActiveRenderInfo activeRenderInfoIn, GameRenderer gameRendererIn, LightTexture lightmapIn, Matrix4f projectionIn) {
      ...
      boolean flag1 = this.mc.world.getDimensionRenderInfo().func_230493_a_(MathHelper.floor(d0), MathHelper.floor(d1)) || this.mc.ingameGUI.getBossOverlay().shouldCreateFog();
      ...
      if (this.world.getDimensionRenderInfo().func_239217_c_()) {
      ...
      if (this.itemEntityFrameBuffer != null) {
         this.itemEntityFrameBuffer.framebufferClear(Minecraft.IS_RUNNING_ON_MAC);
         this.itemEntityFrameBuffer.func_237506_a_(this.mc.getFramebuffer());
         this.mc.getFramebuffer().bindFramebuffer(false);
      }

      if (this.weatherFrameBuffer != null) {
         this.weatherFrameBuffer.framebufferClear(Minecraft.IS_RUNNING_ON_MAC);
      }
      ...
      if (this.field_239227_K_ != null) {
         ...
         this.translucentFrameBuffer.framebufferClear(Minecraft.IS_RUNNING_ON_MAC);
         this.translucentFrameBuffer.func_237506_a_(this.mc.getFramebuffer());
         ...
         this.particleFrameBuffer.framebufferClear(Minecraft.IS_RUNNING_ON_MAC);
         this.particleFrameBuffer.func_237506_a_(this.mc.getFramebuffer());
   ...
   public void renderSky(MatrixStack matrixStackIn, float partialTicks) {
      ...
      if (this.mc.world.getDimensionRenderInfo().getFogType() == DimensionRenderInfo.FogType.END) {
         this.renderSkyEnd(matrixStackIn);
      } else if (this.mc.world.getDimensionRenderInfo().getFogType() == DimensionRenderInfo.FogType.NORMAL) {
         RenderSystem.disableTexture();
         ...
         RenderSystem.enableBlend();
         RenderSystem.defaultBlendFunc();
         float[] afloat = this.world.getDimensionRenderInfo().func_230492_a_(this.world.func_242415_f(partialTicks), partialTicks);
         if (afloat != null) {
            RenderSystem.disableTexture();
   ...
   public void renderClouds(MatrixStack matrixStackIn, float partialTicks, double viewEntityX, double viewEntityY, double viewEntityZ) {
      net.minecraftforge.client.ICloudRenderHandler renderHandler = world.getDimensionRenderInfo().getCloudRenderHandler();
      if (renderHandler != null) {
   ...
   @Nullable
   public Framebuffer getItemEntityFrameBuffer() {
      return this.itemEntityFrameBuffer;
   }

   @Nullable
   public Framebuffer getParticleFrameBuffer() {
      return this.particleFrameBuffer;
   }
   ...
   @Nullable
   public Framebuffer getCloudFrameBuffer() {
      return this.cloudFrameBuffer;
   }
