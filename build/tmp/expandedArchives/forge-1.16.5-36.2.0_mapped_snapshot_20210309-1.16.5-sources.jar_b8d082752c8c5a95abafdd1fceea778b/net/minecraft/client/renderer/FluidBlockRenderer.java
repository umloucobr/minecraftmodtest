...
public class FluidBlockRenderer {
   ...
   private static boolean func_239284_a_(IBlockReader reader, Direction direction, float p_239284_2_, BlockPos pos, BlockState state) {
      if (state.isSolid()) {
         VoxelShape voxelshape = VoxelShapes.create(0.0D, 0.0D, 0.0D, 1.0D, (double)p_239284_2_, 1.0D);
         VoxelShape voxelshape1 = state.getRenderShape(reader, pos);
   ...
   private static boolean func_239283_a_(IBlockReader reader, BlockPos pos, Direction direction, float p_239283_3_) {
      BlockPos blockpos = pos.offset(direction);
      BlockState blockstate = reader.getBlockState(blockpos);
      return func_239284_a_(reader, direction, p_239283_3_, blockpos, blockstate);
   }

   private static boolean func_239282_a_(IBlockReader reader, BlockPos pos, BlockState state, Direction direction) {
      return func_239284_a_(reader, direction.getOpposite(), 1.0F, pos, state);
   }

   public static boolean func_239281_a_(IBlockDisplayReader reader, BlockPos pos, FluidState fluidState, BlockState blockState, Direction direction) {
      return !func_239282_a_(reader, pos, blockState, direction) && !isAdjacentFluidSameAs(reader, pos, direction, fluidState);
   }
