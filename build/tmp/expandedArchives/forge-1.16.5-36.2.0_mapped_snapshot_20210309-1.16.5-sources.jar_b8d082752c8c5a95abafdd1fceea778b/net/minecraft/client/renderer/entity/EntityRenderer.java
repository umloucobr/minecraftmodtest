...
public abstract class EntityRenderer<T extends Entity> {
   ...
   public final int getPackedLight(T entityIn, float partialTicks) {
      BlockPos blockpos = new BlockPos(entityIn.getClientEyePosition(partialTicks));
      return LightTexture.packLight(this.getBlockLight(entityIn, blockpos), this.getSkyLight(entityIn, blockpos));
   }

   protected int getSkyLight(T entity, BlockPos pos) {
      return entity.world.getLightFor(LightType.SKY, pos);
   }
