...
public class StriderRenderer extends MobRenderer<StriderEntity, StriderModel<StriderEntity>> {
   private static final ResourceLocation STRIDER_TEXTURES = new ResourceLocation("textures/entity/strider/strider.png");
   private static final ResourceLocation COLD_STRIDER_TEXTURES = new ResourceLocation("textures/entity/strider/strider_cold.png");
   ...
   public ResourceLocation getEntityTexture(StriderEntity entity) {
      return entity.func_234315_eI_() ? COLD_STRIDER_TEXTURES : STRIDER_TEXTURES;
   }
   ...
   protected boolean func_230495_a_(StriderEntity entity) {
      return entity.func_234315_eI_();
   }
}