            ...
            for(JsonElement jsonelement : jsonarray) {
               try {
                  ...
                  if (framebuffer2 == null) {
                     ...
                     shader.addAuxFramebuffer(s5, framebuffer2::getDepthBuffer, framebuffer2.framebufferTextureWidth, framebuffer2.framebufferTextureHeight);
                  } else {
                     shader.addAuxFramebuffer(s5, framebuffer2::getFrameBufferTexture, framebuffer2.framebufferTextureWidth, framebuffer2.framebufferTextureHeight);
                  }
               } catch (Exception exception1) {
