...
public class Stats {
   ...
   public static final ResourceLocation STRIDER_ONE_CM = registerCustom("strider_one_cm", IStatFormatter.DISTANCE);
   ...
   public static final ResourceLocation TARGET_HIT = registerCustom("target_hit", IStatFormatter.DEFAULT);
   public static final ResourceLocation INTERACT_WITH_SMITHING_TABLE = registerCustom("interact_with_smithing_table", IStatFormatter.DEFAULT);
