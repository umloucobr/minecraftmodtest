...
public abstract class NodeProcessor {
   ...
   protected PathPoint func_237223_a_(BlockPos pos) {
   ...
   protected PathPoint openPoint(int x, int y, int z) {
      return this.pointMap.computeIfAbsent(PathPoint.makeHash(x, y, z), (id) -> {
   ...
   public abstract FlaggedPathPoint func_224768_a(double x, double y, double z);
    ...
    */
   public abstract PathNodeType determineNodeType(IBlockReader blockaccessIn, int x, int y, int z, MobEntity entitylivingIn, int xSize, int ySize, int zSize, boolean canBreakDoorsIn, boolean canEnterDoorsIn);

   /**
    * Returns the node type at the specified postion taking the block below into account
    */
   public abstract PathNodeType getFloorNodeType(IBlockReader worldIn, int x, int y, int z);
