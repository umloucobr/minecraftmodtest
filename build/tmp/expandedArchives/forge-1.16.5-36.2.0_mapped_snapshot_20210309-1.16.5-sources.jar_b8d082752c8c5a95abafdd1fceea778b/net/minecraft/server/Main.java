   ...
   public static void main(String[] p_main_0_) {
      ...
      try {
         ...
         if (iserverconfiguration == null) {
            ...
            dimensiongeneratorsettings = DimensionGeneratorSettings.field_236201_a_.encodeStart(net.minecraft.util.registry.WorldGenSettingsExport.create(NBTDynamicOps.INSTANCE, dynamicregistries$impl), dimensiongeneratorsettings).flatMap(nbt -> DimensionGeneratorSettings.field_236201_a_.parse(worldsettingsimport, nbt)).getOrThrow(false, errorMsg->{});
