...
public class DebugPacketSender {
   ...
   public static void func_229752_a_(ServerWorld p_229752_0_, BlockPos p_229752_1_, String p_229752_2_, int p_229752_3_, int p_229752_4_) {
      ...
      func_229753_a_(p_229752_0_, packetbuffer, SCustomPayloadPlayPacket.DEBUG_GAME_TEST_ADD_MARKER);
   }

   public static void func_229751_a_(ServerWorld p_229751_0_) {
      PacketBuffer packetbuffer = new PacketBuffer(Unpooled.buffer());
      func_229753_a_(p_229751_0_, packetbuffer, SCustomPayloadPlayPacket.DEBUG_GAME_TEST_CLEAR);
   }

   public static void sendChunkPos(ServerWorld worldIn, ChunkPos p_218802_1_) {
   }
