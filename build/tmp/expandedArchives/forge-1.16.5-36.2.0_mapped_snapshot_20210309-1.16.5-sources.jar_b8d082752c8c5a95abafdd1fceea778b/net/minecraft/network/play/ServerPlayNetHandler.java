...
public class ServerPlayNetHandler implements IServerPlayNetHandler {
   ...
   private boolean func_241162_a_(Entity p_241162_1_) {
      return BlockPos.getAllInBox(p_241162_1_.getBoundingBox().grow(0.0625D).expand(0.0D, -0.55D, 0.0D)).allMatch(b -> p_241162_1_.world.getBlockState(b).isAir(p_241162_1_.world, b));
   }
   ...
   public void func_241831_a(CUpdateRecipeBookStatusPacket p_241831_1_) {
      ...
      this.player.getRecipeBook().func_242144_a(p_241831_1_.getCategory(), p_241831_1_.isVisible(), p_241831_1_.shouldFilterCraftable());
   }
      ...
      if (this.player.canUseCommandBlock()) {
         ...
         if (tileentity instanceof StructureBlockTileEntity) {
            ...
            if (structureblocktileentity.hasName()) {
               ...
               if (packetIn.getUpdateCommand() == StructureBlockTileEntity.UpdateCommand.SAVE_AREA) {
               ...
               } else if (packetIn.getUpdateCommand() == StructureBlockTileEntity.UpdateCommand.LOAD_AREA) {
               ...
               } else if (packetIn.getUpdateCommand() == StructureBlockTileEntity.UpdateCommand.SCAN_AREA) {
   ...
   public void func_217262_a(CUpdateJigsawBlockPacket p_217262_1_) {
      ...
      if (this.player.canUseCommandBlock()) {
         BlockPos blockpos = p_217262_1_.getPosition();
         BlockState blockstate = this.player.world.getBlockState(blockpos);
         TileEntity tileentity = this.player.world.getTileEntity(blockpos);
         if (tileentity instanceof JigsawTileEntity) {
            JigsawTileEntity jigsawtileentity = (JigsawTileEntity)tileentity;
            jigsawtileentity.func_235664_a_(p_217262_1_.getName());
            jigsawtileentity.func_235666_b_(p_217262_1_.getTarget());
            jigsawtileentity.func_235667_c_(p_217262_1_.getPool());
            jigsawtileentity.setFinalState(p_217262_1_.getBlockName());
            jigsawtileentity.func_235662_a_(p_217262_1_.getJointOrientation());
   ...
   public void func_230549_a_(CJigsawBlockGeneratePacket p_230549_1_) {
      ...
      if (this.player.canUseCommandBlock()) {
         BlockPos blockpos = p_230549_1_.getPosition();
         TileEntity tileentity = this.player.world.getTileEntity(blockpos);
         if (tileentity instanceof JigsawTileEntity) {
            JigsawTileEntity jigsawtileentity = (JigsawTileEntity)tileentity;
            jigsawtileentity.func_235665_a_(this.player.getServerWorld(), p_230549_1_.func_240845_c_(), p_230549_1_.shouldKeepJigsaws());
         }
   ...
   public void processTryUseItemOnBlock(CPlayerTryUseItemOnBlockPacket packetIn) {
      ...
      BlockRayTraceResult blockraytraceresult = packetIn.getRayTraceResult();
   ...
   public void func_217263_a(CSetDifficultyPacket p_217263_1_) {
      ...
      if (this.player.hasPermissionLevel(2) || this.func_217264_d()) {
         this.server.setDifficultyForAllWorlds(p_217263_1_.getDifficulty(), false);
      }
   }
