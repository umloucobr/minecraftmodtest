...
public class SAdvancementInfoPacket implements IPacket<IClientPlayNetHandler> {
   ...
   public SAdvancementInfoPacket(boolean firstSync, Collection<Advancement> p_i47519_2_, Set<ResourceLocation> advancementsToRemove, Map<ResourceLocation, AdvancementProgress> progressUpdates) {
      ...
      this.progressUpdates = Maps.newHashMap(progressUpdates);
   }
