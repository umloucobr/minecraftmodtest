...
public class CUpdateCommandBlockPacket implements IPacket<IServerPlayNetHandler> {
   ...
   @OnlyIn(Dist.CLIENT)
   public CUpdateCommandBlockPacket(BlockPos pos, String command, CommandBlockTileEntity.Mode p_i49543_3_, boolean p_i49543_4_, boolean p_i49543_5_, boolean p_i49543_6_) {
      this.pos = pos;
