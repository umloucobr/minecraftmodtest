...
public class SChunkDataPacket implements IPacket<IClientPlayNetHandler> {
   ...
   public SChunkDataPacket(Chunk chunk, int p_i242081_2_) {
      ...
      this.buffer = new byte[this.calculateChunkSize(chunk, p_i242081_2_)];
      this.availableSections = this.extractChunkData(new PacketBuffer(this.getWriteBuffer()), chunk, p_i242081_2_);
      this.tileEntityTags = Lists.newArrayList();

      for(Entry<BlockPos, TileEntity> entry1 : chunk.getTileEntityMap().entrySet()) {
