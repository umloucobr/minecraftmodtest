...
public class Commands {
   ...
   public Commands(Commands.EnvironmentType envType) {
      ...
      this.dispatcher.setConsumer((p_197058_0_, success, result) -> {
         ...
         try {
            ...
            if (commandsyntaxexception.getInput() != null && commandsyntaxexception.getCursor() >= 0) {
               ...
               if (j < commandsyntaxexception.getInput().length()) {
                  ...
                  iformattabletextcomponent1.appendSibling(itextcomponent);
               }

               iformattabletextcomponent1.appendSibling((new TranslationTextComponent("command.context.here")).mergeStyle(new TextFormatting[]{TextFormatting.RED, TextFormatting.ITALIC}));
