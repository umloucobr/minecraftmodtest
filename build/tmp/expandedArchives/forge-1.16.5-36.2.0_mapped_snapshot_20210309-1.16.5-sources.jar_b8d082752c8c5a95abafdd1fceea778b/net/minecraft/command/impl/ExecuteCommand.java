...
public class ExecuteCommand {
   ...
   private static boolean func_229767_a_(CommandSource p_229767_0_, ILootCondition p_229767_1_) {
      ...
      LootContext.Builder lootcontext$builder = (new LootContext.Builder(serverworld)).withParameter(LootParameters.ORIGIN, p_229767_0_.getPos()).withNullableParameter(LootParameters.THIS_ENTITY, p_229767_0_.getEntity());
