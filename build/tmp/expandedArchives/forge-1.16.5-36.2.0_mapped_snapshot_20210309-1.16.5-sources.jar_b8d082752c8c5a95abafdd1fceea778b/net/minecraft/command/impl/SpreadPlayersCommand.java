...
public class SpreadPlayersCommand {
   ...
   private static double func_241072_a_(Collection<? extends Entity> p_241072_0_, ServerWorld p_241072_1_, SpreadPlayersCommand.Position[] p_241072_2_, int p_241072_3_, boolean p_241072_4_) {
      ...
      for(Entity entity : p_241072_0_) {
         ...
         net.minecraftforge.event.entity.living.EntityTeleportEvent.SpreadPlayersCommand event = net.minecraftforge.event.ForgeEventFactory.onEntityTeleportSpreadPlayersCommand(entity, (double)MathHelper.floor(spreadplayerscommand$position.x) + 0.5D, (double)spreadplayerscommand$position.getHighestNonAirBlock(p_241072_1_, p_241072_3_), (double)MathHelper.floor(spreadplayerscommand$position.z) + 0.5D);
         if (!event.isCanceled()) entity.teleportKeepLoaded(event.getTargetX(), event.getTargetY(), event.getTargetZ());
