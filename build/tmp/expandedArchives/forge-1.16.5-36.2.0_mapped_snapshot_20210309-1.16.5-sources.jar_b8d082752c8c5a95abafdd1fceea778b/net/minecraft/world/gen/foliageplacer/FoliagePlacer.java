...
public abstract class FoliagePlacer {
   public static final Codec<FoliagePlacer> CODEC = Registry.FOLIAGE_PLACER_TYPE.dispatch(FoliagePlacer::getPlacerType, FoliagePlacerType::getCodec);
   ...
   protected static <P extends FoliagePlacer> P2<Mu<P>, FeatureSpread, FeatureSpread> func_242830_b(Instance<P> p_242830_0_) {
      return p_242830_0_.group(FeatureSpread.createCodec(0, 8, 8).fieldOf("radius").forGetter((p_242829_0_) -> {
         return p_242829_0_.radius;
      }), FeatureSpread.createCodec(0, 8, 8).fieldOf("offset").forGetter((p_242828_0_) -> {
         return p_242828_0_.offset;
      }));
   }

   public FoliagePlacer(FeatureSpread radius, FeatureSpread offset) {
      this.radius = radius;
      this.offset = offset;
   }

   protected abstract FoliagePlacerType<?> getPlacerType();
   ...
   public int func_230376_a_(Random p_230376_1_, int p_230376_2_) {
      return this.radius.getSpread(p_230376_1_);
   }

   private int func_236755_a_(Random p_236755_1_) {
      return this.offset.getSpread(p_236755_1_);
   }
