...
public class MegaPineFoliagePlacer extends FoliagePlacer {
   public static final Codec<MegaPineFoliagePlacer> CODEC = RecordCodecBuilder.create((p_242832_0_) -> {
      return func_242830_b(p_242832_0_).and(FeatureSpread.createCodec(0, 16, 8).fieldOf("crown_height").forGetter((p_242831_0_) -> {
   ...
   protected FoliagePlacerType<?> getPlacerType() {
      return FoliagePlacerType.MEGA_PINE;
   }
   ...
   public int func_230374_a_(Random p_230374_1_, int p_230374_2_, BaseTreeFeatureConfig p_230374_3_) {
      return this.crownHeight.getSpread(p_230374_1_);
   }
