...
public class BlockMosinessProcessor extends StructureProcessor {
   public static final Codec<BlockMosinessProcessor> CODEC = Codec.FLOAT.fieldOf("mossiness").xmap(BlockMosinessProcessor::new, (processor) -> {
      return processor.mossiness;
   }).codec();
   private final float mossiness;

   public BlockMosinessProcessor(float mossiness) {
   ...
   public Template.BlockInfo func_230386_a_(IWorldReader world, BlockPos p_230386_2_, BlockPos p_230386_3_, Template.BlockInfo p_230386_4_, Template.BlockInfo p_230386_5_, PlacementSettings settings) {
      ...
      if (!blockstate.matchesBlock(Blocks.STONE_BRICKS) && !blockstate.matchesBlock(Blocks.STONE) && !blockstate.matchesBlock(Blocks.CHISELED_STONE_BRICKS)) {
         ...
         } else if (blockstate.matchesBlock(Blocks.OBSIDIAN)) {
   ...
   private BlockState func_237070_b_(Random p_237070_1_) {
      return p_237070_1_.nextFloat() < this.mossiness ? Blocks.MOSSY_STONE_BRICK_SLAB.getDefaultState() : null;
   }

   @Nullable
   private BlockState func_237071_c_(Random p_237071_1_) {
      return p_237071_1_.nextFloat() < this.mossiness ? Blocks.MOSSY_STONE_BRICK_WALL.getDefaultState() : null;
   }
   ...
   private BlockState func_237069_a_(Random p_237069_1_, BlockState[] p_237069_2_, BlockState[] p_237069_3_) {
      return p_237069_1_.nextFloat() < this.mossiness ? func_237068_a_(p_237069_1_, p_237069_3_) : func_237068_a_(p_237069_1_, p_237069_2_);
   }
