...
public class GiantTrunkPlacer extends AbstractTrunkPlacer {
   public static final Codec<GiantTrunkPlacer> field_236898_a_ = RecordCodecBuilder.create((p_236900_0_) -> {
      return getAbstractTrunkCodec(p_236900_0_).apply(p_236900_0_, GiantTrunkPlacer::new);
   });
   ...
   public List<FoliagePlacer.Foliage> getFoliages(IWorldGenerationReader reader, Random rand, int treeHeight, BlockPos p_230382_4_, Set<BlockPos> p_230382_5_, MutableBoundingBox p_230382_6_, BaseTreeFeatureConfig p_230382_7_) {
      ...
      return ImmutableList.of(new FoliagePlacer.Foliage(p_230382_4_.up(treeHeight), 0, true));
   }
