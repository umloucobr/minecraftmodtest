...
public class EndSpikeFeature extends Feature<EndSpikeFeatureConfig> {
   ...
   public static List<EndSpikeFeature.EndSpike> getSpikes(ISeedReader reader) {
      Random random = new Random(reader.getSeed());
   ...
   public static class EndSpike {
      public static final Codec<EndSpikeFeature.EndSpike> CODEC = RecordCodecBuilder.create((builder) -> {
         return builder.group(Codec.INT.fieldOf("centerX").orElse(0).forGetter((spike) -> {
         ...
         })).apply(builder, EndSpikeFeature.EndSpike::new);
      });
