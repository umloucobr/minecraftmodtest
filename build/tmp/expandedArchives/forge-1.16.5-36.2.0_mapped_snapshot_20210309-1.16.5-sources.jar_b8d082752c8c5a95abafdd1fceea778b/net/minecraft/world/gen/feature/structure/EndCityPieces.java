...
public class EndCityPieces {
   ...
   private static EndCityPieces.CityTemplate addPiece(TemplateManager p_191090_0_, EndCityPieces.CityTemplate p_191090_1_, BlockPos p_191090_2_, String p_191090_3_, Rotation p_191090_4_, boolean overwrite) {
      EndCityPieces.CityTemplate endcitypieces$citytemplate = new EndCityPieces.CityTemplate(p_191090_0_, p_191090_3_, p_191090_1_.templatePosition, p_191090_4_, overwrite);
   ...
   public static class CityTemplate extends TemplateStructurePiece {
      ...
      public CityTemplate(TemplateManager p_i47214_1_, String p_i47214_2_, BlockPos p_i47214_3_, Rotation p_i47214_4_, boolean overwriteIn) {
         super(IStructurePieceType.END_CITY_TEMPLATE, 0);
      ...
      public CityTemplate(TemplateManager p_i50598_1_, CompoundNBT p_i50598_2_) {
         super(IStructurePieceType.END_CITY_TEMPLATE, p_i50598_2_);
