...
public class Template {
   ...
   public List<Template.BlockInfo> func_215386_a(BlockPos p_215386_1_, PlacementSettings p_215386_2_, Block p_215386_3_, boolean p_215386_4_) {
      ...
      if (this.blocks.isEmpty()) {
         ...
         for(Template.BlockInfo template$blockinfo : p_215386_2_.func_237132_a_(this.blocks, p_215386_1_).getInfoForBlock(p_215386_3_)) {
         ...
         if ((!list.isEmpty() || !p_237146_4_.getIgnoreEntities() && !this.entities.isEmpty()) && this.size.getX() >= 1 && this.size.getY() >= 1 && this.size.getZ() >= 1) {
            ...
            if (i <= l) {
               if (!p_237146_4_.func_215218_i()) {
                  ...
                  updatePostProcessing(p_237146_1_, p_237146_6_, voxelshapepart, l1, i2, j2);
               }
               ...
               for(Pair<BlockPos, CompoundNBT> pair : list2) {
                  ...
                  if (!p_237146_4_.func_215218_i()) {
                     ...
                     p_237146_1_.updateBlock(blockpos4, blockstate3.getBlock());
                  }
   ...
   public static void updatePostProcessing(IWorld worldIn, int p_222857_1_, VoxelShapePart voxelShapePartIn, int xIn, int yIn, int zIn) {
   ...
   public static final class Palette {
      ...
      private final Map<Block, List<Template.BlockInfo>> blockToInfoMap = Maps.newHashMap();
      ...
      public List<Template.BlockInfo> getInfoForBlock(Block p_237158_1_) {
         return this.blockToInfoMap.computeIfAbsent(p_237158_1_, (block) -> {
            return this.field_237155_a_.stream().filter((info) -> {
               return info.state.matchesBlock(block);
