...
public class StructureFeatures {
   ...
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> MANSION = register("mansion", Structure.WOODLAND_MANSION.withConfiguration(NoFeatureConfig.INSTANCE));
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> JUNGLE_PYRAMID = register("jungle_pyramid", Structure.JUNGLE_PYRAMID.withConfiguration(NoFeatureConfig.INSTANCE));
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> DESERT_PYRAMID = register("desert_pyramid", Structure.DESERT_PYRAMID.withConfiguration(NoFeatureConfig.INSTANCE));
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> IGLOO = register("igloo", Structure.IGLOO.withConfiguration(NoFeatureConfig.INSTANCE));
   ...
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> SWAMP_HUT = register("swamp_hut", Structure.SWAMP_HUT.withConfiguration(NoFeatureConfig.INSTANCE));
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> STRONGHOLD = register("stronghold", Structure.STRONGHOLD.withConfiguration(NoFeatureConfig.INSTANCE));
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> MONUMENT = register("monument", Structure.MONUMENT.withConfiguration(NoFeatureConfig.INSTANCE));
   ...
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> FORTRESS = register("fortress", Structure.FORTRESS.withConfiguration(NoFeatureConfig.INSTANCE));
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> NETHER_FOSSIL = register("nether_fossil", Structure.NETHER_FOSSIL.withConfiguration(NoFeatureConfig.INSTANCE));
   public static final StructureFeature<NoFeatureConfig, ? extends Structure<NoFeatureConfig>> END_CITY = register("end_city", Structure.END_CITY.withConfiguration(NoFeatureConfig.INSTANCE));
