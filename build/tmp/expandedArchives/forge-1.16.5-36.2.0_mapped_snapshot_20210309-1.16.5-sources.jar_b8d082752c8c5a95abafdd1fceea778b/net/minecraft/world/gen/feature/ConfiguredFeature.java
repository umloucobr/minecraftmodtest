...
public class ConfiguredFeature<FC extends IFeatureConfig, F extends Feature<FC>> implements IDecoratable<ConfiguredFeature<?, ?>> {
   public static final Codec<ConfiguredFeature<?, ?>> CODEC = Registry.FEATURE.dispatch((p_236266_0_) -> {
      return p_236266_0_.feature;
   }, Feature::getCodec);
   public static final Codec<Supplier<ConfiguredFeature<?, ?>>> field_236264_b_ = RegistryKeyCodec.create(Registry.CONFIGURED_FEATURE_KEY, CODEC);
   public static final Codec<List<Supplier<ConfiguredFeature<?, ?>>>> field_242764_c = RegistryKeyCodec.getValueCodecs(Registry.CONFIGURED_FEATURE_KEY, CODEC);
   ...
   public ConfiguredRandomFeatureList withChance(float chance) {
      return new ConfiguredRandomFeatureList(this, chance);
   }
   ...
   public Stream<ConfiguredFeature<?, ?>> getConfiguredFeatures() {
      return Stream.concat(Stream.of(this), this.config.getConfiguredFeatures());
   }
}