...
public class DimensionGeneratorSettings {
   ...
   public boolean hasFlatChunkGenerator() {
   ...
   public static DimensionGeneratorSettings func_242753_a(DynamicRegistries p_242753_0_, Properties p_242753_1_) {
      ...
      case "flat":
         ...
         return new DimensionGeneratorSettings(i, flag, false, func_242749_a(registry2, simpleregistry, new FlatChunkGenerator(FlatGenerationSettings.CODEC.parse(dynamic).resultOrPartial(LOGGER::error).orElseGet(() -> {
   ...
   public DimensionGeneratorSettings create(boolean hardcore, OptionalLong worldSeed) {
      ...
      if (this.hasDebugChunkGenerator()) {
