...
public class FancyTrunkPlacer extends AbstractTrunkPlacer {
   public static final Codec<FancyTrunkPlacer> field_236884_a_ = RecordCodecBuilder.create((p_236891_0_) -> {
      return getAbstractTrunkCodec(p_236891_0_).apply(p_236891_0_, FancyTrunkPlacer::new);
   });
   ...
   public List<FoliagePlacer.Foliage> getFoliages(IWorldGenerationReader reader, Random rand, int treeHeight, BlockPos p_230382_4_, Set<BlockPos> p_230382_5_, MutableBoundingBox p_230382_6_, BaseTreeFeatureConfig p_230382_7_) {
      ...
      for(; j1 >= 0; --j1) {
         ...
         if (!(f < 0.0F)) {
            for(int k1 = 0; k1 < l; ++k1) {
               double d1 = 1.0D;
               double d2 = 1.0D * (double)f * ((double)rand.nextFloat() + 0.328D);
               double d3 = (double)(rand.nextFloat() * 2.0F) * Math.PI;
               ...
               if (this.func_236887_a_(reader, rand, blockpos, blockpos1, false, p_230382_5_, p_230382_6_, p_230382_7_)) {
                  ...
                  if (this.func_236887_a_(reader, rand, blockpos2, blockpos, false, p_230382_5_, p_230382_6_, p_230382_7_)) {
      ...
      this.func_236887_a_(reader, rand, p_230382_4_, p_230382_4_.up(k), true, p_230382_5_, p_230382_6_, p_230382_7_);
      this.func_236886_a_(reader, rand, j, p_230382_4_, list, p_230382_5_, p_230382_6_, p_230382_7_);
