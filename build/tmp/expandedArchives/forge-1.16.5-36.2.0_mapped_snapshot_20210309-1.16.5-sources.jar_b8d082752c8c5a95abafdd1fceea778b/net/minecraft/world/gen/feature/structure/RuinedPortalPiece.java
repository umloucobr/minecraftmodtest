...
public class RuinedPortalPiece extends TemplateStructurePiece {
   ...
   private void func_237016_a_(Random p_237016_1_, IWorld p_237016_2_, BlockPos p_237016_3_) {
      ...
      if (!blockstate.isAir() && !blockstate.matchesBlock(Blocks.VINE)) {
         ...
         if (blockstate1.isAir()) {
            if (Block.doesSideFillSquare(blockstate.getCollisionShapeUncached(p_237016_2_, p_237016_3_), direction)) {
   ...
   private void func_237020_b_(Random p_237020_1_, IWorld p_237020_2_, BlockPos p_237020_3_) {
      if (p_237020_1_.nextFloat() < 0.5F && p_237020_2_.getBlockState(p_237020_3_).matchesBlock(Blocks.NETHERRACK) && p_237020_2_.getBlockState(p_237020_3_.up()).isAir()) {
   ...
   private void func_237015_a_(Random p_237015_1_, IWorld p_237015_2_) {
      for(int i = this.boundingBox.minX + 1; i < this.boundingBox.maxX; ++i) {
         for(int j = this.boundingBox.minZ + 1; j < this.boundingBox.maxZ; ++j) {
            ...
            if (p_237015_2_.getBlockState(blockpos).matchesBlock(Blocks.NETHERRACK)) {
   ...
   private boolean func_237010_a_(IWorld p_237010_1_, BlockPos p_237010_2_) {
      ...
      return !blockstate.matchesBlock(Blocks.AIR) && !blockstate.matchesBlock(Blocks.OBSIDIAN) && !blockstate.matchesBlock(Blocks.CHEST) && (this.field_237007_h_ == RuinedPortalPiece.Location.IN_NETHER || !blockstate.matchesBlock(Blocks.LAVA));
   }
