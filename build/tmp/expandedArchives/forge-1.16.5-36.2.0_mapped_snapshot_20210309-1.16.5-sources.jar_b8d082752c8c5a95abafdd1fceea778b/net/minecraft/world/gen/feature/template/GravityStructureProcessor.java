...
public class GravityStructureProcessor extends StructureProcessor {
   public static final Codec<GravityStructureProcessor> field_237081_a_ = RecordCodecBuilder.create((p_237082_0_) -> {
      return p_237082_0_.group(Heightmap.Type.CODEC.fieldOf("heightmap").orElse(Heightmap.Type.WORLD_SURFACE_WG).forGetter((processor) -> {
   ...
   public Template.BlockInfo func_230386_a_(IWorldReader world, BlockPos p_230386_2_, BlockPos p_230386_3_, Template.BlockInfo p_230386_4_, Template.BlockInfo p_230386_5_, PlacementSettings settings) {
      ...
      int i = world.getHeight(heightmap$type, p_230386_5_.pos.getX(), p_230386_5_.pos.getZ()) + this.offset;
