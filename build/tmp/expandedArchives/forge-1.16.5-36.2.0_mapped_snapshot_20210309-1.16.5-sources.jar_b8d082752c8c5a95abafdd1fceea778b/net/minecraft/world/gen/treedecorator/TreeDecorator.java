...
public abstract class TreeDecorator {
   public static final Codec<TreeDecorator> field_236874_c_ = Registry.TREE_DECORATOR_TYPE.dispatch(TreeDecorator::getDecoratorType, TreeDecoratorType::getCodec);

   protected abstract TreeDecoratorType<?> getDecoratorType();

   public abstract void func_225576_a_(ISeedReader world, Random rand, List<BlockPos> p_225576_3_, List<BlockPos> p_225576_4_, Set<BlockPos> p_225576_5_, MutableBoundingBox p_225576_6_);
