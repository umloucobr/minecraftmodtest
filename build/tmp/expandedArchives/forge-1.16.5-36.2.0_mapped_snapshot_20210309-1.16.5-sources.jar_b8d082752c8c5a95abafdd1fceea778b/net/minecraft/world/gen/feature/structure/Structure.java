...
public abstract class Structure<C extends IFeatureConfig> extends net.minecraftforge.registries.ForgeRegistryEntry<Structure<?>> implements net.minecraftforge.common.extensions.IForgeStructure {
   ...
   public static final Structure<NoFeatureConfig> JUNGLE_PYRAMID = register("Jungle_Pyramid", new JunglePyramidStructure(NoFeatureConfig.CODEC), GenerationStage.Decoration.SURFACE_STRUCTURES);
   ...
   public static final Structure<NoFeatureConfig> MONUMENT = register("Monument", new OceanMonumentStructure(NoFeatureConfig.CODEC), GenerationStage.Decoration.SURFACE_STRUCTURES);
   ...
   public static final Structure<NoFeatureConfig> FORTRESS = register("Fortress", new FortressStructure(NoFeatureConfig.CODEC), GenerationStage.Decoration.UNDERGROUND_DECORATION);
