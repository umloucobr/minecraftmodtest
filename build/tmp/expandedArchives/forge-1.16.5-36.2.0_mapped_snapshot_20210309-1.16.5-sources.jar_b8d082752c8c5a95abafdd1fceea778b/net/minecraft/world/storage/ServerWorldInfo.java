...
public class ServerWorldInfo implements IServerWorldInfo, IServerConfiguration {
   ...
   private void serialize(DynamicRegistries registry, CompoundNBT nbt, @Nullable CompoundNBT playerNBT) {
      ...
      DimensionGeneratorSettings.field_236201_a_.encodeStart(worldgensettingsexport, this.generatorSettings).resultOrPartial(Util.prefixString("WorldGenSettings: ", LOGGER::error)).ifPresent((worldSettingsNBT) -> {
