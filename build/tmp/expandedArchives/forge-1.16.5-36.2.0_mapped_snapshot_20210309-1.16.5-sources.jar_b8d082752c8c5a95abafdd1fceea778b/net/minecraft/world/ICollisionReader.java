...
public interface ICollisionReader extends IBlockReader {
   ...
   default Stream<VoxelShape> func_234867_d_(@Nullable Entity entity, AxisAlignedBB aabb, Predicate<Entity> entityPredicate) {
      return Stream.concat(this.getBlockCollisionShapes(entity, aabb), this.func_230318_c_(entity, aabb, entityPredicate));
   }

   default Stream<VoxelShape> getBlockCollisionShapes(@Nullable Entity entity, AxisAlignedBB aabb) {
