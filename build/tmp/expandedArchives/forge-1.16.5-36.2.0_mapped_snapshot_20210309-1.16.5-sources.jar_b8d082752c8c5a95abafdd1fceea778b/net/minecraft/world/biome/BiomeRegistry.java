...
public abstract class BiomeRegistry {
   ...
   static {
      ...
      register(3, Biomes.MOUNTAINS, BiomeMaker.makeMountainBiome(1.0F, 0.5F, ConfiguredSurfaceBuilders.MOUNTAIN, false));
      ...
      register(20, Biomes.MOUNTAIN_EDGE, BiomeMaker.makeMountainBiome(0.8F, 0.3F, ConfiguredSurfaceBuilders.GRASS, true));
      ...
      register(34, Biomes.WOODED_MOUNTAINS, BiomeMaker.makeMountainBiome(1.0F, 0.5F, ConfiguredSurfaceBuilders.GRASS, true));
      ...
      register(131, Biomes.GRAVELLY_MOUNTAINS, BiomeMaker.makeMountainBiome(1.0F, 0.5F, ConfiguredSurfaceBuilders.GRAVELLY_MOUNTAIN, false));
      ...
      register(162, Biomes.MODIFIED_GRAVELLY_MOUNTAINS, BiomeMaker.makeMountainBiome(1.0F, 0.5F, ConfiguredSurfaceBuilders.GRAVELLY_MOUNTAIN, false));
