...
public class MobSpawnInfo {
   ...
   public static final MapCodec<MobSpawnInfo> CODEC = RecordCodecBuilder.mapCodec((builder) -> {
      ...
      }), Codec.simpleMap(EntityClassification.CODEC, MobSpawnInfo.Spawners.CODEC.listOf().promotePartial(Util.prefixString("Spawn data: ", LOGGER::error)), IStringSerializable.createKeyable(EntityClassification.values())).fieldOf("spawners").forGetter((spawnInfo) -> {
