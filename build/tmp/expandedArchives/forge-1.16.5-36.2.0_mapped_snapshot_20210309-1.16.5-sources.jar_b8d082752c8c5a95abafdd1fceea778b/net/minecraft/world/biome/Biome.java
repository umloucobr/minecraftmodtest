...
public final class Biome extends net.minecraftforge.registries.ForgeRegistryEntry.UncheckedRegistryEntry<Biome> {
   ...
   public static final Codec<Biome> CODEC = RecordCodecBuilder.create((builder) -> {
      ...
      .apply(builder, (climate, category, depth, scale, effects, gen, spawns, name) ->
          net.minecraftforge.common.ForgeHooks.enhanceBiome(name.orElse(null), climate, category, depth, scale, effects, gen, spawns, builder, Biome::new));
   });
   ...
   public static class Climate {
      ...
      public Climate(Biome.RainType precipitation, float temperature, Biome.TemperatureModifier temperatureModifier, float downfall) {
