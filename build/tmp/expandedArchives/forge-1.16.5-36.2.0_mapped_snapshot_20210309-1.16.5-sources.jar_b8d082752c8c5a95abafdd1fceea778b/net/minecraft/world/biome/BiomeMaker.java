...
public class BiomeMaker {
   ...
   public static Biome makeGiantTaigaBiome(float depth, float scale, float temperature, boolean isSpruceVariant) {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.GIANT_TREE_TAIGA);
   ...
   public static Biome makeDesertBiome(float depth, float scale, boolean hasVillageAndOutpost, boolean hasDesertPyramid, boolean hasFossils) {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.DESERT);
   ...
   private static Biome makeEndBiome(BiomeGenerationSettings.Builder generationSettingsBuilder) {
      ...
      return (new Biome.Builder()).precipitation(Biome.RainType.NONE).category(Biome.Category.THEEND).depth(0.1F).scale(0.2F).temperature(0.5F).downfall(0.5F).setEffects((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(10518688).withSkyColor(0).setMoodSound(MoodSoundAmbience.DEFAULT_CAVE).build()).withMobSpawnSettings(mobspawninfo$builder.build()).withGenerationSettings(generationSettingsBuilder.build()).build();
   }
   ...
   public static Biome makeTheEndBiome() {
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.END).withFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, Features.END_SPIKE);
      return makeEndBiome(biomegenerationsettings$builder);
   }

   public static Biome makeEndMidlandsBiome() {
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.END).withStructure(StructureFeatures.END_CITY);
      return makeEndBiome(biomegenerationsettings$builder);
   }

   public static Biome makeEndHighlandsBiome() {
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.END).withStructure(StructureFeatures.END_CITY).withFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, Features.END_GATEWAY).withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Features.CHORUS_PLANT);
      return makeEndBiome(biomegenerationsettings$builder);
   }

   public static Biome makeSmallEndIslandsBiome() {
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.END).withFeature(GenerationStage.Decoration.RAW_GENERATION, Features.END_ISLAND_DECORATED);
      return makeEndBiome(biomegenerationsettings$builder);
   }
   ...
   public static Biome makeMushroomBiome(float depth, float scale) {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.MYCELIUM);
      DefaultBiomeFeatures.withStrongholdAndMineshaft(biomegenerationsettings$builder);
      biomegenerationsettings$builder.withStructure(StructureFeatures.RUINED_PORTAL);
      DefaultBiomeFeatures.withCavesAndCanyons(biomegenerationsettings$builder);
      DefaultBiomeFeatures.withLavaAndWaterLakes(biomegenerationsettings$builder);
   ...
   private static Biome makeGenericSavannaBiome(float depth, float scale, float temperature, boolean isHighland, boolean isShatteredSavanna, MobSpawnInfo.Builder mobSpawnBuilder) {
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(isShatteredSavanna ? ConfiguredSurfaceBuilders.SHATTERED_SAVANNA : ConfiguredSurfaceBuilders.GRASS);
   ...
   public static Biome makeColdOceanBiome(boolean isDeepVariant) {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = getOceanGenerationSettingsBuilder(ConfiguredSurfaceBuilders.GRASS, isDeepVariant, false, flag);
   ...
   public static Biome makeOceanBiome(boolean isDeepVariant) {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = getOceanGenerationSettingsBuilder(ConfiguredSurfaceBuilders.GRASS, isDeepVariant, false, true);
   ...
   public static Biome makeLukewarmOceanBiome(boolean isDeepVariant) {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = getOceanGenerationSettingsBuilder(ConfiguredSurfaceBuilders.OCEAN_SAND, isDeepVariant, true, false);
   ...
   public static Biome makeDeepWarmOceanBiome() {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = getOceanGenerationSettingsBuilder(ConfiguredSurfaceBuilders.FULL_SAND, true, true, false).withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Features.SEAGRASS_DEEP_WARM);
      DefaultBiomeFeatures.withSimpleSeagrass(biomegenerationsettings$builder);
      DefaultBiomeFeatures.withFrozenTopLayer(biomegenerationsettings$builder);
   ...
   public static Biome makeFrozenOceanBiome(boolean isDeepVariant) {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.FROZEN_OCEAN);
   ...
   private static Biome makeGenericForestBiome(float depth, float scale, boolean isFlowerForestVariant, MobSpawnInfo.Builder mobSpawnBuilder) {
      ...
      DefaultBiomeFeatures.withLavaAndWaterSprings(biomegenerationsettings$builder);
      DefaultBiomeFeatures.withFrozenTopLayer(biomegenerationsettings$builder);
      return (new Biome.Builder()).precipitation(Biome.RainType.RAIN).category(Biome.Category.FOREST).depth(depth).scale(scale).temperature(0.7F).downfall(0.8F).setEffects((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).withSkyColor(getSkyColorWithTemperatureModifier(0.7F)).setMoodSound(MoodSoundAmbience.DEFAULT_CAVE).build()).withMobSpawnSettings(mobSpawnBuilder.build()).withGenerationSettings(biomegenerationsettings$builder.build()).build();
   }
   ...
   public static Biome makeSnowyBiome(float depth, float scale, boolean isIceSpikesBiome, boolean isMountainVariant) {
      ...
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(isIceSpikesBiome ? ConfiguredSurfaceBuilders.ICE_SPIKES : ConfiguredSurfaceBuilders.GRASS);
   ...
   public static Biome makeGenericBeachBiome(float depth, float scale, float temperature, float downfall, int waterColor, boolean isColdBiome, boolean isStoneVariant) {
      ...
      DefaultBiomeFeatures.withBatsAndHostiles(mobspawninfo$builder);
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(isStoneVariant ? ConfiguredSurfaceBuilders.STONE : ConfiguredSurfaceBuilders.DESERT);
      if (isStoneVariant) {
         DefaultBiomeFeatures.withStrongholdAndMineshaft(biomegenerationsettings$builder);
      } else {
         biomegenerationsettings$builder.withStructure(StructureFeatures.MINESHAFT);
   ...
   public static Biome makeNetherWastesBiome() {
      MobSpawnInfo mobspawninfo = (new MobSpawnInfo.Builder()).withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.GHAST, 50, 4, 4)).withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.ZOMBIFIED_PIGLIN, 100, 4, 4)).withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.MAGMA_CUBE, 2, 4, 4)).withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.ENDERMAN, 1, 4, 4)).withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.PIGLIN, 15, 4, 4)).withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.STRIDER, 60, 1, 2)).build();
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.NETHER).withStructure(StructureFeatures.RUINED_PORTAL_NETHER).withStructure(StructureFeatures.FORTRESS).withStructure(StructureFeatures.BASTION_REMNANT).withCarver(GenerationStage.Carving.AIR, ConfiguredCarvers.NETHER_CAVE).withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Features.SPRING_LAVA);
      DefaultBiomeFeatures.withNormalMushroomGeneration(biomegenerationsettings$builder);
   ...
   public static Biome makeCrimsonForestBiome() {
      MobSpawnInfo mobspawninfo = (new MobSpawnInfo.Builder()).withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.ZOMBIFIED_PIGLIN, 1, 2, 4)).withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.HOGLIN, 9, 3, 4)).withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.PIGLIN, 5, 3, 4)).withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.STRIDER, 60, 1, 2)).build();
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.CRIMSON_FOREST).withStructure(StructureFeatures.RUINED_PORTAL_NETHER).withCarver(GenerationStage.Carving.AIR, ConfiguredCarvers.NETHER_CAVE).withStructure(StructureFeatures.FORTRESS).withStructure(StructureFeatures.BASTION_REMNANT).withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Features.SPRING_LAVA);
      DefaultBiomeFeatures.withNormalMushroomGeneration(biomegenerationsettings$builder);
   ...
   public static Biome makeWarpedForestBiome() {
      MobSpawnInfo mobspawninfo = (new MobSpawnInfo.Builder()).withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.ENDERMAN, 1, 4, 4)).withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.STRIDER, 60, 1, 2)).withSpawnCost(EntityType.ENDERMAN, 1.0D, 0.12D).build();
      BiomeGenerationSettings.Builder biomegenerationsettings$builder = (new BiomeGenerationSettings.Builder()).withSurfaceBuilder(ConfiguredSurfaceBuilders.WARPED_FOREST).withStructure(StructureFeatures.FORTRESS).withStructure(StructureFeatures.BASTION_REMNANT).withStructure(StructureFeatures.RUINED_PORTAL_NETHER).withCarver(GenerationStage.Carving.AIR, ConfiguredCarvers.NETHER_CAVE).withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Features.SPRING_LAVA);
      DefaultBiomeFeatures.withNormalMushroomGeneration(biomegenerationsettings$builder);
