...
public interface IEntityReader {
   ...
   @Nullable
   default <T extends LivingEntity> T getClosestEntity(Class<? extends T> entityClazz, EntityPredicate entityPredicate, @Nullable LivingEntity entity, double x, double y, double z, AxisAlignedBB p_225318_10_) {
      return this.getClosestEntity(this.getLoadedEntitiesWithinAABB(entityClazz, p_225318_10_, (Predicate<? super T>)null), entityPredicate, entity, x, y, z);
   }
   ...
   default <T extends LivingEntity> List<T> getTargettableEntitiesWithinAABB(Class<? extends T> entityClazz, EntityPredicate entityPredicate, LivingEntity entity, AxisAlignedBB p_217374_4_) {
      List<T> list = this.getEntitiesWithinAABB(entityClazz, p_217374_4_, (Predicate<? super T>)null);
      List<T> list1 = Lists.newArrayList();

      for(T t : list) {
         if (entityPredicate.canTarget(entity, t)) {
            list1.add(t);
         }
      }
