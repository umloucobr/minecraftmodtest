...
public class ChunkHolder {
   ...
   private final ChunkHolder.IListener listener;
         ...
         for(int k = 0; k < this.field_244383_q.length; ++k) {
            ...
            if (shortset != null) {
               ...
               if (shortset.size() == 1) {
                  ...
                  smultiblockchangepacket.alterBlock((p_244387_2_, p_244387_3_) -> {
   ...
   protected void processUpdates(ChunkManager chunkManagerIn) {
      ...
      this.listener.func_219066_a(this.pos, this::func_219281_j, this.chunkLevel, this::func_219275_d);
