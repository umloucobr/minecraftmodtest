...
public interface IBlockReader {
   ...
   default double func_242403_h(BlockPos p_242403_1_) {
      return this.func_242402_a(this.getBlockState(p_242403_1_).getCollisionShapeUncached(this, p_242403_1_), () -> {
         BlockPos blockpos = p_242403_1_.down();
         return this.getBlockState(blockpos).getCollisionShapeUncached(this, blockpos);
      });
   }
