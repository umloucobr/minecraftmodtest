...
public class ChunkSerializer {
   ...
   public static ChunkPrimer read(ServerWorld worldIn, TemplateManager templateManagerIn, PointOfInterestManager poiManager, ChunkPos pos, CompoundNBT compound) {
      ...
      net.minecraftforge.common.ForgeHooks.fixNullStructureReferences(ichunk, unpackStructureReferences(pos, compoundnbt4));
   ...
   public static CompoundNBT write(ServerWorld worldIn, IChunk chunkIn) {
      ...
      if (iticklist instanceof ChunkPrimerTickList) {
         ...
         compoundnbt1.put("TileTicks", worldIn.getPendingBlockTicks().writeSchedueledTicksInChunkToNBT(chunkpos));
      }
      ...
      if (iticklist1 instanceof ChunkPrimerTickList) {
         ...
         compoundnbt1.put("LiquidTicks", worldIn.getPendingFluidTicks().writeSchedueledTicksInChunkToNBT(chunkpos));
      }
