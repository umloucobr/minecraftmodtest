      ...
      public LootContext build(LootParameterSet parameterSet) {
         ...
         if (false && !set.isEmpty()) { // Forge: Allow mods to pass custom loot parameters (not part of the vanilla loot table) to the loot context.
            ...
            if (!set1.isEmpty()) {
               ...
               return new LootContext(random, this.luck, this.world, minecraftserver.getLootTableManager()::getLootTableFromLocation, minecraftserver.func_229736_aP_()::getCondition, this.lootParameters, this.field_216026_c, this.queriedLootTableId);
            }
         }
      }
   }
