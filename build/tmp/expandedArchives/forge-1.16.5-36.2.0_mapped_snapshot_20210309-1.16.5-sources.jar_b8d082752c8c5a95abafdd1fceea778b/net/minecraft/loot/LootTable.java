...
public class LootTable {
   ...
   public List<ItemStack> generate(LootContext context) {
      ...
      list = net.minecraftforge.common.ForgeHooks.modifyLoot(this.getLootTableId(), list, context);
      return list;
   }
   ...
   public void validate(ValidationTracker validator) {
      for(int i = 0; i < this.pools.size(); ++i) {
         this.pools.get(i).func_227505_a_(validator.func_227534_b_(".pools[" + i + "]"));
      }
   ...
   public void fillInventory(IInventory inventory, LootContext context) {
