...
public class BlockStateProperty implements ILootCondition {
   ...
   private BlockStateProperty(Block block, StatePropertiesPredicate properties) {
      this.block = block;
   ...
   public static class Builder implements ILootCondition.IBuilder {
      ...
      public BlockStateProperty.Builder fromProperties(StatePropertiesPredicate.Builder builder) {
