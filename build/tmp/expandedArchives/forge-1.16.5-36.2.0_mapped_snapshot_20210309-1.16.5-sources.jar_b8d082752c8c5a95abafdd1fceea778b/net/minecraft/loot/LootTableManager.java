   ...
   protected void apply(Map<ResourceLocation, JsonElement> objectIn, IResourceManager resourceManagerIn, IProfiler profilerIn) {
      ...
      objectIn.forEach((id, element) -> {
         try (net.minecraft.resources.IResource res = resourceManagerIn.getResource(getPreparedPath(id));){
            LootTable loottable = net.minecraftforge.common.ForgeHooks.loadLootTable(GSON_INSTANCE, id, element, res == null || !res.getPackName().equals("Default"), this);
      ...
      ValidationTracker validationtracker = new ValidationTracker(LootParameterSets.GENERIC, this.lootPredicateManager::getCondition, immutablemap::get);
