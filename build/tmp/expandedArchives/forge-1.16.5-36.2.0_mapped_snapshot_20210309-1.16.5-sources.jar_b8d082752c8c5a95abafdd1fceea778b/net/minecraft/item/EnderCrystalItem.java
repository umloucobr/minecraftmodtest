...
public class EnderCrystalItem extends Item {
   ...
   public ActionResultType onItemUse(ItemUseContext context) {
      ...
      if (!blockstate.matchesBlock(Blocks.OBSIDIAN) && !blockstate.matchesBlock(Blocks.BEDROCK)) {
         ...
         if (!world.isAirBlock(blockpos1)) {
            ...
            if (!list.isEmpty()) {
               ...
               if (world instanceof ServerWorld) {
                  ...
                  DragonFightManager dragonfightmanager = ((ServerWorld)world).getDragonFightManager();
