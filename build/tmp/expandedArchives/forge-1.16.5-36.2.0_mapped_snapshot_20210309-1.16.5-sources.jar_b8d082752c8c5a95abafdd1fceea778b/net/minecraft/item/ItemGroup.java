...
public abstract class ItemGroup {
   ...
   public String getPath() {
      return this.groupPath == null ? this.groupLabel : this.groupPath;
   }
   ...
   public ItemGroup setGroupPath(String pathIn) {
      this.groupPath = pathIn;
      return this;
   }

   @OnlyIn(Dist.CLIENT)
   public boolean drawInForegroundOfGroup() {
