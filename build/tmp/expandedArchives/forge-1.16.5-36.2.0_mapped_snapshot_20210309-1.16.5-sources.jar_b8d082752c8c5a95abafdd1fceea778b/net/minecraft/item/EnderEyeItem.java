...
public class EnderEyeItem extends Item {
   ...
   public ActionResultType onItemUse(ItemUseContext context) {
      ...
      if (blockstate.matchesBlock(Blocks.END_PORTAL_FRAME) && !blockstate.get(EndPortalFrameBlock.EYE)) {
         if (world.isRemote) {
   ...
   public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
      ...
      if (raytraceresult.getType() == RayTraceResult.Type.BLOCK && worldIn.getBlockState(((BlockRayTraceResult)raytraceresult).getPos()).matchesBlock(Blocks.END_PORTAL_FRAME)) {
