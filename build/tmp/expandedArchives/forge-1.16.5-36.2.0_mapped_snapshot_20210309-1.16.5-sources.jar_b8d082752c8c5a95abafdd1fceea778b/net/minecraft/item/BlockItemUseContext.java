...
public class BlockItemUseContext extends ItemUseContext {
   ...
   public BlockItemUseContext(PlayerEntity player, Hand hand, ItemStack stack, BlockRayTraceResult rayTraceResult) {
      this(player.world, player, hand, stack, rayTraceResult);
   }
