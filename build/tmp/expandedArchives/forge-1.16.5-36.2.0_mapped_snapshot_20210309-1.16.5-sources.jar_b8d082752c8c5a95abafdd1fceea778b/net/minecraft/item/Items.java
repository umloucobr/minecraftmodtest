...
public class Items {
   ...
   public static final Item NETHERITE_BLOCK = register(new BlockItem(Blocks.NETHERITE_BLOCK, (new Item.Properties()).group(ItemGroup.BUILDING_BLOCKS).isImmuneToFire()));
