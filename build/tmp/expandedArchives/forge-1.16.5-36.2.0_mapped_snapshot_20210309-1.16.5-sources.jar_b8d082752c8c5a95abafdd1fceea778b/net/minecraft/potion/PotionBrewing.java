...
public class PotionBrewing {
   ...
   public static boolean isBrewablePotion(Potion potion) {
      ...
      for(int j = POTION_TYPE_CONVERSIONS.size(); i < j; ++i) {
         if ((POTION_TYPE_CONVERSIONS.get(i)).output.get() == potion) {
            return true;
         }
      }
   ...
   public static class MixPredicate<T extends net.minecraftforge.registries.ForgeRegistryEntry<T>> {
      public final net.minecraftforge.registries.IRegistryDelegate<T> input;
      private final Ingredient reagent;
      public final net.minecraftforge.registries.IRegistryDelegate<T> output;
