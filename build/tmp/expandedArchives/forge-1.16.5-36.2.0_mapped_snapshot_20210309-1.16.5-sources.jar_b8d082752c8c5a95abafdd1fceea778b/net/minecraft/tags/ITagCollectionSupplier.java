...
public interface ITagCollectionSupplier extends net.minecraftforge.common.extensions.IForgeTagCollectionSupplier {
   ...
   static ITagCollectionSupplier reinjectOptionalTags(ITagCollectionSupplier tagCollectionSupplier) {
      ITagCollection<Block> blockTagCollection = BlockTags.REGISTRY.reinjectOptionalTags(tagCollectionSupplier.getBlockTags());
      ITagCollection<Item> itemTagCollection = ItemTags.REGISTRY.reinjectOptionalTags(tagCollectionSupplier.getItemTags());
      ITagCollection<Fluid> fluidTagCollection = FluidTags.REGISTRY.reinjectOptionalTags(tagCollectionSupplier.getFluidTags());
      ITagCollection<EntityType<?>> entityTypeTagCollection = EntityTypeTags.REGISTRY.reinjectOptionalTags(tagCollectionSupplier.getEntityTypeTags());
      return new ITagCollectionSupplier() {
         @Override
         public ITagCollection<Block> getBlockTags() {
