...
public final class EntityTypeTags {
   protected static final TagRegistry<EntityType<?>> REGISTRY = TagRegistryManager.create(new ResourceLocation("entity_type"), ITagCollectionSupplier::getEntityTypeTags);
