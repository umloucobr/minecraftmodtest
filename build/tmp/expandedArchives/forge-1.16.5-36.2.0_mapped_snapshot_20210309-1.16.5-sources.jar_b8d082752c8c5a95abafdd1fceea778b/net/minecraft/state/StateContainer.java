...
public class StateContainer<O, S extends StateHolder<O, S>> {
   ...
   protected StateContainer(Function<O, S> p_i231877_1_, O owner, StateContainer.IFactory<O, S> p_i231877_3_, Map<String, Property<?>> properties) {
      this.owner = owner;
      this.properties = ImmutableSortedMap.copyOf(properties);
      Supplier<S> supplier = () -> {
         return p_i231877_1_.apply(owner);
      };
      ...
      for(Property<?> property : this.properties.values()) {
         stream = stream.flatMap((states) -> {
            return property.getAllowedValues().stream().map((value) -> {
               List<Pair<Property<?>, Comparable<?>>> list1 = Lists.newArrayList(states);
               list1.add(Pair.of(property, value));
               return list1;
            });
         });
      }

      stream.forEach((states) -> {
         ImmutableMap<Property<?>, Comparable<?>> immutablemap = states.stream().collect(ImmutableMap.toImmutableMap(Pair::getFirst, Pair::getSecond));
         S s1 = p_i231877_3_.create(owner, immutablemap, mapcodec1);
   ...
   private static <S extends StateHolder<?, S>, T extends Comparable<T>> MapCodec<S> func_241487_a_(MapCodec<S> p_241487_0_, Supplier<S> p_241487_1_, String p_241487_2_, Property<T> p_241487_3_) {
      return Codec.mapPair(p_241487_0_, p_241487_3_.getPropertyValuePairCodec().fieldOf(p_241487_2_).setPartial(() -> {
         return p_241487_3_.getValuePair(p_241487_1_.get());
      })).xmap((p_241485_1_) -> {
         return p_241485_1_.getFirst().with(p_241487_3_, p_241485_1_.getSecond().getValue());
      }, (p_241484_1_) -> {
         return Pair.of(p_241484_1_, p_241487_3_.getValuePair(p_241484_1_));
      });
   }
   ...
   public static class Builder<O, S extends StateHolder<O, S>> {
      ...
      public StateContainer<O, S> createStateContainer(Function<O, S> p_235882_1_, StateContainer.IFactory<O, S> p_235882_2_) {
