...
public interface IAngerable {
      ...
      if (!nbt.hasUniqueId("AngryAt")) {
         ...
         if (entity != null) {
            ...
            if (entity.getType() == EntityType.PLAYER) {
               this.setAttackingPlayer((PlayerEntity)entity);
            }
   ...
   default boolean func_241357_a_(World p_241357_1_) {
      return p_241357_1_.getGameRules().getBoolean(GameRules.UNIVERSAL_ANGER) && this.isAngry() && this.getAngerTarget() == null;
   }
   ...
   void setAttackingPlayer(@Nullable PlayerEntity p_230246_1_);
