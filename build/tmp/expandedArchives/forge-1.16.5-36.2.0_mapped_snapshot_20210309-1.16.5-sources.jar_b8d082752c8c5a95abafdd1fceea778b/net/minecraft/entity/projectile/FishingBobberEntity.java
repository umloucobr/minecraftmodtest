...
public class FishingBobberEntity extends ProjectileEntity {
   ...
   private void checkCollision() {
      ...
      if (raytraceresult.getType() == RayTraceResult.Type.MISS || !net.minecraftforge.event.ForgeEventFactory.onProjectileImpact(this, raytraceresult)) this.onImpact(raytraceresult);
   }
