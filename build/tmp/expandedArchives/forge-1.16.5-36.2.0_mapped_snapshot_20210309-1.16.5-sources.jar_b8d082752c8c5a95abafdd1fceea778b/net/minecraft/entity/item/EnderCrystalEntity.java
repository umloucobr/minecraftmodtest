...
public class EnderCrystalEntity extends Entity {
   ...
   public void tick() {
      ...
      if (this.world instanceof ServerWorld) {
         ...
         if (((ServerWorld)this.world).getDragonFightManager() != null && this.world.getBlockState(blockpos).isAir()) {
   ...
   private void onCrystalDestroyed(DamageSource source) {
      if (this.world instanceof ServerWorld) {
         DragonFightManager dragonfightmanager = ((ServerWorld)this.world).getDragonFightManager();
