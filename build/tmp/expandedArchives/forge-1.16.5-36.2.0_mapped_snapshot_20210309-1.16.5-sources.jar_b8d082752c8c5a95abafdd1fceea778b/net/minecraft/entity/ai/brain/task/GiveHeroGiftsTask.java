   ...
   private List<ItemStack> getGifts(VillagerEntity villager) {
      if (villager.isChild()) {
         ...
         if (GIFTS.containsKey(villagerprofession)) {
            ...
            LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)villager.world)).withParameter(LootParameters.ORIGIN, villager.getPositionVec()).withParameter(LootParameters.THIS_ENTITY, villager).withRandom(villager.getRNG());
