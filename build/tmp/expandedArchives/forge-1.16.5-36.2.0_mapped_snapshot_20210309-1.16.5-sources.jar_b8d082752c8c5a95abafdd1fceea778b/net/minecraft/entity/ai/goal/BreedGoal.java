...
public class BreedGoal extends Goal {
   private static final EntityPredicate ENTITY_SELECTOR_PREDICATE = (new EntityPredicate()).setDistance(8.0D).allowInvulnerable().allowFriendlyFire().setIgnoresLineOfSight();
   ...
   private AnimalEntity getNearbyMate() {
      List<AnimalEntity> list = this.world.getTargettableEntitiesWithinAABB(this.mateClass, ENTITY_SELECTOR_PREDICATE, this.animal, this.animal.getBoundingBox().grow(8.0D));
