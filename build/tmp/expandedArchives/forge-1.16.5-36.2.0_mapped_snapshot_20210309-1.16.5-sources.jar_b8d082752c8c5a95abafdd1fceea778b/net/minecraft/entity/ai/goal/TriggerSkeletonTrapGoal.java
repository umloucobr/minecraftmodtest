...
public class TriggerSkeletonTrapGoal extends Goal {
   ...
   private AbstractHorseEntity createHorse(DifficultyInstance difficulty) {
      SkeletonHorseEntity skeletonhorseentity = EntityType.SKELETON_HORSE.create(this.horse.world);
      skeletonhorseentity.onInitialSpawn((ServerWorld)this.horse.world, difficulty, SpawnReason.TRIGGERED, (ILivingEntityData)null, (CompoundNBT)null);
   ...
   private SkeletonEntity createSkeleton(DifficultyInstance difficulty, AbstractHorseEntity horse) {
      SkeletonEntity skeletonentity = EntityType.SKELETON.create(horse.world);
      skeletonentity.onInitialSpawn((ServerWorld)horse.world, difficulty, SpawnReason.TRIGGERED, (ILivingEntityData)null, (CompoundNBT)null);
      ...
      skeletonentity.setItemStackToSlot(EquipmentSlotType.MAINHAND, EnchantmentHelper.addRandomEnchantment(skeletonentity.getRNG(), this.func_242327_a(skeletonentity.getHeldItemMainhand()), (int)(5.0F + difficulty.getClampedAdditionalDifficulty() * (float)skeletonentity.getRNG().nextInt(18)), false));
      skeletonentity.setItemStackToSlot(EquipmentSlotType.HEAD, EnchantmentHelper.addRandomEnchantment(skeletonentity.getRNG(), this.func_242327_a(skeletonentity.getItemStackFromSlot(EquipmentSlotType.HEAD)), (int)(5.0F + difficulty.getClampedAdditionalDifficulty() * (float)skeletonentity.getRNG().nextInt(18)), false));
