...
public class BreakDoorGoal extends InteractDoorGoal {
   ...
   protected int getNormalizedBreakTime() {
   ...
   public boolean shouldExecute() {
      if (!super.shouldExecute()) {
         ...
         return this.canBreakOnDifficulty(this.entity.world.getDifficulty()) && !this.canDestroy();
      }
   }
   ...
   public boolean shouldContinueExecuting() {
      return this.breakingTime <= this.getNormalizedBreakTime() && !this.canDestroy() && this.doorPosition.withinDistance(this.entity.getPositionVec(), 2.0D) && this.canBreakOnDifficulty(this.entity.world.getDifficulty());
   }
   ...
   public void tick() {
      ...
      ++this.breakingTime;
      int i = (int)((float)this.breakingTime / (float)this.getNormalizedBreakTime() * 10.0F);
      if (i != this.previousBreakProgress) {
         this.entity.world.sendBlockBreakProgress(this.entity.getEntityId(), this.doorPosition, i);
         this.previousBreakProgress = i;
      }

      if (this.breakingTime == this.getNormalizedBreakTime() && this.canBreakOnDifficulty(this.entity.world.getDifficulty())) {
