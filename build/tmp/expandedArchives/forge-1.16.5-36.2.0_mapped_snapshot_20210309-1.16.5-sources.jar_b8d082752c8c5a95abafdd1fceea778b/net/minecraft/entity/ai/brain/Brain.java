...
public class Brain<E extends LivingEntity> {
   ...
   private Set<Activity> persistentActivities = Sets.newHashSet();
   ...
   public void setPersistentActivities(Set<Activity> newActivities) {
      this.persistentActivities = newActivities;
   }
   ...
   public Optional<Activity> getTemporaryActivity() {
      for(Activity activity : this.activities) {
         if (!this.persistentActivities.contains(activity)) {
   ...
   private void switchActivity(Activity activity) {
      if (!this.hasActivity(activity)) {
         ...
         this.activities.addAll(this.persistentActivities);
