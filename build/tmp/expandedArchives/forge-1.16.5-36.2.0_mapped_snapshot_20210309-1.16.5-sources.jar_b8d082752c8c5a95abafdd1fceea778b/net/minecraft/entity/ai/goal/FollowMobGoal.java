...
public class FollowMobGoal extends Goal {
   ...
   public FollowMobGoal(MobEntity entity, double speedModifier, float stopDistance, float areaSize) {
      this.entity = entity;
      this.followPredicate = (mob) -> {
         return mob != null && entity.getClass() != mob.getClass();
      };
