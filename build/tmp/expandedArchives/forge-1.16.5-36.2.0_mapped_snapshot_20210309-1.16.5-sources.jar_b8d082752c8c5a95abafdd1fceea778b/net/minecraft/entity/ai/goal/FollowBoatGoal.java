...
public class FollowBoatGoal extends Goal {
   ...
   public void startExecuting() {
      ...
      this.cooldown = 0;
      this.boatGoal = BoatGoals.GO_TO_BOAT;
   }
   ...
   public void tick() {
      ...
      float f = this.boatGoal == BoatGoals.GO_IN_BOAT_DIRECTION ? (flag ? 0.01F : 0.0F) : 0.015F;
      ...
      if (--this.cooldown <= 0) {
         this.cooldown = 10;
         if (this.boatGoal == BoatGoals.GO_TO_BOAT) {
            ...
            if (this.swimmer.getDistance(this.player) < 4.0F) {
               this.cooldown = 0;
               this.boatGoal = BoatGoals.GO_IN_BOAT_DIRECTION;
            }
         } else if (this.boatGoal == BoatGoals.GO_IN_BOAT_DIRECTION) {
