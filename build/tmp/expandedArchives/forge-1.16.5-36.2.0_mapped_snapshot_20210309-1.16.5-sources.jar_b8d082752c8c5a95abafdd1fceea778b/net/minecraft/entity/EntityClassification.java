...
public enum EntityClassification implements IStringSerializable, net.minecraftforge.common.IExtensibleEnum {
   ...
   public static final Codec<EntityClassification> CODEC = net.minecraftforge.common.IExtensibleEnum.createCodecForExtensibleEnum(EntityClassification::values, EntityClassification::getClassificationByName);
   ...
   @Deprecated
   public void init() {
      VALUES_MAP.put(this.getName(), this);
   }
