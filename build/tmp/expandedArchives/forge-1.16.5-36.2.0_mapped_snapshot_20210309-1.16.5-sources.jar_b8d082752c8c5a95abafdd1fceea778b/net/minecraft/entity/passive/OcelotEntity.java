...
public class OcelotEntity extends AnimalEntity {
   ...
   public ActionResultType getEntityInteractionResult(PlayerEntity playerIn, Hand hand) {
      ...
      if ((this.aiTempt == null || this.aiTempt.isRunning()) && !this.isTrusting() && this.isBreedingItem(itemstack) && playerIn.getDistanceSq(this) < 9.0D) {
   ...
   public OcelotEntity createChild(ServerWorld world, AgeableEntity mate) {
