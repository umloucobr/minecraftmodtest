...
public class StriderEntity extends AnimalEntity implements IRideable, IEquipable {
   ...
   public Vector3d getDismountPosition(LivingEntity livingEntity) {
      Vector3d[] avector3d = new Vector3d[]{getRiderDismountPlacementOffset((double)this.getWidth(), (double)livingEntity.getWidth(), livingEntity.rotationYaw), getRiderDismountPlacementOffset((double)this.getWidth(), (double)livingEntity.getWidth(), livingEntity.rotationYaw - 22.5F), getRiderDismountPlacementOffset((double)this.getWidth(), (double)livingEntity.getWidth(), livingEntity.rotationYaw + 22.5F), getRiderDismountPlacementOffset((double)this.getWidth(), (double)livingEntity.getWidth(), livingEntity.rotationYaw - 45.0F), getRiderDismountPlacementOffset((double)this.getWidth(), (double)livingEntity.getWidth(), livingEntity.rotationYaw + 45.0F)};
   ...
   public StriderEntity createChild(ServerWorld world, AgeableEntity mate) {
   ...
   static class LavaPathNavigator extends GroundPathNavigator {
      ...
      protected boolean func_230287_a_(PathNodeType nodeType) {
         return nodeType != PathNodeType.LAVA && nodeType != PathNodeType.DAMAGE_FIRE && nodeType != PathNodeType.DANGER_FIRE ? super.func_230287_a_(nodeType) : true;
      }
   ...
   static class MoveToLavaGoal extends MoveToBlockGoal {
      ...
      protected boolean shouldMoveTo(IWorldReader worldIn, BlockPos pos) {
         return worldIn.getBlockState(pos).matchesBlock(Blocks.LAVA) && worldIn.getBlockState(pos.up()).allowsMovement(worldIn, pos, PathType.LAND);
      }
   }
}