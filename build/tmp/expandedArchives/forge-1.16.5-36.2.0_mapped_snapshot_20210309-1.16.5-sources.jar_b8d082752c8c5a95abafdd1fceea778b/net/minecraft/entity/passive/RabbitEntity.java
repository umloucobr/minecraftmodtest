...
public class RabbitEntity extends AnimalEntity {
   ...
   public RabbitEntity createChild(ServerWorld world, AgeableEntity mate) {
      RabbitEntity rabbitentity = EntityType.RABBIT.create(world);
      int i = this.getRandomRabbitType(world);
      if (this.rand.nextInt(20) != 0) {
         if (mate instanceof RabbitEntity && this.rand.nextBoolean()) {
            i = ((RabbitEntity)mate).getRabbitType();
         } else {
