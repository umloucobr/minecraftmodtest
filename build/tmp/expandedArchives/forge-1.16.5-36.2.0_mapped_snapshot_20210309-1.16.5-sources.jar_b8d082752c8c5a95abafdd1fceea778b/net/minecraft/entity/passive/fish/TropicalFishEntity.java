...
public class TropicalFishEntity extends AbstractGroupFishEntity {
   ...
   private static int pack(TropicalFishEntity.Type type, DyeColor pattern, DyeColor bodyColor) {
      return type.func_212550_a() & 255 | (type.func_212551_b() & 255) << 8 | (pattern.getId() & 255) << 16 | (bodyColor.getId() & 255) << 24;
   }
