...
public class CatEntity extends TameableEntity {
      ...
      if (mate instanceof CatEntity) {
         ...
         if (this.isTamed()) {
            ...
            if (this.rand.nextBoolean()) {
               ...
               catentity.setCollarColor(((CatEntity)mate).getCollarColor());
            }
         }
      }
   ...
   public ILivingEntityData onInitialSpawn(IServerWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      ...
      if (world instanceof ServerWorld && ((ServerWorld)world).getStructureManager().getStructureStart(this.getPosition(), true, Structure.SWAMP_HUT).isValid()) {
         this.setCatType(10);
   ...
   public ActionResultType getEntityInteractionResult(PlayerEntity playerIn, Hand hand) {
      ...
      if (this.world.isRemote) {
         ...
         ActionResultType actionresulttype1 = super.getEntityInteractionResult(playerIn, hand);
   ...
   static class MorningGiftGoal extends Goal {
      ...
      public boolean shouldExecute() {
         if (!this.cat.isTamed()) {
            return false;
         } else if (this.cat.isQueuedToSit()) {
            return false;
         } else {
       ...
       */
      public boolean shouldContinueExecuting() {
         return this.cat.isTamed() && !this.cat.isQueuedToSit() && this.owner != null && this.owner.isSleeping() && this.bedPos != null && !this.func_220805_g();
      }
      ...
      private void func_220804_h() {
         ...
         LootContext.Builder lootcontext$builder = (new LootContext.Builder((ServerWorld)this.cat.world)).withParameter(LootParameters.ORIGIN, this.cat.getPositionVec()).withParameter(LootParameters.THIS_ENTITY, this.cat).withRandom(random);
