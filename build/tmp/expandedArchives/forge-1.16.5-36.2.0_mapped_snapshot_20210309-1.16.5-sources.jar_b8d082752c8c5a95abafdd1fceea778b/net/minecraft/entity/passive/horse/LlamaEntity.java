...
public class LlamaEntity extends AbstractChestedHorseEntity implements IRangedAttackMob {
   ...
   public LlamaEntity createChild(ServerWorld world, AgeableEntity mate) {
      LlamaEntity llamaentity = this.createChild();
      this.setOffspringAttributes(mate, llamaentity);
      LlamaEntity llamaentity1 = (LlamaEntity)mate;
