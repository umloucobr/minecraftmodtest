...
public class MooshroomEntity extends CowEntity implements IShearable, net.minecraftforge.common.IForgeShearable {
   ...
   public ActionResultType getEntityInteractionResult(PlayerEntity playerIn, Hand hand) {
      ...
      if (itemstack.getItem() == Items.BOWL && !this.isChild()) {
         ...
         if (!this.world.isRemote) {
            itemstack.damageItem(1, playerIn, (p_213442_1_) -> {
   ...
   public MooshroomEntity createChild(ServerWorld world, AgeableEntity mate) {
      MooshroomEntity mooshroomentity = EntityType.MOOSHROOM.create(world);
      mooshroomentity.setMooshroomType(this.func_213445_a((MooshroomEntity)mate));
