...
public abstract class AnimalEntity extends AgeableEntity {
   ...
   public float getBlockPathWeight(BlockPos pos, IWorldReader worldIn) {
      return worldIn.getBlockState(pos.down()).matchesBlock(Blocks.GRASS_BLOCK) ? 10.0F : worldIn.getBrightness(pos) - 0.5F;
   }
   ...
   public static boolean canAnimalSpawn(EntityType<? extends AnimalEntity> animal, IWorld worldIn, SpawnReason reason, BlockPos pos, Random random) {
      return worldIn.getBlockState(pos.down()).matchesBlock(Blocks.GRASS_BLOCK) && worldIn.getLightSubtracted(pos, 0) > 8;
   }
   ...
   public void spawnBabyAnimal(ServerWorld world, AnimalEntity p_234177_2_) {
      AgeableEntity ageableentity = this.createChild(world, p_234177_2_);
