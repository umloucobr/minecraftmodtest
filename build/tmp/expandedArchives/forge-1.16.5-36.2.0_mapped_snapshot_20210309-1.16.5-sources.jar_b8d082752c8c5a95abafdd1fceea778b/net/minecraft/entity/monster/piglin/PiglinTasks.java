...
public class PiglinTasks {
   ...
   protected static Brain<?> func_234469_a_(PiglinEntity p_234469_0_, Brain<PiglinEntity> p_234469_1_) {
      ...
      p_234469_1_.setPersistentActivities(ImmutableSet.of(Activity.CORE));
   ...
   private static List<ItemStack> func_234524_k_(PiglinEntity p_234524_0_) {
      ...
      return loottable.generate((new LootContext.Builder((ServerWorld)p_234524_0_.world)).withParameter(LootParameters.THIS_ENTITY, p_234524_0_).withRandom(p_234524_0_.world.rand).build(LootParameterSets.BARTER));
   }
   ...
   private static boolean func_234494_c_(LivingEntity p_234494_0_) {
      return p_234494_0_.func_233634_a_(item -> item instanceof net.minecraft.item.CrossbowItem);
   }
