...
public abstract class AbstractRaiderEntity extends PatrollerEntity {
   ...
   public class FindTargetGoal extends Goal {
      ...
      public final EntityPredicate findTargetPredicate = (new EntityPredicate()).setDistance(8.0D).setSkipAttackChecks().allowInvulnerable().allowFriendlyFire().setIgnoresLineOfSight().setUseInvisibilityCheck();
