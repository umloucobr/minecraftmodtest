...
public class PiglinEntity extends AbstractPiglinEntity implements ICrossbowUser {
   ...
   public static boolean func_234418_b_(EntityType<PiglinEntity> p_234418_0_, IWorld p_234418_1_, SpawnReason p_234418_2_, BlockPos p_234418_3_, Random p_234418_4_) {
      return !p_234418_1_.getBlockState(p_234418_3_.down()).matchesBlock(Blocks.NETHER_WART_BLOCK);
   }
   ...
   public ActionResultType getEntityInteractionResult(PlayerEntity playerIn, Hand hand) {
      ...
      if (actionresulttype.isSuccessOrConsume()) {
         ...
         return PiglinTasks.func_234471_a_(this, playerIn, hand);
      } else {
         boolean flag = PiglinTasks.func_234489_b_(this, playerIn.getHeldItem(hand)) && this.func_234424_eM_() != PiglinAction.ADMIRING_ITEM;
   ...
   public PiglinAction func_234424_eM_() {
      if (this.func_234425_eN_()) {
         ...
         return this.isAggressive() && this.func_233634_a_(item -> item instanceof net.minecraft.item.CrossbowItem) ? PiglinAction.CROSSBOW_HOLD : PiglinAction.DEFAULT;
      }
   }
   ...
   public boolean func_230293_i_(ItemStack p_230293_1_) {
      return net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.world, this) && this.canPickUpLoot() && PiglinTasks.func_234474_a_(this, p_230293_1_);
   }
