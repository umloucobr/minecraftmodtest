...
public class HoglinEntity extends AnimalEntity implements IMob, IFlinging {
   ...
   protected void updateAITasks() {
      ...
      if (this.func_234364_eK_()) {
         ...
         if (this.field_234358_by_ > 300 && net.minecraftforge.event.ForgeEventFactory.canLivingConvert(this, EntityType.ZOGLIN, (timer) -> this.field_234358_by_ = timer)) {
   ...
   public static boolean func_234361_c_(EntityType<HoglinEntity> p_234361_0_, IWorld p_234361_1_, SpawnReason p_234361_2_, BlockPos p_234361_3_, Random p_234361_4_) {
      return !p_234361_1_.getBlockState(p_234361_3_.down()).matchesBlock(Blocks.NETHER_WART_BLOCK);
   }
   ...
   public float getBlockPathWeight(BlockPos pos, IWorldReader worldIn) {
      if (HoglinTasks.func_234380_a_(this, pos)) {
         ...
         return worldIn.getBlockState(pos.down()).matchesBlock(Blocks.CRIMSON_NYLIUM) ? 10.0F : 0.0F;
      }
   }
