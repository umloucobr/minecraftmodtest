...
public abstract class AbstractPiglinEntity extends MonsterEntity {
   ...
   protected void updateAITasks() {
      ...
      if (this.field_242334_c > 300 && net.minecraftforge.event.ForgeEventFactory.canLivingConvert(this, EntityType.ZOMBIFIED_PIGLIN, (timer) -> this.field_242334_c = timer)) {
         this.func_241848_eP();
