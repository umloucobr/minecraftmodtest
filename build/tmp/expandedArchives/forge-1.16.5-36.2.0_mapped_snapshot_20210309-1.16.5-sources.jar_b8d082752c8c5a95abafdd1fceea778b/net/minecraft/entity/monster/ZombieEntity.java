...
public class ZombieEntity extends MonsterEntity {
   ...
   public void tick() {
      if (!this.world.isRemote && this.isAlive() && !this.isAIDisabled()) {
         if (this.isDrowning()) {
            ...
            if (this.drownedConversionTime < 0 && net.minecraftforge.event.ForgeEventFactory.canLivingConvert(this, EntityType.ZOMBIE, (timer) -> this.drownedConversionTime = timer)) {
               this.onDrowned();
            }
   ...
   public void onKillEntity(ServerWorld world, LivingEntity killedEntity) {
      ...
      if ((world.getDifficulty() == Difficulty.NORMAL || world.getDifficulty() == Difficulty.HARD) && killedEntity instanceof VillagerEntity && net.minecraftforge.event.ForgeEventFactory.canLivingConvert(killedEntity, EntityType.ZOMBIE_VILLAGER, (timer) -> {})) {
         if (world.getDifficulty() != Difficulty.HARD && this.rand.nextBoolean()) {
            return;
         }
         ...
         zombievillagerentity.onInitialSpawn(world, world.getDifficultyForLocation(zombievillagerentity.getPosition()), SpawnReason.CONVERSION, new ZombieEntity.GroupData(false, true), (CompoundNBT)null);
         ...
         net.minecraftforge.event.ForgeEventFactory.onLivingConvert(killedEntity, zombievillagerentity);
         if (!this.isSilent()) {
