...
public class ZombifiedPiglinEntity extends ZombieEntity implements IAngerable {
   ...
   public void setAttackTarget(@Nullable LivingEntity entitylivingbaseIn) {
      ...
      if (entitylivingbaseIn instanceof PlayerEntity) {
         this.setAttackingPlayer((PlayerEntity)entitylivingbaseIn);
      }
   ...
   protected SoundEvent getAmbientSound() {
      return this.isAngry() ? SoundEvents.ENTITY_ZOMBIFIED_PIGLIN_ANGRY : SoundEvents.ENTITY_ZOMBIFIED_PIGLIN_AMBIENT;
   }
