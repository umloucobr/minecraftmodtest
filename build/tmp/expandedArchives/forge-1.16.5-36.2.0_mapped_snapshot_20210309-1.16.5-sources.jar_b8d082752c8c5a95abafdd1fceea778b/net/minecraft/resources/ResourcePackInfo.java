...
public class ResourcePackInfo implements AutoCloseable {
   ...
   public ITextComponent getChatLink(boolean p_195794_1_) {
      return TextComponentUtils.wrapWithSquareBrackets(this.decorator.decorate(new StringTextComponent(this.name))).modifyStyle((p_211689_2_) -> {
         return p_211689_2_.setFormatting(p_195794_1_ ? TextFormatting.GREEN : TextFormatting.RED).setInsertion(StringArgumentType.escapeIfRequired(this.name)).setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, (new StringTextComponent("")).appendSibling(this.title).appendString("\n").appendSibling(this.description)));
      });
   }
