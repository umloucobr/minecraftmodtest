    ...
    protected void renderRecordOverlay(int width, int height, float partialTicks, MatrixStack mStack)
    {
        if (overlayMessageTime > 0)
        {
            ...
            if (opacity > 8)
            {
                ...
                renderChatBackground(mStack, fontrenderer, -4, fontrenderer.getStringPropertyWidth(overlayMessage), 16777215 | (opacity << 24));
    ...
    protected void renderTitle(int width, int height, float partialTicks, MatrixStack mStack)
    {
        if (displayedTitle != null && titlesTimer > 0)
        {
            ...
            if (opacity > 8)
            {
                ...
                this.getFontRenderer().drawTextWithShadow(mStack, this.displayedTitle.func_241878_f(), (float)(-this.getFontRenderer().getStringPropertyWidth(this.displayedTitle) / 2), -10.0F, 16777215 | l);
                RenderSystem.popMatrix();
                if (this.displayedSubTitle != null)
                {
                    RenderSystem.pushMatrix();
                    RenderSystem.scalef(2.0F, 2.0F, 2.0F);
                    this.getFontRenderer().drawTextWithShadow(mStack, this.displayedSubTitle.func_241878_f(), (float)(-this.getFontRenderer().getStringPropertyWidth(this.displayedSubTitle) / 2), 5.0F, 16777215 | l);
                    RenderSystem.popMatrix();
                }
                RenderSystem.disableBlend();
                RenderSystem.popMatrix();
