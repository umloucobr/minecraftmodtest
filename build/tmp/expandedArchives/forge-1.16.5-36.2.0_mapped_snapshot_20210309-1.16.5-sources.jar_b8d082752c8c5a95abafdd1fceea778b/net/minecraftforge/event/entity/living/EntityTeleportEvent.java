...
public class EntityTeleportEvent extends EntityEvent
{
    ...
    public double getPrevX() { return getEntity().getPosX(); }
    public double getPrevY() { return getEntity().getPosY(); }
    public double getPrevZ() { return getEntity().getPosZ(); }
    public Vector3d getPrev() { return getEntity().getPositionVec(); }
