...
public class ForgeItemTagsProvider extends ItemTagsProvider
{
    ...
    public void registerTags()
    {
        ...
        getOrCreateBuilder(Tags.Items.BONES).addItemEntry(Items.BONE);
        getOrCreateBuilder(Tags.Items.BOOKSHELVES).addItemEntry(Items.BOOKSHELF);
        ...
        getOrCreateBuilder(Tags.Items.CROPS_BEETROOT).addItemEntry(Items.BEETROOT);
        getOrCreateBuilder(Tags.Items.CROPS_CARROT).addItemEntry(Items.CARROT);
        getOrCreateBuilder(Tags.Items.CROPS_NETHER_WART).addItemEntry(Items.NETHER_WART);
        getOrCreateBuilder(Tags.Items.CROPS_POTATO).addItemEntry(Items.POTATO);
        getOrCreateBuilder(Tags.Items.CROPS_WHEAT).addItemEntry(Items.WHEAT);
        ...
        getOrCreateBuilder(Tags.Items.DUSTS_GLOWSTONE).addItemEntry(Items.GLOWSTONE_DUST);
        getOrCreateBuilder(Tags.Items.DUSTS_PRISMARINE).addItemEntry(Items.PRISMARINE_SHARD);
        getOrCreateBuilder(Tags.Items.DUSTS_REDSTONE).addItemEntry(Items.REDSTONE);
        addColored(getOrCreateBuilder(Tags.Items.DYES)::addTags, Tags.Items.DYES, "{color}_dye");
        getOrCreateBuilder(Tags.Items.EGGS).addItemEntry(Items.EGG);
        copy(Tags.Blocks.END_STONES, Tags.Items.END_STONES);
        getOrCreateBuilder(Tags.Items.ENDER_PEARLS).addItemEntry(Items.ENDER_PEARL);
        getOrCreateBuilder(Tags.Items.FEATHERS).addItemEntry(Items.FEATHER);
        ...
        getOrCreateBuilder(Tags.Items.GEMS_DIAMOND).addItemEntry(Items.DIAMOND);
        getOrCreateBuilder(Tags.Items.GEMS_EMERALD).addItemEntry(Items.EMERALD);
        getOrCreateBuilder(Tags.Items.GEMS_LAPIS).addItemEntry(Items.LAPIS_LAZULI);
        getOrCreateBuilder(Tags.Items.GEMS_PRISMARINE).addItemEntry(Items.PRISMARINE_CRYSTALS);
        getOrCreateBuilder(Tags.Items.GEMS_QUARTZ).addItemEntry(Items.QUARTZ);
        ...
        getOrCreateBuilder(Tags.Items.GUNPOWDER).addItemEntry(Items.GUNPOWDER);
        ...
        getOrCreateBuilder(Tags.Items.INGOTS_BRICK).addItemEntry(Items.BRICK);
        getOrCreateBuilder(Tags.Items.INGOTS_GOLD).addItemEntry(Items.GOLD_INGOT);
        getOrCreateBuilder(Tags.Items.INGOTS_IRON).addItemEntry(Items.IRON_INGOT);
        getOrCreateBuilder(Tags.Items.INGOTS_NETHERITE).addItemEntry(Items.NETHERITE_INGOT);
        getOrCreateBuilder(Tags.Items.INGOTS_NETHER_BRICK).addItemEntry(Items.NETHER_BRICK);
        getOrCreateBuilder(Tags.Items.LEATHER).addItemEntry(Items.LEATHER);
        getOrCreateBuilder(Tags.Items.MUSHROOMS).add(Items.BROWN_MUSHROOM, Items.RED_MUSHROOM);
        getOrCreateBuilder(Tags.Items.NETHER_STARS).addItemEntry(Items.NETHER_STAR);
        ...
        getOrCreateBuilder(Tags.Items.NUGGETS_IRON).addItemEntry(Items.IRON_NUGGET);
        getOrCreateBuilder(Tags.Items.NUGGETS_GOLD).addItemEntry(Items.GOLD_NUGGET);
        ...
        getOrCreateBuilder(Tags.Items.RODS_BLAZE).addItemEntry(Items.BLAZE_ROD);
        getOrCreateBuilder(Tags.Items.RODS_WOODEN).addItemEntry(Items.STICK);
        ...
        getOrCreateBuilder(Tags.Items.SEEDS_BEETROOT).addItemEntry(Items.BEETROOT_SEEDS);
        getOrCreateBuilder(Tags.Items.SEEDS_MELON).addItemEntry(Items.MELON_SEEDS);
        getOrCreateBuilder(Tags.Items.SEEDS_PUMPKIN).addItemEntry(Items.PUMPKIN_SEEDS);
        getOrCreateBuilder(Tags.Items.SEEDS_WHEAT).addItemEntry(Items.WHEAT_SEEDS);
        getOrCreateBuilder(Tags.Items.SHEARS).addItemEntry(Items.SHEARS);
        getOrCreateBuilder(Tags.Items.SLIMEBALLS).addItemEntry(Items.SLIME_BALL);
        ...
        getOrCreateBuilder(Tags.Items.STRING).addItemEntry(Items.STRING);
    }
