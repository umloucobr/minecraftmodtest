...
public interface IForgeBlock
{
    ...
    {
        return getBlock().getSlipperiness();
    }
    ...
    {
        return state.getBlock() instanceof LadderBlock && state.get(LadderBlock.FACING) == trapdoorState.get(TrapDoorBlock.HORIZONTAL_FACING);
    }
    ...
    {
        if (isBed(state, world, pos, entity) && world instanceof World && BedBlock.doesBedWork((World) world))
        {
    ...
    */
    ...
    {
        if (state.matchesBlock(Blocks.FARMLAND))
    ...
    {
        return state.matchesBlock(Blocks.OBSIDIAN);
    }
    ...
    */
    ...
    {
        return state.matchesBlock(Blocks.BOOKSHELF) ? 1: 0;
    }
    ...
    */
    ...
    {
        return state.matchesBlock(Blocks.SCAFFOLDING);
    }
}
